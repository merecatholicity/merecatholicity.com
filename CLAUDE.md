...
- **A DM message's acts live on ONE surface**, the press-and-hold (right-click, the hover ⌄, or
  ...
  selectable text, so a rule on the bubble alone is not enough.
