 ...
 *  - the table itself is unchanged — the same 128 (method, path, thunk)
...
test('the ROUTES table is the committed snapshot: 128 (method, path, thunk) triples, in order, every pair unique', () => {
