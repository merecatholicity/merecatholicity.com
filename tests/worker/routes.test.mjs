 ...
 *  - the table itself is unchanged — the same 129 (method, path, thunk)
...
test('the ROUTES table is the committed snapshot: 129 (method, path, thunk) triples, in order, every pair unique', () => {
