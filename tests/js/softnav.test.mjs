...
const SOURCES = [
  'client/comments.ts', 'client/composer.ts', 'client/profile.ts', 'client/board.ts', 'client/wall.ts', 'client/dm-crypto.ts', 'client/dm-message.ts', 'client/dm-pickers.ts', 'client/dm-inbox.ts', 'client/dm-thread.ts', 'client/dm-styles.ts', 'client/merecat.ts', 'client/admin.ts',
