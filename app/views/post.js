...
function el(tag, cls, text) {
  ...
  function commentNode(kit, c, pending, quoteCtx, reveal) {
    ...
    if (Core.canInteract(c.author_hash, kit.state.myHash, kit.MERECAT_BOT_HASH)) {
      ...
      var muteLink = el('a', 'comment-quote-link', kit.isMuted(c.author_hash) ? 'unmute' : 'mute');
      muteLink.href = '#';
    ...
    var date = el('a', 'comment-date', kit.fmtDateTime(c.created_at));
