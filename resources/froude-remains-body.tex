\xchapter{Remains of the Late Reverend Richard Hurrell Froude, M.A. Fellow of Oriel College, Oxford, Vol. I. J. G. \& F. Rivington, 1838}

\textbf{[}Edited by Newman and John
Keble in two volumes, the preface jointly written by them—\textbf{NR}.\textbf{]}
...
on his examination, high, though not the highest honours, both in
the Literæ Humaniores and the Disciplinæ Mathematicæ et Physicæ.
At\emph{}Easter, 1826, he was elected Fellow of his College, and, in
...
Letters begin in 1823, when he was twenty, and are carried down to
...
to the disposal of them; and that they, taking counsel with the
...
pressing nature of the end which the Author had in view, the \emph{principle}
...
of all charges. However, it cannot be an unfair way of meeting it,
...
human thought! Puritanism, Latitudinarianism, \emph{Popery},
...
atrocious Council; for M.—— admitted that many things, \emph{e.g.}
the doctrine of mass, which were fixed then, had been
...
for the total overthrow of their system: I think that the only [\emph{topos}]
...
seem in an especial manner [\emph{katechein t\={e}n al\={e}theian
...
it is plain that unless they habitually made light of gross
...
they pray to them as a come-off. But this is a generalization
...
was probably this; that he was a minister not of any human \emph{establishment},\emph{}but of the one Holy Church Catholic, which, among other places, is
...
calculated to bring the Church into bondage: that her ministers,
...
oppressor has a right to ask. Their \emph{loyalty} is already engaged
...
cannot do more than submit to the Statute of \emph{Præmunire}; they
...
which one may conceive the vague charge of Romanism to bear, \emph{i.e.}
...
kind of Popery is quite untenable; more so, in fact, than if
...
a great measure to defend the old Catholic writers for the
...
of compliment, which often, it may be feared, serve to keep up a
...
he was constantly employing \emph{}the same illustrations and
...
and artifice? Again: it was due to the reader to show him fairly
...
back, but what it was judged would be \emph{fairly} and \emph{naturally}
...
had the risk of such an error continually before their eyes,
