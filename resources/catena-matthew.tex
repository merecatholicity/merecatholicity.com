...
% Gospel of St. Matthew. Oxford translation, 1841, from the fisheaters PDF
% (catena-src/xaquinas-matthew.pdf), rebuilt as our own LaTeX by
...
\urlstyle{same}
\hypersetup{pdftitle={Catena Aurea on St. Matthew},pdfauthor={St. Thomas Aquinas}}
\linespread{1.06}
...
\vspace{2em}
{\Large\color{subhead} A Commentary on the Gospel of St. Matthew\par}
\vspace{2.5em}
