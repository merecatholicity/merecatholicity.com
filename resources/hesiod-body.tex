...
otherwise I have depended on the \emph{apparatus criticus} of the several
...
\emph{Catalogues} (for example), fragmentary as they are, is certainly after
the \emph{Theogony}.

In preparing the text of the \emph{Homeric Hymns} my chief debt—and it is
a heavy one—is to the edition of Allen and Sikes (1904) and to the series
of articles in the \emph{Journal of Hellenic Studies} (vols. xv. \emph{sqq}.)
by T.W. Allen. To the same scholar and to the Delegates of the Clarendon Press
I am greatly indebted for permission to use the restorations of the \emph{Hymn to
...
The texts of the \emph{Batrachomyomachia} and of the \emph{Contest of Homer and
...
giving to the \emph{Introduction} that full revision which I should have
desired.
...
The second period, which produced the \emph{Iliad} and the \emph{Odyssey},
...
universality of the \emph{Iliad} and the \emph{Odyssey} cast into oblivion
...
exhausted the epic \emph{genre}, that after him further efforts were doomed to
...
treated. In continental Greece \footnote{sc. in Boeotia, Locris and
Thessaly: elsewhere the movement was forced and unfruitful.}, on the other hand, but
...
\emph{Theogony}: ‘We can tell many a feigned tale to look like truth, but
we can, when we will, utter the truth’ (\emph{Theogony} 26-27). Such a
...
therefore, an epic like the \emph{Odyssey} is an organism and dramatic in
structure, a work such as the \emph{Theogony} is a merely artificial
...
the \emph{Shield of Heracles}) to the Homeric tradition.

\xsection{The Boeotian School}
...
Though the poems of the Boeotian school \footnote{The extant collection of
three poems, \emph{Works and Days}, \emph{Theogony}, and \emph{Shield of
...
1099) names only these three works.} were
...
Hesiod’s father (whose name, by a perversion of \emph{Works and Days},
...
(\emph{Works and Days}, 636 ff.). Either in Cyme or Ascra, two sons, Hesiod and
...
who ruled from Thespiae (\emph{Works and Days}, 37-39). While his brother
wasted his patrimony and ultimately came to want (\emph{Works and Days}, 34
ff.), Hesiod lived a farmer’s life until, according to the very early
tradition preserved by the author of the \emph{Theogony} (22-23), the Muses met
him as he was tending sheep on Mt. Helicon and “taught him a glorious
song”—doubtless the \emph{Works and Days}. The only other personal
...
dedicated to the Muses of Helicon (\emph{Works and Days}, 651-9).
...
arts), and to refer to the pitiful attempts in the \emph{Etymologicum Magnu}
(\emph{s.v.} \{H\}ESIODUS), to show how prejudiced and lacking even in
...
dialect of the \emph{Works and Days} is shown by Rzach \footnote{\emph{Der Dialekt des
...
treated with scepticism (\emph{see} Murray, \emph{Anc. Gk. Literature}, pp.
...
person—as, in fact, is done in the \emph{Precepts of Chiron}. In a word,
...
Thirdly, there is the passage in the \emph{Theogony} relating to Hesiod and the
Muses. It is surely an error to suppose that lines 22-35 all refer to Hesiod:
rather, the author of the \emph{Theogony} tells the story of his own
inspiration by the same Muses who \emph{once} taught Hesiod glorious song. The
...
that a writer, later than the \emph{Works and Days} by perhaps no more than
...
times the modest version in the \emph{Works and Days} was elaborated, first by
...
with hymns to Apollo \footnote{T.W. Allen suggests that
the conjured Delian and Pythian hymns to Apollo (\emph{Homeric Hymns} III) may
have suggested this version of the story, the Pythian hymn showing strong
continental influence.}, was transferred to Delos. These
developments certainly need no consideration: are we to say the same of the
passage in the \emph{Works and Days?} Critics from Plutarch downwards have
...
Eretria, whose death may be placed \emph{circa} 705 B.C.—a date which is
obviously too low for the genuine Hesiod. Nevertheless, there is much to be
said in defence of the passage. Hesiod’s claim in the \emph{Works and
...
seduced their sister \footnote{She is said to have given
birth to the lyrist Stesichorus.}, was murdered there. His body,
...
Messene (\emph{Palatine Anthology}, vii 55).
...
\emph{Works and Days}, the second round the \emph{Theogony}.

\xsection{I. “The Works and Days”}

The poem consists of four main sections. (\emph{a}) After the prelude, which
...
precepts on industry and prudent conduct generally. (\emph{b}) The second
...
noted, is treated in any way comprehensively. (\emph{c}) The third part is
...
(\emph{d}) The final section is taken up with a series of notices on the days
...
older date, just as Shakespeare used the \emph{Gesta Romanorum}, old
chronicles, and old plays; but close inspection will show that the \emph{Works and
...
Of the Hesiodic poems similar in character to the \emph{Works and Days}, only
the scantiest fragments survive. One at least of these, the \emph{Divination by
Birds}, was, as we know from Proclus, attached to the end of the
\emph{Works} until it was rejected by Apollonius Rhodius: doubtless it
...
\emph{Astronomy} or \emph{Astrology} (as Plutarch calls it) was in turn
appended to the \emph{Divination}. It certainly gave some account of the
...
might be used as guides. The \emph{Precepts of Chiron} was a didactic poem made
up of moral and practical precepts, resembling the gnomic sections of the
\emph{Works and Days}, addressed by the Centaur Chiron to his pupil Achilles.
Even less is known of the poem called the \emph{Great Works}: the title implies
that it was similar in subject to the second section of the \emph{Works and
Days}, but longer. Possible references in Roman writers \footnote{See Kinkel \emph{Epic. Graec.
Frag.} i. 158 ff.} indicate that among the subjects
...
\footnote{See \emph{Great Works},
frag. 2.} on \emph{Works and Days} 126
makes it likely that metals also were dealt with. It is therefore possible that
another lost poem, the \emph{Idaean Dactyls}, which dealt with the discovery of
metals and their working, was appended to, or even was a part of the \emph{Great
Works}, just as the \emph{Divination by Birds} was appended to the \emph{Works
and Days}.

\xsection{II. The Genealogical Poems}

The only complete poem of the genealogical group is the \emph{Theogony}, which
traces from the beginning of things the descent and vicissitudes of the
families of the gods. Like the \emph{Works and Days} this poem has no dramatic
...
This conclusion served to link the \emph{Theogony} to what must have been a
distinct poem, the \emph{Catalogues of Women}. This work was divided into four
(Suidas says five) books, the last one (or two) of which was known as the
\emph{Eoiae} and may have been again a distinct poem: the curious title will be
explained presently. The \emph{Catalogues} proper were a series of genealogies
...
been pointed out that \emph{mutterrecht} still left its traces in northern
Greece in historical times.

The following analysis (after Marckscheffel) \footnote{\emph{Hesiodi Fragmenta},
pp. 119 f.} will show
...
shows the general principle of arrangement of the \emph{Catalogues}: each line
...
Several poems are ascribed to Hesiod, such as the \emph{Epithalamium of Peleus and
Thetis}, the \emph{Descent of Theseus into Hades}, or the \emph{Circuit of the
...
the \emph{Catalogues}. It is highly probable that these poems were
interpolations into the \emph{Catalogues} expanded by later poets from more
...
of the \emph{Shield of Heracles}, the first 53 lines of which belong to the
fourth book of the \emph{Catalogues}, and almost certainly applies to other
episodes, such as the \emph{Suitors of Helen} \footnote{Possibly the division of
...
summary of the Tale of Troy.}, the
\emph{Daughters of Leucippus}, and the \emph{Marriage of Ceyx}, which last
Plutarch mentions as “interpolated in the works of Hesiod.”

To the \emph{Catalogues}, as we have said, was appended another work, the
\emph{Eoiae}. The title seems to have arisen in the following way \footnote{Goettling’s
explanation.}: the \emph{Catalogues} probably
ended (ep. \emph{Theogony} 963 ff.) with some such passage as this: “But
...
the \emph{Eoiae} is extant at the beginning of the \emph{Shield of Heracles},
...
shield of Achilles (\emph{Iliad} xviii. 478 ff.). Nothing shows more clearly
the collapse of the principles of the Hesiodic school than this ultimate
servile dependence upon Homeric models.

At the close of the \emph{Shield} Heracles goes on to Trachis to the house of
Ceyx, and this warning suggests that the \emph{Marriage of Ceyx} may have come
immediately after the ‘Or such as was’ of Alcmena in the
\emph{Eoiae}: possibly Halcyone, the wife of Ceyx, was one of the heroines sung
in the poem, and the original section was “developed” into the
\emph{Marriage}, although what form the poem took is unknown.

Next to the \emph{Eoiae} and the poems which seemed to have been developed from
it, it is natural to place the \emph{Great Eoiae}. This, again, as we know from
fragments, was a list of heroines who bare children to the gods: from the title
we must suppose it to have been much longer that the simple \emph{Eoiae}, but
its extent is unknown. Lehmann, remarking that the heroines are all Boeotian
and Thessalian (while the heroines of the \emph{Catalogues} belong to all parts
of the Greek world), believes the author to have been either a Boeotian or
Thessalian.

Two other poems are ascribed to Hesiod. Of these the \emph{Aegimius} (also
...
against Euboea. The remaining poem, the \emph{Melampodia}, was a work in three
...
\xsection{Date of the Hesiodic Poems}

There is no doubt that the \emph{Works and Days} is the oldest, as it is the
most original, of the Hesiodic poems. It seems to be distinctly earlier than
the \emph{Theogony}, which refers to it, apparently, as a poem already
renowned. Two considerations help us to fix a relative date for the
\emph{Works}. (1) In diction, dialect and style it is obviously dependent upon
Homer, and is therefore considerably later than the \emph{Iliad} and
\emph{Odyssey}: moreover, as we have seen, it is in revolt against the romantic
...
\emph{Works and Days}. The \emph{Theogony} might be tentatively placed a
century later; and the \emph{Catalogues} and \emph{Eoiae} are again later, but
not greatly later, than the \emph{Theogony}: the \emph{Shield of Heracles} may
...
\xsection{Literary Value of Homer}

Quintillian’s \footnote{x. 1. 52.} judgment on Hesiod that ‘he
...
Iron Age (\emph{Works and Days}, 182 ff.) with its catalogue of wrongdoings and
...
to the compiler of the \emph{Contest of Hesiod and Homer}—selected as
best in all his work, ‘When the Pleiades, Atlas’ daughters, begin
to rise...’ (\emph{Works and Days}, 383 ff.). The value of such a passage
...
nature. These qualities, it is true, are those pre-eminently of the \emph{Works
and Days}: the literary values of the \emph{Theogony} are of a more
...
\emph{Iliad} and \emph{Odyssey}. Equally natural it is that they should have
particularly selected various phases of the tale of Troy which preceded or
followed the action of the \emph{Iliad} or \emph{Odyssey}. In this way, without
...
beginning of the 3rd century B.C. At a later time the term \emph{Cycle},
...
poem of the “Trojan Cycle” by Proclus, \emph{i.e.} Eutychius
Proclus of Sicca.

The pre-Trojan poems of the Cycle may be noticed first. The \emph{Titanomachy},
...
unlike the short account of the Titan War found in the Hesiodic \emph{Theogony}
(617 ff.).

What links bound the \emph{Titanomachy} to the Theben Cycle is not clear. This
latter group was formed of three poems, the \emph{Story of Oedipus}, the
\emph{Thebais}, and the \emph{Epigoni}. Of the \emph{Oedipodea} practically
...
Oedipus as it is found in the \emph{Oedipus Tyrannus}. The \emph{Thebais} seems
...
Polyneices, Adrastus and Amphiarus against Thebes. The \emph{Epigoni} (ascribed
to Antimachus of Teos) recounted the expedition of the “After-Born”
against Thebes, and the sack of the city.

\xsection{The Trojan Cycle}

Six epics with the \emph{Iliad} and the \emph{Odyssey} made up the Trojan
Cycle—The \emph{Cyprian Lays}, the \emph{Iliad}, the \emph{Aethiopis},
the \emph{Little Iliad}, the \emph{Sack of Troy}, the \emph{Returns}, the
\emph{Odyssey}, and the \emph{Telegony}.
...
Thus, when we find that in the \emph{Returns} all the prominent Greek heroes
except Odysseus are accounted for, we are forced to believe that the author of
this poem knew the \emph{Odyssey} and judged it unnecessary to deal in full
with that hero’s adventures. \footnote{Odysseus appears to have
been mentioned once only—and that casually—in the
\emph{Returns}.} In a
word, the Cyclic poems are “written round” the \emph{Iliad} and the
\emph{Odyssey}. (3) The general structure of these epics is clearly imitative.
As M.M. Croiset remark, the abusive Thersites in the \emph{Aethiopis} is
clearly copied from the Thersites of the \emph{Iliad}; in the same poem
Antilochus, slain by Memnon and avenged by Achilles, is obviously modelled on
Patroclus. (4) The geographical knowledge of a poem like the \emph{Returns} is
far wider and more precise than that of the \emph{Odyssey}. (5) Moreover, in
the Cyclic poems epic is clearly degenerating morally—if the expression
may be used. The chief greatness of the \emph{Iliad} is in the character of the
...
with which we now have to deal were later than the \emph{Iliad} and
\emph{Odyssey}, and if we must recognize the possibility of some
...
\emph{Aethiopis} and the \emph{Sack of Ilium}, both ascribed to Arctinus of
...
of the \emph{Iliad}. The \emph{Aethiopis} thus included the coming of the
...
arms of Achilles. The \emph{Sack of Ilium} \footnote{M.M. Croiset note that the
\emph{Aethiopis} and the \emph{Sack} were originally merely parts of one work
containing lays (the Amazoneia, Aethiopis, Persis, etc.), just as the
\emph{Iliad} contained various lays such as the Diomedeia.} as
analysed by Proclus was very similar to Vergil’s version in \emph{Aeneid}
...
about 660 B.C. In his \emph{Little Iliad} he undertook to elaborate the
\emph{Sack} as related by Arctinus. His work included the adjudgment of the
...
is known, however (Aristotle, \emph{Poetics}, xxiii; Pausanias, x, 25-27), that
the \emph{Little Iliad} also contained a description of the \emph{Sack of
...
The \emph{Cyprian Lays}, ascribed to Stasinus of Cyprus \footnote{No date is assigned to
him, but it seems likely that he was either contemporary or slightly earlier
than Lesches.} (but also to Hegesinus of
Salamis) was designed to do for the events preceding the action of the
\emph{Iliad} what Arctinus had done for the later phases of the Trojan War. The
\emph{Cypria} begins with the first causes of the war, the purpose of Zeus to
...
quarrel between Achilles and Agamemnon with which the \emph{Iliad} begins.

These four poems rounded off the story of the \emph{Iliad}, and it only
remained to connect this enlarged version with the \emph{Odyssey}. This was
done by means of the \emph{Returns}, a poem in five books ascribed to Agias or
Hegias of Troezen, which begins where the \emph{Sack of Troy} ends. It told of
...
But the \emph{Odyssey} itself left much untold: what, for example, happened in
Ithaca after the slaying of the suitors, and what was the ultimate fate of
Odysseus? The answer to these questions was supplied by the \emph{Telegony}, a
poem in two books by Eugammon of Cyrene (\emph{fl}. 568 B.C.). It told of the
...
of the collection as such is unknown. Diodorus Siculus (\emph{temp}. Augustus)
...
quotes the Delian \emph{Hymn to Apollo}, and it is possible that the Homeric
...
Thucydides, in quoting the \emph{Hymn to Apollo}, calls it PROOIMION, which
...
Hymns as those to \emph{Demeter} (ii), \emph{Apollo} (iii), \emph{Hermes} (iv),
\emph{Aphrodite} (v), can have been real preludes, in spite of the closing
...
The Hymns to \emph{Pan} (xix), to \emph{Dionysus} (xxvi), to \emph{Hestia and
Hermes} (xxix), seem to have been designed for use at definite religious
festivals, apart from recitations. With the exception perhaps of the \emph{Hymn to
...
First, apparently, in the collection stood the \emph{Hymn to Dionysus}, of
which only two fragments now survive. While it appears to have been a hymn of
the longer type \footnote{Cp. Allen and Sikes,
\emph{Homeric Hymns} p. xv. In the text I have followed the arrangement of
these scholars, numbering the Hymns to Dionysus and to Demeter, I and II
respectively: to place \emph{Demeter} after \emph{Hermes}, and the Hymn to
Dionysus at the end of the collection seems to be merely perverse.}, we have no evidence to show
either its scope or date.

The \emph{Hymn to Demeter}, extant only in the MS. discovered by Matthiae at
...
The \emph{Hymn to Apollo} consists of two parts, which beyond any doubt were
...
\emph{Nem}. ii, 2) to Cynaethus of Chios (\emph{fl}. 504 B.C.), a date which is
...
The \emph{Hymn to Hermes} differs from others in its burlesque, quasi-comic
...
invention of the seven-stringed lyre is ascribed to Terpander (\emph{flor}. 676
B.C.). The hymn must therefore be later than that date, though Terpander,
according to Weir Smyth \footnote{\emph{Greek Melic Poets},
p. 165.}, may have only modified the scale
...
\emph{Battle of the Frogs and Mice}, so that a date in the earlier part of the
sixth century is most probable.

The \emph{Hymn to Aphrodite} is not the least remarkable, from a literary point
...
(\emph{Odyssey} viii, 266 ff.), which is superficially similar, will show how
...
and the hymn has almost certainly been used by the author of the \emph{Hymn to
Demeter}, so that the date must lie between these two periods, and the
seventh century seems to be the latest date possible.

The \emph{Hymn to Dionysus} relates how the god was seized by pirates and how
...
Museum \footnote{This monument was returned
to Greece in the 1980’s.— DBK.}.

Very different in character is the \emph{Hymn to Ares}, which is Orphic in
...
The only other considerable hymn is that to \emph{Pan}, which describes how he
...
\emph{Hermes} (xviii), to the \emph{Dioscuri} (xvii), and to \emph{Demeter}
(xiii) are mere abstracts of the longer hymns iv, xxxiii, and ii.

\xsection{The Epigrams of Homer}

The \emph{Epigrams of Homer} are derived from the pseudo-Herodotean \emph{Life of
Homer}, but many of them occur in other documents such as the \emph{Contest of
...
\xsection{The Burlesque Poems}

To Homer were popularly ascribed certain burlesque poems in which Aristotle
(\emph{Poetics} iv) saw the germ of comedy. Most interesting of these, were it
extant, would be the \emph{Margites}. The hero of the epic is at once sciolist
...
Another poem, of which we know even less, is the \emph{Cercopes}. These
...
Finally there is the \emph{Battle of the Frogs and Mice}. Here is told the
...
\xsection{The Contest of Homer and Hesiod}
...
the sophist Alcidamas (c. 400 B.C.). Plutarch (\emph{Conviv. Sept. Sap.}, 40)
uses an earlier (or at least a shorter) version than that which we possess \footnote{Cp. Marckscheffel,
\emph{Hesiodi fragmenta}, p. 35. The papyrus fragment recovered by Petrie
(\emph{Petrie Papyri}, ed. Mahaffy, p. 70, No. xxv.) agrees essentially with
the extant document, but differs in numerous minor textual points.}. The extant \emph{Contest},
...
same general sources as does the Herodotean \emph{Life of Homer}. Its scope is
...
included in the stichomythia of the \emph{Contest} proper, many of
which—did we possess the clue—would have to be referred to poems of
the Epic Cycle.

\xchapter{Bibliography}
...
as the new lines, \emph{Works and Days} 169 a-d, and the improved readings
\emph{ib}. 278, \emph{Theogony} 91, 93. Our chief gains from papyri are the
...
\emph{Editions of Hesiod:}—

Demetrius Chalcondyles, Milan (?) 1493 (?) (\emph{editio princeps}, containing,
however, only the \emph{Works and Days}).
...
be consulted, but especially the \emph{Hist. de la Littérature Grecque} I pp.
459 ff. of MM. Croiset. The summary account in Prof. Murray’s \emph{Anc. Gk.
Lit.} is written with a strong sceptical bias. Very valuable is the appendix
to Mair’s translation (Oxford, 1908) on \emph{The Farmer’s Year in
Hesiod}. Recent work on the Hesiodic poems is reviewed in full by Rzach in
Bursian’s \emph{Jahresberichte} vols. 100 (1899) and 152 (1911).

For the \emph{Fragments} of Hesiodic poems the work of Markscheffel, \emph{Hesiodi
Fragmenta} (Leipzig, 1840), is most valuable: important also is
Kinkel’s \emph{Epicorum Graecorum Fragmenta} I (Leipzig, 1877) and the
editions of Rzach noticed above. For recently discovered papyrus fragments see
Wilamowitz, \emph{Neue Bruchstücke d. Hesiod Katalog} (Sitzungsb. der k.
preuss. Akad. fur Wissenschaft, 1900, pp. 839-851). A list of papyri belonging
to lost Hesiodic works may here be added: all are the \emph{Catalogues}.

1) Berlin Papyri 7497 \footnote{See Schubert, \emph{Berl.
Klassikertexte} v. 1.22 ff.; the other papyri may be found in the
publications whose name they bear.} (2nd cent.).—Frag. 7.

2) \emph{Oxyrhynchus Papyri} 421 (2nd cent.).—Frag. 7.

3) \emph{Petrie Papyri} iii 3.—Frag. 14.

4) \emph{Papiri greci e latine}, No. 130 (2nd-3rd cent.).—Frag.
14.
...
9) \emph{Papiri greci e latine}, No. 131 (2nd-3rd cent.).—Frag.
99.

10) Oxyrhynchus Papyri 1358-9.

\emph{The Homeric Hymns:}—The text of the Homeric hymns is distinctly bad
...
(\emph{Berl. Klassikertexte} v.1. pp. 7 ff.) contains a paraphrase of a poem
very closely parallel to the \emph{Hymn to Demeter}.

The mediaeval MSS. \footnote{Unless otherwise noted,
all MSS. are of the 15th century.} are thus enumerated by Dr. T.W.
Allen:—
...
\emph{Editions of the Homeric Hymns}, \&c.

Demetrius Chalcondyles, Florence, 1488 (with the \emph{Epigrams} and the
\emph{Battle of the Frogs and Mice} in the \emph{ed. pr.} of Homer).
...
Ruhnken, Leyden, 1782 (Epist. Crit. and \emph{Hymn to Demeter}).

Ilgen, Halle, 1796 (with \emph{Epigrams} and the \emph{Battle of the Frogs and
Mice}).

Matthiae, Leipzig, 1806 (with the \emph{Battle of the Frogs and Mice}).

Hermann, Berling, 1806 (with \emph{Epigrams}).

Franke, Leipzig, 1828 (with \emph{Epigrams} and the \emph{Battle of the
Frogs and Mice}).

Dindorff (Didot edition), Paris, 1837.

Baumeister (\emph{Battle of the Frogs and Mice}), Göttingen, 1852.

Baumeister (\emph{Hymns}), Leipzig, 1860.

Gemoll, Leipzig, 1886.

Goodwin, Oxford, 1893.

Ludwich (\emph{Battle of the Frogs and Mice}), 1896.
...
T.W. Allen’s series of articles in the \emph{Journal of Hellenic Studies}
...
Welcker’s \emph{der epische Cyclus} (Bonn, vol. i, 1835: vol. ii, 1849:
vol. i, 2nd edition, 1865). The Appendix to Monro’s \emph{Homer’s
...
Croiset’s \emph{Hist. de la Littérature Grecque}, vol. i.
...
\emph{Real-Encyclopädie} xv (1912).

A discussion of the evidence for the date of Hesiod is to be found in
\emph{Journ. Hell. Stud.} xxxv, 85 ff. (T.W. Allen).

Of translations of Hesiod the following may be noticed:—\emph{The Georgicks
of Hesiod}, by George Chapman, London, 1618; \emph{The Works of Hesiod
translated from the Greek}, by Thomas Coocke, London, 1728; \emph{The Remains
of Hesiod translated from the Greek into English Verse}, by Charles Abraham
Elton; \emph{The Works of Hesiod, Callimachus, and Theognis}, by the Rev. J.
Banks, M.A.; “Hesiod”, by Prof. James Mair, Oxford, 1908\footnote{To this list I would also
add the following: \emph{Hesiod and Theognis}, translated by Dorothea Wender
(Penguin Classics, London, 1973).—DBK.}.

\xchapter{Hesiod}

\xsection{Hesiod’s Works and Days}
...
in mallow and asphodel \footnote{That is, the poor
...
speech in her. And he called this woman Pandora \footnote{The All-endowed.}, because
...
misery men grow old quickly. But the woman took off the great lid of the jar \footnote{The jar or casket
contained the gifts of the gods mentioned in l.82.} with her hands and scattered all
...
generation of mortal men, a brazen race, sprung from ash-trees \footnote{Eustathius refers to
Hesiod as stating that men sprung “from oaks and stones and
ashtrees”. Proclus believed that the Nymphs called Meliae
(\emph{Theogony}, 187) are intended. Goettling would render: “A race
terrible because of their (ashen) spears.”}; and it was in no way equal to
...
the deathless gods, and Cronos rules over them \footnote{Preserved only by Proclus,
...
on the temples at their birth \footnote{\emph{i.e.} the race will
so degenerate that at the last even a new-born child will show the marks of old
age.}. The father will not agree with
...
wretched men one and all. And then Aidos and Nemesis \footnote{Aidos, as a quality, is
...
wicked in undeserved prosperity (\emph{cf. Psalms}, lxxii. 1-19).}, with
...
working they are much better loved by the immortals \footnote{The alternative version
is: ‘and, working, you will be much better loved both by gods and men;
for they greatly dislike the idle.’}. Work is
...
place, neighbours come ungirt, but kinsmen stay to gird themselves \footnote{\emph{i.e.} neighbours
come at once and without making preparations, but kinsmen by marriage (who live
at a distance) have to prepare, and so are long in coming.}. A bad neighbour is as great a
...
(ll. 383-404) When the Pleiades, daughters of Atlas, are rising \footnote{Early in May.}, begin your harvest, and your
ploughing when they are going to set \footnote{In November.}. Forty
...
almighty Zeus sends the autumn rains \footnote{In October.}, and
...
a mortar \footnote{For pounding corn.} three feet wide and a pestle
three cubits long, and an axle of seven feet, for it will do very well so; but
if you make it eight feet long, you can cut a beetle \footnote{A mallet for breaking
clods after ploughing.} from it
...
them, with a loaf of four quarters \footnote{The loaf is a flattish
cake with two intersecting lines scored on its upper surface which divide it
into four equal parts.} and eight
slices \footnote{The meaning is obscure. A
scholiast renders ‘giving eight mouthfulls’; but the elder
Philostratus uses the word in contrast to ‘leavened’.} for his dinner, one who will
...
(ll. 448-457) Mark, when you hear the voice of the crane \footnote{About the middle of
November.} who cries year by year from the
...
your garnered substance. And so you will have plenty till you come to grey \footnote{Spring is so described
because the buds have not yet cast their iron-grey husks.} springtime, and will not look
wistfully to others, but another shall be in need of your help.

(ll. 479-492) But if you plough the good ground at the solstice \footnote{In December.}, you will reap sitting, grasping
...
this remedy—when the cuckoo first calls \footnote{In March.} in the
...
(ll. 504-535) Avoid the month Lenaeon \footnote{The latter part of January
and earlier part of February.}, wretched
...
Boneless One \footnote{\emph{i.e.} the octopus or
cuttle.} gnaws his foot in his fireless
house and wretched home; for the sun shows him no pastures to make for, but
goes to and fro over the land and city of dusky men \footnote{\emph{i.e.} the
darker-skinned people of Africa, the Egyptians or Aethiopians.}, and
...
gain thick coverts or some hollow rock. Then, like the Three-legged One \footnote{\emph{i.e.} an old man
walking with a staff (the ‘third leg’— as in the riddle of
the Sphinx).} whose back is broken and whose
...
the star Arcturus \footnote{February to March.} leaves the holy stream of Ocean
...
(ll. 571-581) But when the House-carrier \footnote{\emph{i.e.} the snail. The
season is the middle of May.} climbs up
...
(ll. 582-596) But when the artichoke flowers \footnote{In June.}, and the
...
Orion \footnote{July.} first appears, on a smooth
...
Day-sleeper \footnote{\emph{i.e.} a robber.} may take your stuff. Bring in
...
rosy-fingered Dawn sees Arcturus \footnote{September.}, then cut
...
Hyades and strong Orion begin to set \footnote{The end of October.}, then
remember to plough in season: and so the completed year \footnote{That is, the succession of
stars which make up the full year.} will fitly pass beneath the
earth.

(ll. 618-640) But if desire for uncomfortable sea-faring seize you; when the
Pleiades plunge into the misty sea \footnote{The end of October or
beginning of November.} to escape
...
(ll. 663-677) Fifty days after the solstice \footnote{July-August.}, when the
...
to a raw \footnote{\emph{i.e.} untimely,
...
face put your heart to shame \footnote{The thought is parallel to
...
the pleasure is greatest and the expense is least \footnote{The ‘common
...
the quick upon that which has five branches \footnote{\emph{i.e.} ‘do not
cut your finger-nails’.} with
bright steel.
...
moved \footnote{\emph{i.e.} things which
it would be sacrilege to disturb, such as tombs.}, for that is bad, and makes a man
...
(ll. 769-768) \footnote{H.G. Evelyn-White prefers
to switch ll. 768 and 769, reading l. 769 first then l. 768.—DBK} For these are days which come
...
eighth and the ninth, two days at least of the waxing month \footnote{The month is divided into
three periods, the waxing, the mid-month, and the waning, which answer to the
phases of the moon.}, are specially good for the works
...
then the Wise One \footnote{\emph{i.e.} the ant.}, gathers her pile. On that day
...
carefully and throw out Demeter’s holy grain upon the well-rolled \footnote{Such seems to be the
...
\emph{nurag}.} threshing floor on the seventh of
...
\xsection{The Divination by Birds}

Proclus on Works and Days, 828: Some make the \emph{Divination by Birds}, which
Apollonius of Rhodes rejects as spurious, follow this verse (\emph{Works and
Days}, 828).

\xsection{The Astronomy}
...
tells us their names as follows: ‘Nymphs like the Graces \footnote{This halt verse is added
by the Scholiast on Aratus, 172.}, Phaesyle and Coronis and
rich-crowned Cleeia and lovely Phaco and long-robed Eudora, whom the tribes of
men upon the earth call Hyades.’

Fragment \#3—Pseudo-Eratosthenes Catast. frag. 1: \footnote{The
“Catasterismi” (“Placings among the Stars”) is a
collection of legends relating to the various constellations.} The Great
...
which broke through the neck of land and formed the straits \footnote{The Straits of Messina.}, the sea parting the mainland
...
\xsection{The Precepts of Chiron}
...
for he was the first to reject the \emph{Precepts}, in which book this maxim
occurs, as a work of that poet.

\xsection{The Great Works}

Fragment \#1—Comm. on Aristotle, Nicomachean Ethics. v. 8: The verse,
however (the slaying of Rhadamanthys), is in Hesiod in the \emph{Great
...
\emph{Great Works} Hesiod makes silver to be of the family of Earth.

\xsection{The Idaean Dactyls}
...
him Scythes \footnote{Or perhaps ‘a
Scythian’.}.

\xsection{The Theogony}
...
quick-glancing \footnote{The epithet probably
indicates coquettishness.} Aphrodite, and Hebe with the
...
about oak or stone? \footnote{A proverbial saying
...
Terpsichore, and Erato and Polyhymnia and Urania and Calliope \footnote{‘She of the noble
voice’: Calliope is queen of Epic poetry.}, who is the chiefest of them all,
...
Earth, the ever-sure foundations of all \footnote{Earth, in the cosmology of
...
of Night were born Aether \footnote{Aether is the bright,
untainted upper atmosphere, as distinguished from Aer, the lower atmosphere of
the earth.} and Day, whom she conceived and
...
and Steropes and stubborn-hearted Arges \footnote{Brontes is the Thunderer;
Steropes, the Lightener; and Arges, the Vivid One.}, who gave
...
lay about Earth spreading himself full upon her \footnote{The myth accounts for the
...
Nymphs whom they call Meliae \footnote{Nymphs of the ash-trees,
as Dryads are nymphs of the oak-trees. Cp. note on \emph{Works and Days}, l.
145.} all over the boundless earth. And
...
in billowy Cyprus, and Philommedes \footnote{‘Member-loving’: the title is perhaps only a perversion of the
regular PHILOMEIDES (laughter-loving).} because
...
\footnote{Cletho (the Spinner) is
...
‘Fury with the abhorred shears.’}, who give men at their birth both
...
perfect river, were born children \footnote{Many of the names which
...
Hipponoe, and Cymodoce who with Cymatolege \footnote{The
‘Wave-receiver’ and the ‘Wave-stiller’.} and
...
Themisto, Pronoe, and Nemertes \footnote{‘The Unerring’
or ‘Truthful’; cp. l. 235.} who has the nature of her
...
the Dark-haired One \footnote{\emph{i.e.} Poseidon.} in a soft meadow amid spring
...
(\emph{pegae}) of Ocean; and that other, because he held a golden blade
(\emph{aor}) in his hands. Now Pegasus flew away and left the earth, the mother
...
(ll. 346-370) Also she brought forth a holy company of daughters \footnote{Goettling notes that some
...
Ocyrrhoe is the ‘Swift-flowing’.} who with the lord Apollo and the
...
in love with a god. And after these Erigenia \footnote{\emph{i.e.} Eos, the
‘Early-born’.} bare the
...
\footnote{Van Lennep explains that
Hecate, having no brothers to support her claim, might have been slighted.}, she is honoured amongst all the
...
children, Hestia \footnote{The goddess of the
\emph{hearth} (the Roman \emph{Vesta}), and so of the house. Cp. \emph{Homeric
Hymns} v.22 ff.; xxxix.1 ff.}, Demeter, and gold-shod Hera and
...
Zeus \footnote{The variant reading
...
rejected by Heyne, Wolf, Gaisford and Guyet.}. Therefore he kept no blind
...
and a marvel to mortal men \footnote{Pausanias (x. 24.6) saw
...
stone given to Cronos.}. And he set free from their
...
unwearying fire to the Melian \footnote{A Scholiast explains:
...
ash-trees: cp. \emph{Works and Days}, l. 145 and note.} race of mortal men who live on
...
clouds. In front of it the son of Iapetus \footnote{\emph{sc}. Atlas, the Shu
of Egyptian mythology: cp. note on line 177.} stands
...
terrible Styx, eldest daughter of back-flowing \footnote{Oceanus is here regarded
...
into the main \footnote{The conception of Oceanus
...
floated.}; but the tenth flows out from a
...
unending roots and it is grown of itself \footnote{\emph{i.e.} the threshold
is of ‘native’ metal, and not artificial.}. And
...
forth from the thunder-stricken lord in the dim rugged glens of the mount \footnote{According to Homer
Typhoeus was overwhelmed by Zeus amongst the Arimi in Cilicia. Pindar
represents him as buried under Aetna, and Tzetzes reads Aetna in this passage.}, when he was smitten. A great
part of huge earth was scorched by the terrible vapour and melted as tin melts
when heated by men’s art in channelled \footnote{The epithet (which means
literally \emph{well-bored}) seems to refer to the spout of the
crucible.}
...
Hephaestus \footnote{The fire god. There is no
reference to volcanic action: iron was smelted on Mount Ida; cp.
\emph{Epigrams of Homer}, ix. 2-4.}. Even so, then, the earth melted
...
Tritogeneia \footnote{\emph{i.e.} Athena, who
was born ‘on the banks of the river Trito’ (cp. l. 929l)}, the awful, the strife-stirring,
...
(ll. 929a-929t) \footnote{Restored by Peppmuller.
The nineteen following lines from another recension of lines 889-900, 924-9 are
quoted by Chrysippus (in Galen).} But Hera was very angry and
...
and mortal men. There the goddess (Athena) received that \footnote{\emph{sc}. the aegis. Line
929s is probably spurious, since it disagrees with l. 929q and contains a
suspicious reference to Athens.} whereby she excelled in strength
...
\xsection{The Catalogues of Women and Eoiae}

\footnote{A catalogue of heroines
...
\emph{Catalogue}, as also that Hellen was the son of Deucalion and
Pyrrha.

Fragment \#2—Ioannes Lydus \footnote{An antiquarian writer of
Byzantium, c. 490-570 A.D.}, de Mens.
...
Fragment \#3—Constantinus Porphyrogenitus \footnote{Constantine VII.
‘Born in the Porphyry Chamber’, 905-959 A.D.}, de Them.
...
drove oxen \footnote{As the price to be given
to her father for her: so in \emph{Iliad} xviii. 593 maidens are called
‘earners of oxen’. Possibly Glaucus, like Aias (fr. 68, ll. 55
ff.), raided the cattle of others.} for her. But he knew not at all
...
father \footnote{\emph{i.e.} Glaucus should father
the children of others. The curse of Aphrodite on the daughters of Tyndareus
(fr. 67) may be compared.}. So she lay in the arms of
...
Porphyrius \footnote{Porphyry, scholar,
mathematician, philosopher and historian, lived 233-305 (?) A.D. He was a pupil
of the neo-Platonist Plotinus.}, Quaest. Hom. ad Iliad. pert.,
...
Fragment \#11—Stephanus of Byzantium \footnote{Author of a geographical
lexicon, produced after 400 A.D., and abridged under Justinian.}, s.v.:
...
Fragment \#12—Eustathius \footnote{Archbishop of Thessalonica
1175-1192 (?) A.D., author of commentaries on Pindar and on the
\emph{Iliad} and \emph{Odyssey}.}, Hom. 1796.39: ‘So
...
\footnote{In the earliest times a
loin-cloth was worn by athletes, but was discarded after the 14th Olympiad.}.

Papiri greci e latini, ii. No. 130 (2nd-3rd century) \footnote{Slight remains of five
...
original publication of this fragment.—DBK)}: (ll.
...
\footnote{Of the three which
Aphrodite gave him to enable him to overcome Atalanta.}: and, swiftly as a Harpy, she
...
Fragment \#15—Strabo \footnote{The geographer; fl. c.24
B.C.}, i. p. 42: ‘And the
...
their beauty (or were turned into cows). They were finally healed by Melampus.} Strabo, viii. p. 370: And
...
Probus \footnote{Fl. 56-88 A.D.: he is best
known for his work on Vergil.} on Vergil, Eclogue vi. 48: These
...
Suidas, s.v.: \footnote{This and the following
fragment segment are meant to be read together.—DBK.} ‘Because of their hideous
...
Fragment \#19A—\footnote{This fragment as well as
fragments \#40A, \#101, and \#102 were added by Mr. Evelyn-White in an appendix to
the second edition (1919). They are here moved to the \emph{Catalogues}
proper for easier use by the reader.—DBK.} Oxyrhynchus Papyri 1358 fr. 1
(3rd cent. A.D.): \footnote{For the restoration of ll.
1-16 see “Ox. Pap.” pt. xi. pp. 46-7: the supplements of ll. 17-31
are by the Translator (cp. “Class. Quart.” x. (1916), pp. 65-67).} (ll. 1-32) ‘....So she
...
from his mouth a crocus \footnote{The crocus was to attract
Europa, as in the very similar story of Persephone: cp. \emph{Homeric
Hymns} ii. lines 8 ff.}. In this way he deceived Europa,
...
Fragment \#21—Apollodorus \footnote{Apollodorus of Athens (fl.
144 B.C.) was a pupil of Aristarchus. He wrote a Handbook of Mythology, from
which the extant work bearing his name is derived.}, iii. 14.4.1: But Hesiod says
that he (Adonis) was the son of Phoenix and Alphesiboea.

Fragment \#22—Porphyrius, Quaest. Hom. ad Iliad. pert. p. 189: As it is
said in Hesiod in the \emph{Catalogue of Women} concerning Demodoce the
...
Aelian \footnote{Priest at Praeneste. He
lived c. 170-230 A.D.}, Var. Hist. xii. 36: But Hesiod
...
Fragment \#25—Herodian \footnote{Son of Apollonius
Dyscolus, lived in Rome under Marcus Aurelius. His chief work was on
accentuation.} in Etymologicum Magnum, p. 60,
40: Tityos the son of Elara.

Fragment \#26—\footnote{This and the next two
fragment segments are meant to be read together.—DBK.} Argument: Pindar, Ol. xiv:
...
Fragment \#28—Stephanus of Byzantium: Onchestus: a grove \footnote{Sacred to Poseidon. For
the custom observed there, cp. \emph{Homeric Hymns} iii. 231 ff.}. It is situate in the country of
...
Fragment \#38—‘Eratosthenes’ \footnote{275-195 (?) B.C.,
mathematician, astronomer, scholar, and head of the Library of Alexandria.}, Catast.
...
thought passes their utterance \footnote{\emph{i.e.} those who seek
to outwit the oracle, or to ask of it more than they ought, will be deceived by
it and be led to ruin: cp. \emph{Hymn to Hermes}, 541 ff.} might be subject to the gods and
...
says that those with Zetes \footnote{Zetes and Calais, sons of
...
the Harpies.} turned and prayed to Zeus:
...
Fragment \#43—Philodemus \footnote{An Epicurean philosopher,
fl. 50 B.C.}, On Piety, 10: Nor let anyone
...
And their names are Thelxiope or Thelxinoe, Molpe and Aglaophonus \footnote{‘Charming-with-her-voice’ (or ‘Charming-the-mind’),
...
Fragment \#52—Diodorus \footnote{Diodorus Siculus, fl. 8
B.C., author of an universal history ending with Caesar’s Gallic Wars.} v. 81: Macareus was a son of
...
viii. 105: The author of the \emph{Cypria} \footnote{The first epic in the
“Trojan Cycle”; like all ancient epics it was ascribed to Homer,
but also, with more probability, to Stasinus of Cyprus.} says that
...
Fragment \#59—\footnote{This fragment is placed by
Spohn after \emph{Works and Days} l. 120.} Origen, Against Celsus, iv. 79:
...
Fragment \#63—Pausanias \footnote{A Greek of Asia Minor,
author of the “Description of Greece” (on which he was still
engaged in 173 A.D.).}, ii. 26. 7: This oracle most
...
Asclepius, blameless and strong.’ \footnote{Wilamowitz thinks one or
...
\emph{Catalogue of the Daughters of Leucippus}?
...
Fragment \#68—\footnote{Lines 1-51 are from Berlin
...
proves that the two fragments together come from the \emph{Catalogue of
Women}. The second book (the beginning of which is indicated after l.
106) can hardly be the second book of the \emph{Catalogues} proper:
possibly it should be assigned to the EOIAI, which were sometimes treated as
part of the \emph{Catalogues}, and sometimes separated from it. The
remains of thirty-seven lines following B. 50 in the Papyrus are too slight to
admit of restoration.} Berlin Papyri, No. 9739: (ll.
...
made him \footnote{sc. the Suitor whose name
is lost.} their brother perforce, but
...
sending messages \footnote{Wooing was by proxy; so
...
right—is stated (ll. 69 ff.).} to horse-taming Castor and
...
II. \footnote{The Papyrus here marks the
beginning of a second book possibly of the \emph{Eoiae}. The passage (ll. 2-50)
probably led up to an account of the Trojan (and Theban?) war, in which,
according to \emph{Works and Days} ll. 161-166, the Race of Heroes perished.
The opening of the \emph{Cypria} is somewhat similar. Somewhere in the
...
of spring, at that time when the Hairless One \footnote{\emph{i.e.} the snake; as
in \emph{Works and Days} l. 524, the “Boneless One” is the
cuttle-fish.} in a
...
Fragment \#69—Tzetzes \footnote{c. 1110-1180 A.D. His
chief work was a poem, “Chiliades”, in accentual verse of nearly
13,000 lines.}, Exeg. Iliad. 68. 19H: Agamemnon
...
\emph{Catalogue of Women} represented that Iphigeneia was not killed
but, by the will of Artemis, became Hecate \footnote{According to this account
...
Euripides (\emph{Iphigeneia in Tauris}) makes her merely priestess of
the goddess.}.

Fragment \#72—Eustathius, Hom. 13. 44. sq: Butes, it is said, was a son of
Poseidon: so Hesiod in the \emph{Catalogue}.
...
Fragment \#75—Hesychius \footnote{Of Alexandria. He lived in
the 5th century, and compiled a Greek Lexicon.}: The athletic contest in memory
...
the Ceramicus. And Hesiod writes: ‘And Eurygyes \footnote{For his murder Minos
exacted a yearly tribute of boys and girls, to be devoured by the Minotaur,
from the Athenians.}, while
...
Rhodes says that it (the \emph{Shield of Heracles}) is Hesiod’s
both from the general character of the work and from the fact that in the
\emph{Catalogue} we again find Iolaus as charioteer of Heracles.
...
men were made, and they were called people.’ \footnote{There is a fancied
...
found a nymph complaisant \footnote{Eustathius identifies
Ileus with Oileus, father of Aias. Here again is fanciful etymology, ILEUS
being similar to ILEOS (complaisant, gracious).} and was joined with her in sweet
...
could move along upon the ears of corn \footnote{Imitated by Vergil,
“Aeneid” vii. 808, describing Camilla.}.... The
...
Fragment \#85—Choeroboscus \footnote{c. 600 A.D., a lecturer
and grammarian of Constantinople.}, i. 123,
22H: ‘And she bare a son Thoas.’

Fragment \#86—Eustathius, Hom. 1623. 44: Maro \footnote{Priest of Apollo, and,
according to Homer, discoverer of wine. Maronea in Thrace is said to have been
called after him.}, whose
...
there came a messenger from the sacred feast to goodly Pytho, a crow \footnote{The crow was originally
white, but was turned black by Apollo in his anger at the news brought by the
bird.}, and he told unshorn Phoebus of
secret deeds, that Ischys son of Elatus had wedded Coronis the daughter of
Phlegyas of birth divine.

Fragment \#90—Athenagoras \footnote{A philosopher of Athens
under Hadrian and Antonius. He became a Christian and wrote a defence of the
Christians addressed to Antoninus Pius.}, Petition for the Christians, 29:
...
would have been cast by Zeus into Tartarus \footnote{Zeus slew Asclepus (fr.
...
herdsman. (Cp. Euripides, \emph{Alcestis}, 1-8)}; but Leto
...
Apollo.’ \footnote{For Cyrene and Aristaeus,
cp. Vergil, \emph{Georgics}, iv. 315 ff.}
...
he has taken over from Hesiod’s \emph{Catalogue of Women}.

Fragment \#95—Scholiast on Homer, Iliad ii. 469: ‘Or like her
(Antiope) whom Boeotian Hyria nurtured as a maid.’

Fragment \#96—Palaephatus \footnote{A writer on mythology of
uncertain date.}, c. 42: Of Zethus and Amphion.
...
built a city, Dodona \footnote{In Epirus. The oracle was
...
Fragment \#98—Berlin Papyri, No. 9777: \footnote{The fragment is part of a
leaf from a papyrus book of the 4th century A.D.} (ll.
...
\footnote{According to Homer and
...
ff.)}, while he was fighting with the
...
Fragment \#99—\footnote{The fragment probably
belongs to the \emph{Catalogues} proper rather than to the Eoiae; but,
as its position is uncertain, it may conveniently be associated with Frags. 99A
and the \emph{Shield of Heracles}.} Papyri greci e latine, No. 131
(2nd-3rd century): \footnote{Most of the smaller
restorations appear in the original publication, but the larger are new: these
last are highly conjectual, there being no definite clue to the general sense.} (ll. 1-10) ‘And (Eriphyle)
bare in the palace Alcmaon \footnote{Alcmaon (who took part in
...
Electryon is introduced as father of Alcmena.}, shepherd of the people, to
...
\emph{Shield} as far as the 56th verse is current in the fourth
\emph{Catalogue}
...
Oxyrhynchus Papyri 1359 fr. 3 (early 3rd cent. A.D.): (ll. 17-24) \footnote{The association of ll.
...
the Translator.}....Cleopatra ....the daughter
...
\xsection{The Shield of Heracles}
...
and from there again wise Zeus went on and trod the highest peak of Phicium \footnote{A mountain peak near
Thebes which took its name from the Sphinx (called in \emph{Theogony} l.
326 PHIX).}: there he sat and planned
...
shining gold; and there were zones of cyanus \footnote{Cyanus was a glass-paste
...
centre of the shield, and Oceanus (l. 314) enclosed the whole.} drawn
...
spoil \footnote{‘She who drives
herds,’ \emph{i.e.} ‘The Victorious’, since herds were the
chief spoil gained by the victor in ancient warfare.}. She was like as if she would
...
down. Upon the head of the hero lay the dread cap \footnote{The cap of darkness which
made its wearer invisible.} of Hades
...
grapes which turned black \footnote{The existing text of the
vineyard scene is a compound of two different versions, clumsily adapted, and
eked out with some makeshift additions.}. And there were men treading out
...
(ll. 402-412) As two lions \footnote{The conception is similar
to that of the sculptured group at Athens of Two Lions devouring a Bull
(Dickens, \emph{Cat. of the Acropolis Museum}, No. 3).} on either side of a slain deer
...
Fragment \#2—Zenobius \footnote{A Greek sophist who taught
rhetoric at Rome in the time of Hadrian. He is the author of a collection of
proverbs in three books.}, ii. 19: Hesiod used the proverb
...
\xsection{The Great Eoiae}

Fragment \#1—Pausanius, ii. 26. 3: Epidaurus. According to the opinion of
the Argives and the epic poem, the \emph{Great Eoiae}, Argos the son of
...
the \emph{Great Eoiae} he represents Alcmene as saying to Heracles:
...
from the \emph{Great Eoiae}; for there we find Heracles entertained by
Telamon, standing dressed in his lion-skin and praying, and there also we find
the eagle sent by Zeus, from which Aias took his name \footnote{When Heracles prayed that
...
Aias after the eagle (\emph{aietos}).}.

Fragment \#4—Pausanias, iv. 2. 1: But I know that the so-called
\emph{Great Eoiae} say that Polycaon the son of Butes married Euaechme,
...
Fragment \#8—Pausanias, ii. 2. 3: But in the \emph{Great Eoiae}
Peirene is represented to be the daughter of Oebalius.

Fragment \#9—Pausanias, ii. 16. 4: The epic poem, which the Greek call the
\emph{Great Eoiae}, says that she (Mycene) was the daughter of Inachus
...
\emph{Great Eoiae}, these were killed by Oenomaus \footnote{Oenomaus, king of Pisa in
...
through the treachery of the charioteer of Oenomaus, became victorious.}: Alcathous the son of Porthaon
...
\emph{Great Eoiae} it is said that Endymion was transported by Zeus into
...
\emph{Great Eoiae} it is related that Melampus, who was very dear to
...
\emph{Great Eoiae} Scylla is the daughter of Phoebus and Hecate.

Fragment \#14—Scholiast on Apollonius Rhodius, Arg. ii. 181: Hesiod in the
\emph{Great Eoiae} says that Phineus was blinded because he told Phrixus
the way \footnote{sc. to Scythia.}.

Fragment \#15—Scholiast on Apollonius Rhodius, Arg. ii. 1122: Argus. This
is one of the children of Phrixus. These.... ....Hesiod in the \emph{Great
...
in the \emph{Great Eoiae}.... ....Magnes was the son of Argus, the son
...
this place \footnote{sc. Colophon. Proclus in
his abstract of the \emph{Returns} (sc. of the heroes from Troy) says
Calchas and his party were present at the death of Teiresias at Colophon,
perhaps indicating another version of this story.}. But happening to find near
...
Fragment \#4—\footnote{ll. 1-2 are quoted by
Athenaeus, ii. p. 40; ll. 3-4 by Clement of Alexandria, \emph{Stromateis} vi.
2. 26. Buttman saw that the two fragments should be joined. (NOTE: These two
fragments should be read together.—DBK)} Athenaeus, ii. p. 40: ‘For
...
without intermediary because of the fleece \footnote{sc. the golden fleece of
the ram which carried Phrixus and Helle away from Athamas and Ino. When he
reached Colchis Phrixus sacrificed the ram to Zeus.}. He says
...
Abantis aforetime, but Zeus then called it Euboea after the cow.’ \footnote{Euboea properly means the
...
\xsection{Fragments of Unknown Position}

Fragment \#1—Diogenes Laertius, viii. 1. 26: \footnote{This and the following
fragment are meant to be read together.—DBK} ‘So
...
\footnote{cp. Hesiod
\emph{Theogony} 81 ff. But Theognis 169, ‘Whomso the god honour,
even a man inclined to blame praiseth him’, is much nearer.}, servant of the sweet Muses:
‘whomsoever the immortals honour, the good report of mortals also
followeth him.’

\xsection{Doubtful Fragments}
...
‘Aegle and Erythea and ox-eyed Hesperethusa.’ \footnote{Cf. Scholion on Clement,
“Protrept.” i. p. 302.}

Fragment \#6—Plato, Republic, iii. 390 E: ‘Gifts move the gods,
gifts move worshipful princes.’

Fragment \#7—\footnote{This line may once have
been read in the text of \emph{Works and Days} after l. 771.} Clement of Alexandria, Strom. v.
...
\xchapter{The Homeric Hymns}

\xsection{I. to Dionysus}

\footnote{ll. 1-9 are preserved by
...
Naxos, O Heaven-born, Insewn \footnote{Dionysus, after his
untimely birth from Semele, was sewn into the thigh of Zeus.}; and others by the deep-eddying
...
(ll. 10-12) ‘...and men will lay up for her \footnote{\emph{sc}. Semele. Zeus is
here speaking.} many
offerings in her shrines. And as these things are three \footnote{The reference is
apparently to something in the body of the hymn, now lost.}, so shall mortals ever sacrifice
...
horses sprang out upon her—the Son of Cronos, He who has many names \footnote{The Greeks feared to name
...
hands before her face. A long time she sat upon the stool \footnote{Demeter chooses the
lowlier seat, supposedly as being more suitable to her assumed condition, but
really because in her sorrow she refuses all comforts.} without speaking because of her
...
bade. So the great queen Deo received it to observe the sacrament.... \footnote{An act of
...
heedlessness of his nurse shall witchcraft hurt him nor yet the Undercutter \footnote{Undercutter and Woodcutter
are probably popular names (after the style of Hesiod’s ‘Boneless
One’) for the worm thought to be the cause of teething and toothache.}: for I know a charm far stronger
...
in a lovely meadow, Leucippe \footnote{The list of names is
taken—with five additions—from Hesiod, \emph{Theogony} 349
ff.: for their general significance see note on that passage.} and Phaeno and Electra and
...
sea in which were many men and goodly, Cretans from Cnossos \footnote{Inscriptions show that
there was a temple of Apollo Delphinius (cp. ii. 495-6) at Cnossus and a Cretan
month bearing the same name.}, the city of Minos, they who do
...
understand \footnote{sc. that the dolphin was
really Apollo.}; but they sought to cast the
...
Delphinius and overlooking \footnote{The epithets are
transferred from the god to his altar ‘Overlooking’ is especially
an epithet of Zeus, as in Apollonius Rhodius ii. 1124.} for ever. Afterwards, sup beside
...
Living, you shall be a spell against mischievous witchcraft \footnote{Pliny notices the efficacy
of the flesh of a tortoise against withcraft. In \emph{Geoponica} i. 14.
8 the living tortoise is prescribed as a charm to preserve vineyards from
hail.}; but if you die, then you shall
make sweetest song.
...
the front behind and the hind before, while he himself walked the other way \footnote{Hermes makes the cattle
...
sandals as a disguise.}. Then he wove sandals with
...
Pieria as he was preparing for his journey, making shift \footnote{Such seems to be the
meaning indicated by the context, though the verb is taken by Allen and Sikes
to mean, ‘to be like oneself’, and so ‘to be
original’.} as one making haste for a long
journey.
...
He chose a stout laurel branch and trimmed it with the knife.... ((LACUNA)) \footnote{Kuhn points out that there
...
belongs) must also have been mentioned.} ....held firmly in his hand: and
...
ground, and rolled them on their sides, bending their necks over \footnote{The cows being on their
sides on the ground, Hermes bends their heads back towards their flanks and so
can reach their backbones.}, and pierced their vital chord.
...
ages afterwards, a long, long time after all this, and are continually \footnote{O. Muller thinks the
...
some cave near Triphylian Pylos.}. Next glad-hearted Hermes dragged
...
was not prevailed upon to devour the flesh, although he greatly desired \footnote{Gemoll explains that
...
the position he claimed as one of the Twelve Gods?}. But he put away the fat and all
...
(ll. 190-200) ‘Old man, weeder \footnote{\emph{Lit}.
“thorn-plucker”.} of grassy
...
under the earth and be the leader amongst little folk.’ \footnote{Hermes is ambitious (l.
...
than one poor wretch bare this night \footnote{Literally, ‘you have
made him sit on the floor’, \emph{i.e.} ‘you have stolen everything
...
certain holy ones, sisters born—three virgins \footnote{The Thriae, who practised
...
first-born child of wily Cronos and youngest too \footnote{Cronos swallowed each of
...
Cronos. Cp. Hesiod \emph{Theogony}, ll. 495-7.}, by will
...
(ll. 75-88) \footnote{Mr. Evelyn-White prefers a
different order for lines \#87-90 than that preserved in the MSS. This
translation is based upon the following sequence: ll. 89,90,87,88.—DBK.} But she herself came to the
...
and marriageable \footnote{‘Cattle-earning’, because an accepted suitor paid for his bride in
cattle.} maidens, playing together; and an
...
continually. His name shall be Aeneas \footnote{The name Aeneas is here
connected with the epithet AIEOS (awful): similarly the name Odysseus is
derived (in \emph{Odyssey} i.62) from ODYSSMAI (I grieve).}, because
...
stature \footnote{Aphrodite extenuates her
...
my careful heart. But, as it is, harsh \footnote{So Christ connecting the
word with OMOS. L. and S. give = OMOIOS, ‘common to all’.} old age
...
swiftly over the sparkling sea Tyrsenian \footnote{Probably not Etruscans,
but the non-Hellenic peoples of Thrace and (according to Thucydides) of Lemnos
and Athens. Cp. Herodotus i. 57; Thucydides iv. 109.} pirates
...
\xsection{XIV. to the Mother of the Gods}
...
\xsection{XV. to Heracles the Lion-hearted}
...
(l. 12) Hail, Hermes, giver of grace, guide, and giver of good things! \footnote{This line appears to be an
...
and Bacchie Dionysus in especial; and they called the boy Pan \footnote{The name Pan is here
derived from PANTES, ‘all’. Cp. Hesiod, \emph{Works and
Days} ll. 80-82, \emph{Hymn to Aphrodite} (v) l. 198. for the
significance of personal names.} because he delighted all their
hearts.

(ll. 48-49) And so hail to you, lord! I seek your favour with a song. And now I
will remember you and another song also.

\xsection{XX. to Hephaestus}
...
\xsection{XXIII. to the Son of Cronos, Most High}
...
\xsection{XXV. to the Muses and Apollo}
...
(ll. 7-10) \footnote{Mr. Evelyn-White prefers
to switch l. 10 and 11, reading 11 first then 10.—DBK.} And you, slayer of Argus, Son of
...
\xsection{XXX. to Earth the Mother of All}
...
\xsection{XXXI. to Helios}

(ll. 1-16) \footnote{An extra line is inserted
in some MSS. after l. 15.— DBK.} And now, O Muse Calliope,
...
\xsection{XXXII. to Selene}

(ll. 1-13) And next, sweet voiced Muses, daughters of Zeus, well-skilled in
song, tell of the long-winged \footnote{The epithet is a usual one
for birds, cp. Hesiod, \emph{Works and Days}, l. 210; as applied to
Selene it may merely indicate her passage, like a bird, through the air, or
mean ‘far flying’.} Moon. From her immortal head a
...
\xsection{XXXIII. to the Dioscuri}
...
\xchapter{Homer’s Epigrams}

\footnote{The \emph{Epigrams}
are preserved in the pseudo-Herodotean \emph{Life of Homer}. Nos. III,
XIII, and XVII are also found in the \emph{Contest of Homer and Hesiod},
and No. I is also extant at the end of some MSS. of the \emph{Homeric
Hymns}.}
...
stream of sacred Meles; thence \footnote{sc. from Smyrna,
Homer’s reputed birth-place.} arose the daughters of Zeus,
...
hereafter—he who with scornful words to them \footnote{The councillors at Cyme
who refused to support Homer at the public expense.} contrived
...
X. (4 lines) (ll. 1-4) Another sort of pine shall bear a better fruit \footnote{The ‘better
fruit’ is apparently the iron smelted out in fires of pine-wood.} than you upon the heights of
...
XII. (4 lines) (ll. 1-4) Goddess-nurse of the young \footnote{Hecate: cp. Hesiod,
\emph{Theogony}, l. 450.}, give ear
...
for you. Come, then, Athena, with hand upraised \footnote{\emph{i.e.} in
protection.} over the
...
XV. (13 lines) \footnote{This song is called by
...
surviving English May-Day songs. Cp. Athenaeus, viii. 360 B.} (ll. 1-7) Let us betake us to the
...
carry home. \footnote{The lice which they caught
...
\xchapter{Fragments of the Epic Cycle}

\xsection{The War of the Titans}
...
\emph{War of the Titans} Heaven was the son of Aether.
...
Fragment \#4—Athenaeus, vii. 277 D: The poet of the \emph{War of the
...
the \emph{War of the Giants} says that Cronos took the shape of a horse
...
sailed across the sea in a cauldron \footnote{See the cylix reproduced
by Gerhard, \emph{Abhandlungen}, taf. 5,4. Cp. Stesichorus, Frag. 3 (Smyth).}; but the
first to give this story is the author of the \emph{War of the Titans}.

Fragment \#8—Philodemus, On Piety: The author of the \emph{War of the
Titans} says that the apples (of the Hesperides) were guarded.

\xsection{The Story of Oedipus}

Fragment \#1—C.I.G. Ital. et Sic. 1292. ii. 11: ....the \emph{Story of
...
of the Epic called the \emph{Story of Oedipus} clearly shows.

Fragment \#3—Scholiast on Euripides Phoen., 1750: The authors of the
\emph{Story of Oedipus} (say) of the Sphinx: ‘But furthermore (she
killed) noble Haemon, the dear son of blameless Creon, the comeliest and
loveliest of boys.’

\xsection{The Thebaid}
...
Oedipus noticed the haunch \footnote{The haunch was regarded as
a dishonourable portion.} he threw it on the ground and
...
‘wearing miserable garments, and took black-maned Areion \footnote{The horse of Adrastus,
offspring of Poseidon and Demeter, who had changed herself into a mare to
escape Poseidon.} with him.’

Fragment \#5—Pindar, Ol. vi. 15: \footnote{Restored from Pindar Ol.
...
Hipponous. The author of the \emph{Thebais} says that when Olenus had
...
\emph{Thebais} which tells of the death of Parthenopaeus says that it
was Periclymenus who killed him.

\xsection{The Epigoni}

Fragment \#1—Contest of Homer and Hesiod: Next (Homer composed) the
\emph{Epigoni} in seven thousand verses, beginning, ‘And now,
Muses, let us begin to sing of younger men.’

Fragment \#2—Photius, Lexicon: Teumesia. Those who have written on Theban
affairs have given a full account of the Teumesian fox. \footnote{So called from Teumessus,
a hill in Boeotia. For the derivation of Teumessus cp. Antimachus
\emph{Thebais} fr. 3 (Kinkel).} They relate that the creature was
...
the \emph{Thebais} say that Manto the daughter of Teiresias was sent to
...
Fragment \#1—Proclus, Chrestomathia, i: This \footnote{The preceding part of the
Epic Cycle (?).} is
continued by the epic called \emph{Cypria} which is current is eleven
...
serpent and the sparrows \footnote{While the Greeks were
...
to mean that the war would swallow up nine full years. Cp. \emph{Iliad}
ii, 299 ff.} takes place before them, and
...
\emph{Cypria} which the more part say was Homer’s work and by him
...
\emph{Cypria} says that Thetis, to please Hera, avoided union with Zeus,
...
head. The story is given by the author of the \emph{Cypria}.

Fragment \#6—Athenaeus, xv. 682 D, F: The author of the
\emph{Cypria}, whether Hegesias or Stasinus, mentions flowers used for
...
Fragment \#9—Scholiast on Euripides, Andr. 898: The writer \footnote{\emph{i.e.} Stasinus (or
Hegesias: cp. fr. 6): the phrase ‘Cyprian histories’ is equivalent
to “The Cypria”.} of the Cyprian histories says
...
\emph{Cypria} that Alexandrus came with Helen to Ilium from Sparta in
...
writer of the \emph{Cypria}—he makes them four, (distinguishing)
Iphigeneia and Iphianassa.

Fragment \#15—\footnote{These two lines possibly
belong to the account of the feast given by Agamemnon at Lemnos.} Contest of Homer and Hesiod:
...
Fragment \#17—Pausanias, iv. 2. 7: The poet of the \emph{Cypria}
...
Hypoplacian \footnote{sc. the Asiatic Thebes at
the foot of Mt. Placius.} Thebes, and that she had not
taken refuge there nor gone there to sacrifice to Artemis, as the author of the
\emph{Cypria} states, but was simply a fellow townswoman of Andromache.

Fragment \#19—Pausanias, x. 31. 2: I know, because I have read it in the
epic \emph{Cypria}, that Palamedes was drowned when he had gone out
...
\xsection{The Aethiopis}

Fragment \#1—Proclus, Chrestomathia, ii: The \emph{Cypria},
described in the preceding book, has its sequel in the \emph{Iliad} of
Homer, which is followed in turn by the five books of the
\emph{Aethiopis}, the work of Arctinus of Miletus. Their contents are as
...
\emph{Aethiopis} says that Aias killed himself about dawn.

\xsection{The Little Iliad}

Fragment \#1—Proclus, Chrestomathia, ii: Next comes the \emph{Little
...
achievements, says the poet of the \emph{Little Iliad}, and Nestor
...
Fragment \#4—Eustathius, 285. 34: The writer of the \emph{Little
Iliad} says that Aias was not buried in the usual way \footnote{sc. after cremation.}, but was simply buried in a
coffin, because of the king’s anger.

Fragment \#5—Eustathius on Homer, Il. 326: The author of the \emph{Little
...
Fragment \#8—Pausanias, iii. 26. 9: The writer of the epic \emph{Little
...
Fragment \#10—\footnote{This fragment comes from a
version of the \emph{Contest of Homer and Hesiod} widely different from
...
\emph{Little Iliad}. It is possible they may have introduced some
unusually striking incident, such as the actual Fall of Troy.} Plutarch, Moralia, p. 153 F: And
...
Fragment \#12—Pausanias, x. 25. 5: Meges is represented \footnote{\emph{i.e.} in the
paintings by Polygnotus at Delphi.} wounded in the arm just as
Lescheos the son of Aeschylinus of Pyrrha describes in his \emph{Sack of
...
Pausanias, x. 27. 1: Of them \footnote{\emph{i.e.} the dead
bodies in the picture.}, Lescheos says that Eion was
...
account in his \emph{Little Iliad}.
...
with a welcome prize. And he put Aeneas\footnote{According to this version
...
composed the \emph{Sack} says that Astyanax was also hurled from the
city wall.
...
them. Lysimachus, however, says that the author of the \emph{Sack}
...
this \footnote{sc. knowledge of both
surgery and of drugs.} does not apply to physicians
generally, but only to Machaon: and some say that he only practised surgery,
while Podaleirius treated sicknesses. Arctinus in the \emph{Sack of
...
\xsection{The Returns}

Fragment \#1—Proclus, Chrestomathia, ii: After the \emph{Sack of
Ilium} follow the \emph{Returns} in five books by Agias of Troezen.
...
\emph{Returns} says that Telemachus afterwards married Circe, while
Telegonus the son of Circe correspondingly married Penelope.

Fragment \#5—Clement of Alex. Strom., vi. 2. 12. 8: ‘For gifts
beguile men’s minds and their deeds as well.’ \footnote{Clement attributes this
line to Augias: probably Agias is intended.}

Fragment \#6—Pausanias, x. 28. 7: The poetry of Homer and the
\emph{Returns}—for here too there is an account of Hades and the
terrors there—know of no spirit named Eurynomus.

Athenaeus, 281 B: The writer of the “Return of the Atreidae” \footnote{Identical with the
\emph{Returns}, in which the Sons of Atreus occupy the most prominent
parts.} says that Tantalus came and lived
...
\xsection{The Telegony}

Fragment \#1—Proclus, Chrestomathia, ii: After the \emph{Returns}
comes the \emph{Odyssey} of Homer, and then the \emph{Telegony}
...
\emph{Telegony}, a Cyrenaean, relates that Odysseus had by Calypso a son
Telegonus or Teledamus, and by Penelope Telemachus and Acusilaus.

\xchapter{Homerica}

\xsection{The Expedition of Amphiaraus}

Fragment \#1—Pseudo-Herodotus, Life of Homer: Sitting there in the
tanner’s yard, Homer recited his poetry to them, the \emph{Expedition of
Amphiarus to Thebes} and the \emph{Hymns to the Gods} composed by
him.

\xsection{The Taking of Oechalia}
...
the attribution of the poem which they call the \emph{Taking of
...
those which now you see.’ This verse (\emph{Odyssey} xiv. 343) we
shall also find in the \emph{Taking of Oechalia}.
...
\xsection{The Phocais}

Fragment \#1—Pseudo-Herodotus, Life of Homer: While living with
Thestorides, Homer composed the \emph{Lesser Iliad} and the
\emph{Phocais}; though the Phocaeans say that he composed the latter
among them.

\xsection{The Margites}

Fragment \#1—Suidas, s.v.: Pigres. A Carian of Halicarnassus and brother
of Artemisia, wife of Mausolus, who distinguished herself in war... \footnote{This Artemisia, who
distinguished herself at the battle of Salamis (Herodotus, vii. 99) is here
confused with the later Artemisia, the wife of Mausolus, who died 350 B.C.} He also wrote the
\emph{Margites} attributed to Homer and the \emph{Battle of the Frogs
and Mice}.
...
hedge-hog’s one trick \footnote{\emph{i.e.} the fox knows
many ways to baffle its foes, while the hedge-hog knows one only which is far
more effectual.} can beat them all.’ \footnote{Attributed to Homer by
Zenobius, and by Bergk to the \emph{Margites}.}

\xsection{The Cercopes}

Fragment \#1—Suidas, s.v.: Cercopes. These were two brothers living upon
the earth who practised every kind of knavery. They were called Cercopes \footnote{\emph{i.e.}
‘monkey-men’.} because of their cunning doings:
...
\xsection{The Battle of Frogs and Mice}
...
which follows you still even when you dive down your hole. \footnote{Lines 42-52 are intrusive;
the list of vegetables which the Mouse cannot eat must follow immediately after
the various dishes of which he does eat.} I gnaw no radishes and cabbages
...
shall drown these dry-hobs \footnote{lit. ‘those unable
to swim’.} in the water, and merrily set up
...
the race of Frogs utterly \footnote{This may be a parody of
Orion’s threat in Hesiod, “Astronomy”, frag. 4.}, and splitting a chestnut-husk
...
\xchapter{Of the Origin of Homer and Hesiod, and of Their Contest}
...
first work was the \emph{Margites}.
...
the \emph{Margites}, he went about from city to city as a minstrel, and
...
dead; but beware of the riddle of the young children.’ \footnote{sc. the riddle of the
...
of doubtful meaning \footnote{The verses of Hesiod are
called doubtful in meaning because they are, if taken alone, either incomplete
or absurd.}: he recited many lines and
...
season.’ \footnote{\emph{Works and
Days}, ll. 383-392.}
...
felt no pang.’ \footnote{\emph{Iliad} xiii,
ll. 126-133, 339-344.}
...
place reciting his poems, and first of all the \emph{Thebais} in seven
thousand verses which begins: ‘Goddess, sing of parched Argos whence
kings...’, and then the \emph{Epigoni} in seven thousand verses
...
After this he composed the \emph{Odyssey} in twelve thousand verses,
having previously written the \emph{Iliad} in fifteen thousand five
hundred verses \footnote{The accepted text of the
\emph{Iliad} contains 15,693 verses; that of the \emph{Odyssey},
12,110.}. From Delphi, as we are told, he
...
linen jerkins, very goads of war.’ \footnote{\emph{Iliad} ii,
...
\emph{Hymn to Apollo} \footnote{\emph{Homeric
Hymns}, iii.} which begins: ‘I will
