\xchapter{The Elder Eddas of Saemund.}
...
generation.\footnote{The following, the first among many, may serve as a
specimen.
...
departure.''} Sæmund died at the age of 77, leaving behind him a work
...
Poetic Edda,\footnote{Bishop P.E. Muller supposes the greater number of the
Eddaic poems to be of the 8th century. Sagabibliothek II, p, 131.} was Brynjolf Svensson, bishop of Skalholt. This
...
to be made, which he entitled \emph{Edda Saemundi Multiscii}. The
...
Copenhagen, where it now is.\footnote{Codex Regius, No. 2365, 4to. The handwriting of this MS.
is supposed to be of the beginning of the 14th century.} As many of the Eddaic poems appear to
...
Swedish king Nidud. Volund (\emph{Ger}. Wieland, \emph{Fr}. Veland and Galans)
...
Consolatione, renders the words \emph{fidelis ossa Fabricii, etc}. by Hwæt
...
\textbf{Sigi}, king of Hunaland, said to be a son of Odin\\
|\\
\textbf{Rerir}\\
|\\
\textbf{Volsung} = a daughter of the giant Hrimnir\\
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_|\\
|\\
\textbf{Sigmund} = Signi = Borghild = Hiordis\\
| | | |\\
Hamund. \textbf{Sinfiotli}. \textbf{Helgi} = Sigrun \textbf{Sigurd} = Gudrun\\
\_\_|\_\_\_\_\_\_\_\_\_\_\_\_\\
| |\\
\textbf{Sigmund}, Svanhild.\\
m Jornmnrek.\\
\\
\\
\textbf{Giuki} = Grimhild.\\
\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_|\\
|\\
\textbf{Gunnar}=Glaumvor. \textbf{Hogni}=Kostbera. \textbf{Guthorm}. \textbf{Gudrun}, = 1 Sigurd.\\
| 2 Atli.\\
...
\textbf{Budli}.\\
|\\
\textbf{Atli} = Gudrun: \textbf{Brynhild} = Gunnar. Oddrun. Beckhild = Heimir.\\
| |\\
Erp. Eitil Alsvid.\\
\\
\\
...
1241,\footnote{Snorre, at the death of John Loptson (A.D. 1197), does
...
the men, as in the Pagan times.} by three of his sons-in-law and a stepson. When Snorre was
...
of—1. \emph{Formali} (Fore discourse); or the prologue. 2. \emph{Gylfa-ginning}
(The deluding of Gylfi). 3. \emph{Braga-roedur} (Conversations of Bragi).
4. \emph{Eptirmali} (After discourse); or Epilogue. The Prologue and
...
\xchapter{Introduction to the Voluspa.}
...
means of \emph{seid}, during the night, while all others in the house were
...
\xchapter{Völuspâ. The Vala's Prophecy.}

\textbf{1.} For silence I pray all sacred children, great and small, sons of
Heimdall,\footnote{In the Rigsmal we are informed how Heimdall, under the
name of Rig, became the progenitor of the three orders of mankind.} they will that I Valfather's deeds recount, men's ancient
saws, those that I best remember.

\textbf{2.} The Jötuns I remember early born, those who me of old have
reared. I nine worlds remember, nine trees, the great central tree,
beneath the earth.

\textbf{3.} There was in times of old, where Ymir dwelt, nor sand nor sea,
nor gelid waves; earth existed not, nor heaven above, 'twas a chaotic
chasm, and grass nowhere.

\textbf{4.} Before Bur's sons raised up heaven's vault, they who the noble
mid-earth shaped. The sun shone from the south over the structure's
rocks: then was the earth begrown with herbage green.

\textbf{5.} The sun from the south, the moon's companion, her right hand cast
about the heavenly horses. The sun knew not where she\footnote{In the Germanic tongues, as in the Semitic, the sun is
fem., the moon masc.} a dwelling
had, the moon knew not what power he possessed, the stars knew not
where they had a station.

\textbf{6.} Then went the powers all to their judgment-seats, the all-holy
...
\textbf{7.} The Æsir met on Ida's plain; they altar-steads and temples high
...
\textbf{21.} Alone she\footnote{The Vala here speaks of herself in the third person.} sat without, when came that ancient dread Æsir's
prince; and in his eye she gazed.

\textbf{22.} ``Of what wouldst thou ask me? Why temptest thou me? Odin! I know
all, where thou thine eye didst sink in the pure well of Mim.'' Mim
drinks mead each morn from Valfather's pledge.\footnote{His eye here understood to signify the sun.} Understand ye yet,
or what?

\textbf{23.} The chief of hosts gave her rings and necklace, useful
discourse, and a divining spirit: wide and far she saw o'er every
world.

\textbf{24.} She the Valkyriur saw from afar coming, ready to ride to the
...
\textbf{25.} She that war remembers, the first on earth, when Gullveig\footnote{A personification of gold. With the introduction of gold
was the end of the golden age.}
they with lances pierced, and in the high one's\footnote{\emph{i.e.}, Odin's: his hall is the world.} hall her burnt,
thrice burnt, thrice brought her forth, oft not seldom; yet she still
lives.

\textbf{26.} Heidi they called her, whithersoe'r she came, the
well-foreseeing Vala: wolves she tamed, magic arts she knew, magic
arts practised; ever was she the joy of evil people.

\textbf{27.} Then went the powers all to their judgment-seats, the all-holy
gods, and thereon held council, whether the Æsir should avenge the
crime,\footnote{Of introducing the use of gold.} or all the gods receive atonement.

\textbf{28.} Broken was the outer wall of the Æsir's burgh. The Vanir,
...
\textbf{52.} How is it with the Æsir? How with the Alfar? All Jötunheim
...
\textbf{53.} Then arises Hlîn's second grief, when Odin goes with the wolf to
fight, and the bright slayer of Beli with Surt. Then will Frigg's
beloved fall.

\textbf{54.} Then comes the great victor-sire's son, Vidar, to fight with the
deadly beast. He with his hands will make his sword pierce to the
heart of the giant's son: then avenges he his father.

\textbf{55.} Then comes the mighty son of Hlôdyn: (Odin's son goes with the
...
\textbf{39.} In Vanaheim wise powers him created, and to the gods a hostage
gave. At the world's dissolution, he will return to the wise Vanir.

\emph{Gagnrâd}.

\textbf{40.} Tell me eleventhly, since all the condition of the gods thou
knowest, Vafthrûdnir! what the Einheriar do in Haerfather's halls,
until the powers perish?

\emph{Vafthrûdnir}.

\textbf{41.} All the Einheriar in Odin's halls each day together fight; the
...
\textbf{42.} Tell me twelfthly, as thou all the condition of the gods
knowest, Vafthrûdnir! of the Jötuns' secrets, and of all the gods',
say what truest is, thou all-knowing Jötun!

\emph{Vafthrûdnir}.

\textbf{43.} Of the secrets of the Jötuns and of all the gods, I can truly
tell; for I have over each world travelled; to nine worlds I came, to
Niflhel beneath: here die men from Hel.

\emph{Gagnrâd}.

\textbf{44.} Much have I journeyed, much experienced, mighty ones many
proved. What mortals will live, when the great ``Fimbul''-winter shall
from men have passed?

\emph{Vafthrûdnir}.

\textbf{45.} Lif and Lifthrasir; but they will be concealed in Hoddmimir's
holt. The morning dews they will have for food. From, them shall men
be born.

\emph{Gagnrâd}.

\textbf{46.} Much have I journeyed, much experienced, mighty ones many
proved. Whence will come the sun in that fair heaven, when Fenrir has
this devoured?

\emph{Vafthrûdnir}.

\textbf{47.} A daughter shall Alfrödull bear, ere Fenrir shall have swallowed
her. The maid shall ride, when the powers die, on her mother's course.

\emph{Gagnrâd}.

\textbf{48.} Much have I journeyed, etc. Who are the maidens that o'er the
ocean travel, wise of spirit, journey?

\emph{Vafthrûdnir}.

\textbf{49.} O'er people's dwellings three descend of Mögthrasir's maidens,
the sole Hamingiur who are in the world, although with Jötuns
nurtured.

\emph{Gagnrâd}.

\textbf{50.} Much have I journeyed, etc. Which of the Æsir will rule o'er the
gods' possession, when Surt's fire shall be quenched?

\emph{Vafthrûdnir}.

\textbf{51.} Vidar and Vali will the gods' holy fanes inhabit, when Surt's
fire shall be quenched. Môdi and Magni will Miöllnir possess, and
warfare strive to end.

\emph{Gagnrâd}.

\textbf{52.} Much have I journeyed, etc. What of Odin will the life's end be,
when the powers perish?

\emph{Vafthrûdnir}.

\textbf{53.} The wolf will the father of men devour; him Vidar will avenge:
he his cold jaws will cleave, in conflict with the wolf.

\emph{Gagnrâd}.

\textbf{54.} Much have I journeyed, etc. What said Odin in his son's ear, ere
he on the pile was laid?

\emph{Vafthrûdnir}.

\textbf{55.} That no one knoweth, what thou in days of old saidst in thy
...
\textbf{28.} Vina one is called, a second Vegsvin, a third Thiodnuma; Nyt and
...
\textbf{29.} Körmt and Ormt, and the Kerlaugs twain: these Thor must wade
each day, when he to council goes at Yggdrasil's ash; for the
As-bridge is all on fire, the holy waters boil.

\textbf{30.} Glad and Gyllir, Gler and Skeidbrimir, Sillfrintopp and Sinir,
...
\textbf{31.} Three roots stand on three ways under Yggdrasil's ash: Hel under
one abides, under the second the Hrimthursar, under the third mankind.

\textbf{32.} Ratatösk is the squirrel named, which, has to run in Yggdrasil's
ash; he from above the eagle's words must carry, and beneath to
Nidhögg repeat.

\textbf{33.} Harts there are also four, which from its summits, arch-necked,
gnaw. Dâin and Dvalin, Duneyr and Durathrôr.

\textbf{34.} More serpents lie under Yggdrasil's ash, than any one would
...
\textbf{35.} Yggdrasil's ash hardship suffers greater than men know of; a
hart bites it above, and in its side it rots, Nidhögg beneath tears
it.

\textbf{36.} Hrist and Mist the horn shall bear me Skeggöld and Skögul, Hlökk
and Herfiotur, Hildi and Thrûdi, Göll and Geirölul, Randgríd and
Râdgrîd, and Reginleif, these bear beer to the Einheriar.

\textbf{37.} Arvakr and Alsvid, theirs 'tis up hence fasting the sun to draw:
under their shoulder the gentle powers, the Æsir, have concealed an
iron-coolness.

\textbf{38.} Svalin the shield is called, which stands before the sun, the
refulgent deity; rocks and ocean must, I ween, be burnt, fell it from
its place.

\textbf{39.} Sköll the wolf is named, that the fair-faced goddess to the
ocean chases; another Hati hight, he is Hrôdvitnir's son; he the
bright maid of heaven shall precede.

\textbf{40.} Of Ymir's flesh was earth created, of his blood the sea, of his
bones the hills, of his hair trees and plants, of his skull the
heaven;

\textbf{41.} And of his brows the gentle powers formed Midgard for the sons
of men; but of his brain the heavy clouds are all created.

\textbf{42.} Ullr's and all the gods' favour shall have, whoever first shall
look to the fire; for open will the dwelling be, to the Æsir's sons,
when the kettles are lifted off.\footnote{What in this strophe is said of Ullr has apparently
...
\textbf{43.} Ivaldi's sons went in days of old Skidbladnir to form, of ships
the best, for the bright Frey, Niörd's benign son.

\textbf{44.} Yggdrasil's ash is of all trees most excellent, and of all
...
\textbf{45.} Now I my face have raised to the gods' triumphant sons, at that
will welcome help awake; from all the Æsir, that shall penetrate, to
Oegir's bench, to Oegir's compotation.\footnote{My version of this strophe is not in accordance with
...
\textbf{46.} I am called Grim, I am called Gangleri, Herian and Hiâlmberi,
Thekk and Thridi, Thund and Ud, Helblindi and Har,

\textbf{47.} Sad and Svipall, and Sanngetall, Herteit and Hnikar Bileyg,
Bâleyg, Bölverk, Fiölnir, Grîm and Grimnir, Glapsvid and Fiölsvid,

\textbf{48.} Sîdhött, Sîdskegg Sigfödr, Hnikud, Alfodr, Valfödr, Atrid and
Farmatyr; by one name I never have been called, since among men I have
gone.

\textbf{49.} Grimnir I am called at Geirröd's, and at Asmund's Jâlk and
...
\textbf{50.} Svidur and Svidrir I was at Sökkmimir's called, and beguiled
that ancient Jötun, when of Midvitnir's renowned son I was the sole
destroyer.

\textbf{51.} Drunken art thou, Geirröd, thou hast drunk too much, thou art
greatly by mead beguiled. Much didst thou lose, when thou wast of my
help bereft, of all the Einheriar's and Odin's favour.

\textbf{52.} Many things I told thee, but thou hast few remembered: thy
friends mislead thee. My friend's sword lying I see, with blood all
dripping.

\textbf{53.} The fallen by the sword Ygg shall now have; thy life is now run
out: Wroth with thee are the Dîsir: Odin thou now shalt see: draw near
to me if thou canst.

\textbf{54.} Odin I now am named, Ygg I was called before, before that,
...
\xchapter{The Lay of Vegtam, or Baldr's Dreams.}

\textbf{1.} Together were the Æsir all in council, and the Asyniur all in
conference, and they consulted, the mighty gods, why Baldr had
oppressive dreams.

\textbf{2.} [To that god his slumber was most afflicting; his auspicious
dreams seemed departed. They the Jötuns questioned, wise seers of the
future, whether this might not forebode calamity?

\textbf{3.} The responses said that to death destined was Ullr's kinsman, of
all the dearest: that caused grief to Frigg and Svafnir, and to the
other powers—On a course they resolved:

\textbf{4.} That they would send to every being, assurance to solicit, Baldr
not to harm. All species swore oaths to spare him; Frigg received all
their vows and compacts.

\textbf{5.} Valfather fears something defective; he thinks the Hamingiur may
have departed; the Æsir he convenes, their counsel craves: at the
deliberation much is devised.]

\textbf{6.} Uprose Odin lord of men and on Sleipnir he the saddle laid; rode
thence down to Niflhel. A dog he met, from Hel coming.

\textbf{7.} It was blood-stained on its breast, on its slaughter-craving
throat, and nether jaw. It bayed and widely gaped at the sire of magic
song:—long it howled.

\textbf{8.} Forth rode Odin—the ground rattled—till to Hel's lofty house he
came. Then rode Ygg to the eastern gate, where he knew there was a
Vala's grave.

\textbf{9.} To the prophetess, he began a magic song to chant, towards the
...
\textbf{17.} ``Be not silent, Vala! I will question thee, until I know all. I
...
\textbf{18.} ``Not Vegtam art thou, as I before believed; rather art thou
Odin, lord of men!''

\emph{Odin}.

\textbf{19.} ``Thou art no Vala, nor wise woman, rather art thou the mother of
three Thursar.''

\emph{Vala}.

\textbf{20.} ``Home ride thou, Odin! and exult. Thus shall never more man
again visit me, until Loki free from his bonds escapes, and Ragnarök
all-destroying comes.''

\xchapter{The High One's Lay.}

\footnote{Odin is the ``High One.'' The poem is a collection of
rules and maxims, and stories of himself, some of them not very
consistent with our ideas of a supreme deity.}

\textbf{1.} All door-ways, before going forward, should be looked to; for
difficult it is to know where foes may sit within a dwelling.

\textbf{2.} Givers, hail! A guest is come in: where shall he sit? In much
haste is he, who on the ways has to try his luck.

\textbf{3.} Fire is needful to him who is come in, and whose knees are
frozen; food and raiment a man requires, wheo'er the fell has
travelled.

\textbf{4.} Water to him is needful who for refection comes, a towel and
hospitable invitation, a good reception; if he can get it, discourse
and answer.

\textbf{5.} Wit is needful to him who travels far: at home all is easy. A
laughing-stock is he who nothing knows, and with the instructed sits.

\textbf{6.} Of his understanding no one should be proud, but rather in
...
\textbf{7.} A wary guest,\footnote{In the Copenhagen paper Ms. F. this strophe begins with
...
Bask, and in the Swedish translation by Afzelius.} who to refection comes, keeps a cautious
silence, with his ears listens, and with his eyes observes: so
explores every prudent man.

\textbf{8.} He is happy, who for himself obtains fame and kind words: less
sure is that which a man must have in another's breast.

\textbf{9.} He is happy, who in himself possesses fame and wit while living;
for bad counsels have oft been received from another's breast.

\textbf{10.} A better burthen no man bears on the way than much good sense;
that is thought better than riches in a strange place; such is the
recourse of the indigent.

\textbf{11.} A worse provision on the way he cannot carry than too much
beer-bibbing; so good is not, as it is said, beer for the sons of men.

\textbf{12.} A worse provision no man can take from table than too much
beer-bibbing: for the more he drinks the less control he has of his
own mind.

\textbf{13.} Oblivion's heron 'tis called that over potations hovers; he
steals the minds of men. With this bird's pinions I was fettered in
Gunnlods dwelling.

\textbf{14.} Drunk I was, I was over-drunk, at that cunning Fialar's. It's
the best drunkenness, when every one after it regains his reason.

\textbf{15.} Taciturn and prudent, and in war daring, should a king's
children be; joyous and liberal every one should be until his hour of
death.

\textbf{16.} A cowardly man thinks he will ever live, if warfare he avoids;
but old age will give him no peace, though spears may spare him.

\textbf{17.} A fool gapes when to a house he comes, to himself mutters or is
silent; but all at once, if he gets drink, then is the man's mind
displayed.

\textbf{18.} He alone knows who wanders wide, and has much experienced, by
what disposition each man is ruled, who common sense possesses.

\textbf{19.} Let a man hold the cup, yet of the mead drink moderately, speak
sensibly or be silent. As of a fault no man will admonish thee, if
thou goest betimes to sleep.

\textbf{20.} A greedy man, if he be not moderate, eats to his mortal sorrow.
Oftentimes his belly draws laughter on a silly man, who among the
prudent comes.

\textbf{21.} Cattle know when to go home, and then from grazing cease; but a
foolish man never knows his stomach's measure.

\textbf{22.} A miserable man, and ill-conditioned, sneers at every thing: one
thing he knows not, which he ought to know, that he is not free from
faults.

\textbf{23.} A foolish man is all night awake, pondering over everything; he
then grows tired; and when morning comes, all is lament as before.

\textbf{24.} A foolish man thinks all who on him smile to be his friends; he
feels it not, although they speak ill of him, when he sits among the
clever.

\textbf{25.} A foolish man thinks all who speak him fair to be his friends;
but he will find, if into court he comes, that he has few advocates.

\textbf{26.} A foolish man thinks he knows everything if placed in unexpected
difficulty; but he knows not what to answer, if to the test he is put.

\textbf{27.} A foolish man, who among people comes, had best be silent; for
...
\textbf{28.} He thinks himself wise, who can ask questions and converse also;
conceal his ignorance no one can, because it circulates among men.

\textbf{29.} He utters too many futile words who is never silent; a garrulous
tongue, if it be not checked, sings often to its own harm.

\textbf{30.} For a gazing-stock no man shall have another, although he come a
stranger to his house. Many a one thinks himself wise, if he is not
questioned, and can sit in a dry habit.

\textbf{31.} Clever thinks himself the guest who jeers a guest, if he takes
to flight. Knows it not certainly he who prates at meat, whether he
babbles among foes.

\textbf{32.} Many men are mutually well-disposed, yet at table will torment
each other. That strife will ever be; guest will guest irritate.

\textbf{33.} Early meals a man should often take, unless to a friend's house
he goes; else he will sit and mope, will seem half-famished, and can
of few things inquire.

\textbf{34.} Long is and indirect the way to a bad friend's, though by the
road he dwell; but to a good friend's the paths lie direct, though he
be far away.

\textbf{35.} A guest should depart, not always stay in one place. The welcome
becomes unwelcome, if he too long continues in another's house.

\textbf{36.} One's own house is best, small though it be; at home is every
one his own master. Though he but two goats possess, and a
straw-thatched cot, even that is better than begging.

\textbf{37.} One's own house is best, small though it be, at home is every
one his own master. Bleeding at heart is he, who has to ask for food
at every meal-tide.

\textbf{38.} Leaving in the field his arms, let no man go a foot's length
forward; for it is hard to know when on the way a man may need his
weapon.

\textbf{39.} I have never found a man so bountiful, or so hospitable that he
refused a present; or of his property so liberal that he scorned a
recompense.

\textbf{40.} Of the property which he has gained no man should suffer need;
for the hated oft is spared what for the dear was destined. Much goes
worse than is expected.

\textbf{41.} With arms and vestments friends should each other gladden, those
which are in themselves most sightly. Givers and requiters are longest
friends, if all [else] goes well.\footnote{The sense of this line seems doubtful; I have adopted
the version of Finn Magnusen.}

\textbf{42.} To his friend a man should be a friend, and gifts with gifts
requite. Laughter with laughter men should receive, but leasing with
lying.

\textbf{43.} To his friend a man should be a friend; to him and to his
friend; but of his foe no man shall the friend's friend be.

\textbf{44.} Know, if thou hast a friend whom thou fully trustest, and from
whom thou woulds't good derive, thou shouldst blend thy mind with his,
and gifts exchange, and often go to see him.

\textbf{45.} If thou hast another, whom thou little trustest, yet wouldst
good from him derive, thou shouldst speak him fair, but think
craftily, and leasing pay with lying.

\textbf{46.} But of him yet further, whom thou little trustest, and thou
...
\textbf{47.} I was once young, I was journeying alone, and lost my way; rich
I thought myself, when I met another. Man is the joy of man.

\textbf{48.} Liberal and brave men live best, they seldom cherish sorrow; but
a base-minded man dreads everything; the niggardly is uneasy even at
gifts.

\textbf{49.} My garments in a field I gave away to two wooden men: heroes
they seemed to be, when they got cloaks: exposed to insult is a naked
man.

\textbf{50.} A tree withers that on a hill-top stands; protects it neither
bark nor leaves: such is the man whom no one favours: why should he
live long?

\textbf{51.} Hotter than fire love for five days burns between false
friends; but is quenched when the sixth day comes, and-friendship is
all impaired.

\textbf{52.} Something great is not [always] to be given, praise is often for
a trifle bought. With half a loaf and a tilted vessel I got myself a
comrade.

\textbf{53.} Little are the sand-grains, little the wits, little the minds of
[some] men; for all men are not wise alike: men are everywhere by
halves.

\textbf{54.} Moderately wise should each one be, but never over-wise: of
those men the lives are fairest, who know much well.

\textbf{55.} Moderately wise should each one be, but never over-wise; for a
wise man's heart is seldom glad, if he is all-wise who owns it.

\textbf{56.} Moderately wise should each one be, but never over-wise. His
destiny let know no man beforehand; his mind will be freest from'
care.

\textbf{57.} Brand burns from brand until it is burnt out; fire is from fire
quickened. Man to' man becomes known by speech, but a fool by his
bashful silence.

\textbf{58.} He should early rise, who another's property or wife desires to
have. Seldom a sluggish wolf gets prey, or a sleeping man victory.

\textbf{59.} Early should rise he who has few workers, and go his work to see
to; greatly is he retarded who sleeps the morn away. Wealth half
depends on energy.

\textbf{60.} Of dry planks and roof-shingles a man knows the measure; of the
fire-wood that may suffice, both measure and time.

\textbf{61.} Washed and refected let a man ride to the Thing,\footnote{The public meeting.} although
...
\textbf{62.} Inquire and impart should every man of sense, who will be
accounted sage. Let one only know, a second may not; if three, all the
world knows.

\textbf{63.} Gasps and gapes, when to the sea he comes, the eagle over old
ocean; so is a man, who among many comes, and has few advocates.

\textbf{64.} His power should every sagacious man use with discretion; for he
will find, when among the bold he comes, that no one alone is
doughtiest.

\textbf{65.} Circumspect and reserved every man should be, and wary in
trusting friends. Of the words that a man says to another he often
pays the penalty.

\textbf{66.} Much too early I came to many places, but too late to others:
the beer was drunk, or not ready: the disliked seldom hits the moment.

\textbf{67.} Here and there I should have been invited, if I a meal had
needed; or two hams had hung, at that true friend's, where of one I
had eaten.

\textbf{68.} Fire is best among the sons of men, and the sight of the sun, if
his health a man can have, with a life free from vice.

\textbf{69.} No man lacks everything, although his health be bad: one in his
sons is happy, one in his kin, one in abundant wealth, one in his good
works.

\textbf{70.} It is better to live, even to live miserably; a living man can
always get a cow. I saw fire consume the rich man's property, and
death stood without his door.

\textbf{71.} The halt can ride on horseback, the one-handed drive cattle; the
deaf fight and be useful: to be blind is better than to be burnt\footnote{That is dead on the funeral pyre.}
no one gets good from a corpse.

\textbf{72.} A son is better, even if born late, after his father's
departure. Gravestones seldom stand by the way-side unless raised by a
kinsman to a kinsman.

\textbf{73.} Two are adversaries: the tongue is the bane of the head: under
every cloak I expect a hand. * * *

\textbf{74.} At night is joyful he who is sure of travelling entertainment.
[A ship's yards are short.]\footnote{This line is evidently an interpolation.} Variable is an autumn night. Many are
the weather's changes in five days, but more in a month.

\textbf{75.} He [only] knows not who knows nothing, that many a one apes
another. One man is rich, another poor: let him not be thought
blameworthy.

\textbf{76.} Cattle die, kindred die, we ourselves also die; but the fair
fame never dies of him who has earned it.

\textbf{77.} Cattle die, kindred die, we ourselves also die; but I know one
thing that never dies,—judgment on each one dead.

\textbf{78.} Full storehouses I saw at Dives' sons': now bear they the
beggar's staff. Such are riches; as is the twinkling of an eye: of
friends they are most fickle.

\textbf{79.} A foolish man, if he acquires wealth or woman's love, pride
grows within him, but wisdom never: he goes on more and more arrogant.

\textbf{80.} Then 'tis made manifest, if of runes thou questionest him, those
to the high ones known, which the great powers invented, and the
great talker\footnote{Odin.} painted, that he had best hold silence.

\textbf{81.} At eve the day is to be praised, a woman after she is burnt, a
sword after it is proved, a maid after she is married, ice after it
has passed away, beer after it is drunk.

\textbf{82.} In the wind one should hew wood, in a breeze row out to sea, in
...
\textbf{83.} By the fire one should drink beer, on the ice slide; buy a horse
that is lean, a sword that is rusty; feed a horse at home, but a dog
at the farm.

\textbf{84.} In a maiden's words no one should place faith, nor in what a
woman says; for on a turning wheel have their hearts been formed, and
guile in their breasts been laid;

\textbf{85.} In a creaking bow, a burning flame, a yawning wolf, a chattering
crow, a grunting swine, a rootless tree, a waxing wave, a boiling
kettle,

\textbf{86.} A flying dart, a falling billow, a one night's ice, a coiled
serpent, a woman's bed-talk, or a broken sword, a bear's play, or a
royal child,

\textbf{87.} A sick calf, a self-willed thrall, a flattering prophetess, a
corpse newly slain, [a serene sky, a laughing lord, a barking dog, and
a harlot's grief];

\textbf{88.} An early sown field let no one trust, nor prematurely in a son:
weather rules the field, and wit the son, each of which is doubtful;

\textbf{89.} A brother's murderer, though on the high road met, a half-burnt
house, an over-swift horse, (a horse is useless, if a leg be broken),
no man is so confiding as to trust any of these.

\textbf{90.} Such is the love of women, who falsehood meditate, as if one
...
as if the halt were set to catch a reindeer in the thawing fell.\footnote{From this line it appears that the poem is of Norwegian
...
\textbf{91.} Openly I now speak, because I both sexes know: unstable are
men's minds towards women; 'tis then we speak most fair when we most
falsely think: that deceives even the cautious.

\textbf{92.} Fair shall speak, and money offer, who would obtain a woman's
love. Praise the form of a fair damsel; he gets who courts her.

\textbf{93.} At love should no one ever wonder in another: a beauteous
countenance oft captivates the wise, which captivates not the foolish.

\textbf{94.} Let no one wonder at another's folly, it is the lot of many.
All-powerful desire makes of the sons of men fools even of the wise.

\textbf{95.} The mind only knows what lies near the heart, that alone is
conscious of our affections. No disease is worse to a sensible man
than not to be content with himself.

\textbf{96.} That I experienced, when in the reeds I sat, awaiting my
delight. Body and soul to me was that discreet maiden: nevertheless I
possess her not.

\textbf{97.} Billing's lass\footnote{The story of Odin and Billing's daughter is no longer
extant; but compare the story of Odin and Rinda in Saxo, p. 126, edit.
Muller \& Veleschow.} on her couch I found, sun-bright, sleeping. A
prince's joy to me seemed naught, if not with that form to live.

\textbf{98.} ``Yet nearer eve must thou, Odin, come, if thou wilt talk the
maiden over; all will be disastrous, unless we alone are privy to such
misdeed.''

\textbf{99.} I returned, thinking to love, at her wise desire. I thought I
should obtain her whole heart and love.

\textbf{100.} When next I came the bold warriors were all awake, with lights
burning, and bearing torches: thus was the way to pleasure closed.

\textbf{101.} But at the approach of morn, when again I came, the household
all was sleeping; the good damsel's dog alone I found tied to the bed.

\textbf{102.} Many a fair maiden, when rightly known, towards men is fickle:
...
\textbf{103.} At home let a man be cheerful, and towards a guest liberal; of
wise conduct he should be, of good memory and ready speech; if much
knowledge he desires, he must often talk on good.

\textbf{104.} Fimbulfambi he is called who' little has to say: such is the
nature of the simple.

\textbf{105.} The old Jotun I sought; now I am come back: little got I there
by silence; in many words I spoke to my advantage in Suttung's halls.

\textbf{106.} Gunnlod gave me, on her golden seat, a draught of the precious
mead; a bad recompense I afterwards made her, for her whole soul, her
fervent love.

\textbf{107.} Rati's mouth I caused to make a space, and to gnaw the rock;
over and under me were the Jotun's ways: thus I my head did peril.

\textbf{108.} Of a well-assumed form I made good use: few things fail the
wise; for Odhrærir is now come up to men's earthly dwellings.

\textbf{109.} 'Tis to me doubtful that I could have come from the Jotun's
courts, had not Gunnlod aided me, that good damsel, over whom I laid
my arm.

\textbf{110.} On the day following came the Hrimthursar, to learn something
...
\textbf{111.} Odin, I believe, a ring-oath\footnote{In the pagan North oaths were taken on a holy ring or
bracelet, as with us on the Gospels, a sacred ring being kept in the
temple for the purpose.} gave. Who in his faith will
trust? Suttung defrauded, of his drink bereft, and Gunnlod made to
weep!

\textbf{112.} Time 'tis to discourse from the preacher's chair. By the well
of Urd I silent sat, I saw and meditated, I listened to men's words.

\textbf{113.} Of runes I heard discourse, and of things divine, nor of
graving them were they silent, nor of sage counsels, at the High One's
hall. In the High One's hall. I thus heard say:

\textbf{114.} I counsel thee, Loddfafnir, to take advice: thou wilt profit if
thou takest it. Rise not at night, unless to explore, or art compelled
to go out.

\textbf{115.} I counsel thee, Loddfafnir, to take advice, thou wilt profit if
thou takest it. In an enchantress's embrace thou mayest not sleep, so
that in her arms she clasp thee.

\textbf{116.} She will be the cause that thou carest not for Thing or
prince's words; food thou wilt shun and human joys; sorrowful wilt
thou go to sleep.

\textbf{117.} I counsel thee, etc. Another's wife entice thou never to secret
converse.

\textbf{118.} I counsel thee, etc. By fell or firth if thou have to travel,
provide thee well with food.

\textbf{119.} I counsel thee, etc. A bad man let thou never know thy
misfortunes; for from a bad man thou never wilt obtain a return for
thy good will.

\textbf{120.} I saw mortally wound a man a wicked woman's words; a false
tongue caused his death, and most unrighteously.

\textbf{121.} I counsel thee, etc. If thou knowest thou hast a friend, whom
thou well canst trust, go oft to visit him; for with brushwood
over-grown, and with high grass, is the way that no one treads.

\textbf{122.} I counsel thee, etc. A good man attract to thee in pleasant
converse; and salutary speech learn while thou livest.

\textbf{123.} I counsel thee, etc. With thy friend be thou never first to
quarrel. Care gnaws the heart, if thou to no one canst thy whole mind
disclose.

\textbf{124.} I counsel thee, etc. Words thou never shouldst exchange with a
witless fool;

\textbf{125.} For from an ill-conditioned man thou wilt never get a return
for good; but a good man will bring thee favour by his praise.

\textbf{126.} There is a mingling of affection, where one can tell another
all his mind. Everything is better than being with the deceitful. He
is not another's friend who ever says as he says.

\textbf{127.} I counsel thee, etc. Even in three words quarrel not with a
worse man: often the better yields, when the worse strikes.

\textbf{128.} I counsel thee, etc. Be not a shoemaker, nor a shaftmaker,
unless for thyself it be; for a shoe if ill made, or a shaft if
crooked, will call down evil on thee.

\textbf{129.} I counsel thee, etc. Wherever of injury thou knowest, regard
that injury as thy own; and give to thy foes no peace.

\textbf{130.} I counsel thee, etc. Rejoiced at evil be thou never; but let
good give thee pleasure.

\textbf{131.} I counsel thee, etc. In a battle look not up, (like swine the
sons of men then become) that men may not fascinate thee.

\textbf{132.} If thou wilt induce a good woman to pleasant converse, thou
must promise fair, and hold to it: no one turns from good if it can be
got.

\textbf{133.} I enjoin thee to be wary, but not over wary; at drinking be
thou most wary, and with another's wife; and thirdly, that thieves
delude thee not.

\textbf{134.} With insult or derision treat thou never a guest or wayfarer.
They often little know, who sit within, of what race they are who
come.

\textbf{135.} Vices and virtues the sons of mortals bear in their breasts
mingled; no one is so good that no failing attends him, nor so bad as
to be good for nothing.

\textbf{136.} At a hoary speaker laugh thou never; often is good that which
...
\textbf{137.} I counsel thee, etc. Rail not at a guest, nor from thy gate
thrust him; treat well the indigent; they will speak well of thee.

\textbf{138.} Strong is the bar that must be raised to admit all. Do thou
give a penny, or they will call down on thee every ill in thy limbs.

\textbf{139.} I counsel thee, etc. Wherever thou beer drinkest, invoke to
...
\xchapter{Odin's Rune-song.}

\footnote{The first eight strophes of this composition require an
...
\textbf{140.} I know that I hung, on a wind-rocked tree, nine whole nights,
with a spear wounded, and to Odin offered, myself to myself; on that
tree, of which no one knows from what root it springs.

\textbf{141.} Bread no one gave me, nor a horn of drink, downward I peered,
to runes applied myself, wailing learnt them, then fell down thence.

\textbf{142.} Potent songs nine from the famed son I learned of Bolthorn,
Bestla's sire, and a draught obtained of the precious mead, drawn from
Odhrærir.

\textbf{143.} Then I began to bear fruit, and to know many things, to grow
and well thrive: word by word I sought out words, fact by fact I
sought out facts.

\textbf{144.} Runes thou wilt find, and explained characters, very large
...
\textbf{145.} Odin among the Æsir, but among the Alfar, Dain, and Dvalin for
the dwarfs, Asvid for the Jotuns: some I myself graved.

\textbf{146.} Knowest thou how to grave them? knowest thou how to expound
...
to send?\footnote{Probably, send them (the runes) forth on their several
missions.} knowest thou how to consume?

\textbf{147.} 'Tis better not to pray than too much offer; a gift ever looks
...
\textbf{148.} Those songs I know which the king's wife knows not nor son of
man. Help the first is called, for that will help thee against strifes
and cares.

\textbf{149.} For the second I know, what the sons of men require, who will
as leeches live. * * * *

\textbf{150.} For the third I know,\footnote{The miraculous powers here ascribed by Odin to himself
bear, in many instances, a remarkable similarity to those attributed
to him by Snorri.} if I have great need to restrain my
foes, the weapons' edge I deaden: of my adversaries nor arms nor wiles
harm aught.

\textbf{151.} For the fourth I know, if men place bonds on my limbs, I so
sing that I can walk; the fetter starts from my feet, and the manacle
from my hands.

\textbf{152.} For the fifth I know, if I see a shot from a hostile hand, a
shaft flying amid the host, so swift it cannot fly that I cannot
arrest it, if only I get sight of it.

\textbf{153.} For the sixth I know, if one wounds me with a green tree's
roots;\footnote{The ancient inhabitants of the North believed that the
...
trees.} also if a man declares hatred to me, harm shall consume
them sooner than me.

\textbf{154.} For the seventh I know, if a lofty house I see blaze o'er its
inmates, so furiously it shall not burn that I cannot save it. That
song I can sing.

\textbf{155.} For the eighth I know, what to all is useful to learn: where
hatred grows among the sons of men—that I can quickly assuage.

\textbf{156.} For the ninth I know, if I stand in need my bark on the water
to save, I can the wind on the waves allay, and the sea lull.

\textbf{157.} For the tenth I know, if I see troll-wives sporting in air, I
can so operate that they will forsake their own forms, and their own
minds.

\textbf{158.} For the eleventh I know, if I have to lead my ancient friends
...
\textbf{165.} For the eighteenth I know that which I never teach to maid or
...
\textbf{166.} Now are sung the High-one's songs, in the High-one's hall, to
...
\xchapter{The Lay of Hymir.}

\textbf{1.} Once the celestial gods had been taking fish, and were in
compotation, ere they the truth discovered.\footnote{To wit, that they were short of kettles for brewing.} Rods\footnote{That is divining rods.} they shook,
and blood inspected, when they found at Oegir's a lack of kettles.

\textbf{2.} Sat the rock-dweller glad as a child, much like the son of
Miskorblindi. In his eyes looked Ygg's son steadfastly. ``Thou to the
Æsir shalt oft a compotation give.''

\textbf{3.} Caused trouble to the Jotun th' unwelcome-worded As: he forthwith
meditated vengeance on the gods. Sif's husband he besought a kettle
him to bring, ``in which I beer for all of you may brew.''

\textbf{4.} The illustrious gods found that impossible, nor could the exalted
powers it accomplish, till from true-heartedness, Ty to Hlorridi much
friendly counsel gave.

\textbf{5.} ``There dwells eastward of Elivagar the all-wise Hymir, at
heaven's end. My sire, fierce of mood, a kettle owns, a capacious
cauldron, a rast in depth.''

\emph{Thor}.

\textbf{6.} ``Knowest thou whether we can get the liquor-boiler?''
...
\textbf{7.} Thor stalled his goats, splendid of horn, then turned him to the
hall that Hymir owned. The son his granddam found to him most
loathful; heads she had nine hundred.

\textbf{8.} But another came all-golden forth, fair-browed, bearing the
beer-cup to her son:

\textbf{9.} ``Ye Jotuns' kindred! I will you both, ye daring pair, under the
kettles place. My husband is oftentimes niggard towards guests, to
ill-humour prone.''

\textbf{10.} But the monster, the fierce-souled Hymir, late returned home
from the chase. He the hall entered, the icebergs resounded, as the
churl approached; the thicket on his cheeks was frozen.

\textbf{11.} ``Hail to thee, Hymir! be of good cheer: now thy son is come to
thy hall, whom we expected from his long journey; him accompanies our
famed adversary, the friend of man, who Veor hight.

\textbf{12.} See where they sit under the hall's gable, as if to shun thee:
the pillar stands before them.'' In shivers flew the pillar at the
Jotun's glance; the beam was first broken in two.

\textbf{13.} Eight kettles fell, but only one of them, a hard-hammered
cauldron, whole from the column. The two came forth, but the old Jotun
with eyes surveyed his adversary.

\textbf{14.} Augured to him his mind no good, when he saw the giantess's
sorrow on the floor coming. Then were three oxen taken, and the Jotun
bade them forthwith be boiled.

\textbf{15.} Each one they made by the head shorter, and to the fire
afterwards bore them. Sif's consort ate, ere to sleep he went,
completely, he alone, two of Hymir's beeves.

\textbf{16.} Seemed to the hoary friend of Hrungnir Hlorridi's refection full
well large: ``We three to-morrow night shall be compelled on what we
catch to live.''

\textbf{17.} Veor said he would on the sea row, if the bold Jotun him would
with baits supply: ``To the herd betake thee, (if thou in thy courage
trustest, crusher of the rock-dwellers!) for baits to seek.

\textbf{18.} I expect that thou wilt bait from an ox easily obtain.'' The
guest in haste to the forest went, where stood an all-black ox before
him.

\textbf{19.} The Thursar's bane wrung from an ox the high fastness of his two
horns. ``To me thy work seems worse by far, ruler of keels! than if
thou hadst sat quiet.''

\textbf{20.} The lord of goats the apes' kinsman besought the horse of plank
farther out to move; but the Jotun declared his slight desire farther
to row.

\textbf{21.} The mighty Hymir drew, he alone, two whales up with his hook;
but at the stern abaft Veor cunningly made him a line.

\textbf{22.} Fixed on the hook the shield of men, the serpent's slayer, the
ox's head. Gaped at the bait the foe of gods, the encircler beneath of
every land.\footnote{The great serpent that encircles the earth.}

\textbf{23.} Drew up boldly the mighty Thor the worm with venom glistening,
up to the side; with his hammer struck, on his foul head's summit,
like a rock towering, the wolf's own brother.

\textbf{24.} The icebergs resounded, the caverns howled, the old earth shrank
together: at length the fish back into ocean sank.\footnote{According to the Prose Edda, the giant, overcome with
fright, took out his knife and severed Thor's line.}

\textbf{25.} The Jotun was little glad, as they rowed back, so that the
powerful Hymir nothing spake, but the oar moved in another course.

\textbf{26.} ``Wilt thou do half the work with me, either the whales home to
the dwelling bear, or the boat fast bind?''

\textbf{27.} Hlorridi went, grasped the prow, quickly, with its hold-water,
...
\textbf{28.} But the Jotun yet ever frowned, to strife accustomed, with Thor
disputed, said that no one was strong, however vigorously he might
row, unless he his cup could break.

\textbf{29.} But Hlorridi, when to his hands it came, forthwith brake an
upright stone in twain; sitting dashed the cup through the pillars:
yet they brought it whole to Hymir back.

\textbf{30.} Until the beauteous woman gave important, friendly counsel,
which she only knew: ``Strike at the head of Hymir, the Jotun with food
oppressed, that is harder than any cup.''

\textbf{31.} Rose then on his knee the stern lord of goats, clad in all his
godlike power. Unhurt remained the old man's helm-block, but the round
wine-bearer was in shivers broken.

\textbf{32.} ``Much good, I know, has departed from me, now that my cup I see
hurled from my knees.'' Thus the old man spake: ``I can never say again,
beer thou art too hot.

\textbf{33.} ``Now 'tis to be tried if ye can carry the beer-vessel out of our
dwelling.'' Ty twice assayed to move the vessel, yet at each time stood
the kettle fast.

\textbf{34.} Then Modi's father by the brim grasped it, and trod through the
dwelling's floor. Sif's consort lifted the kettle on his head, while
about his heels its rings jingled.

\textbf{35.} They had far journeyed before Odin's son cast one look backward:
he from the caverns saw, with Hymir from the east, a troop of
many-headed monsters coming.

\textbf{36.} From his shoulders he lifted the kettle down; Miollnir hurled
forth towards the savage crew, and slew all the mountain-giants, who
with Hymir had him pursued.

\textbf{37.} Long they had not journeyed when of Hlorridi's goats one lay
down half-dead before the car. It from the pole had sprung across the
trace; but the false Loki was of this the cause.

\textbf{38.} Now ye have heard,—for what fabulist can more fully tell—what
indemnity he from the giant got: he paid for it with his children
both.\footnote{This strophe belongs apparently to another poem.}

\textbf{39.} In his strength exulting he to the gods' council came, and had
the kettle, which Hymir had possessed, out of which every god shall
beer with Oegir drink at every harvest-tide.

\xchapter{The Lay of Thrym, or the Hammer Recovered.}

\textbf{1.} Wroth was Vingthor, when he awoke, and his hammer missed; his
beard he shook, his forehead struck, the son of earth felt all around
him;

\textbf{2.} And first of all these words he uttered: ``Hear now, Loki! what I
now say, which no one knows anywhere on earth, nor in heaven above;
the As's hammer is stolen!''

\textbf{3.} They went to the fair Freyia's dwelling, and he these words first
of all said: ``Wilt thou me, Freyia, thy feather-garment lend, that
perchance my hammer I may find?''

\emph{Freyia.}

\textbf{4.} ``That I would give thee, although of gold it were, and trust it
to thee, though it were of silver.''

\textbf{5.} Flew then Loki—the plumage rattled—until he came beyond the
Æsir's dwellings, and came within the Jotun's land.

\textbf{6.} On a mound sat Thrym, the Thursar's lord, for his greyhounds
plaiting gold bands and his horses' manes smoothing.

\textbf{7.} ``How goes it with the Æsir? How goes it with the Alfar? Why art
thou come alone to Jotunheim?''

\emph{Loki}.

\textbf{8.} ``Ill it goes with the Æsir, Ill it goes with the Alfar. Hast thou
Hlorridi's hammer hidden?''

\emph{Thrym}.

\textbf{9.} ``I have Hlorridi's hammer hidden eight rasts beneath the earth;
it shall no man get again, unless he bring me Freyia to wife.''

\textbf{10.} Flew then Loki—the plumage rattled—until he came beyond the
...
\textbf{11.} ``Hast thou had success as well as labour? Tell me from the air
the long tidings. Oft of him who sits are the tales defective, and he
who lies down utters falsehood.''

\emph{Loki}.

\textbf{12.} ``I have had labour and success: Thrym has thy hammer, the
Thursar's lord. It shall no man get again, unless he bring him Freyia
to wife.''

\textbf{13.} They went the fair Freyia to find; and he those words first of
all said: ``Bind thee, Freyia, in bridal raiment, we two must drive to
Jotunheim.''

\textbf{14.} Wroth then was Freyia, and with anger chafed, all the Æsir's
...
\textbf{15.} Straightway went the Æsir all to council, and the Asyniur all to
hold converse; and deliberated the mighty gods, how they Hlorridi's
hammer might get back.

\textbf{16.} Then said Heimdall, of Æsir brightest—he well foresaw, like
other Vanir—``Let us clothe Thor with bridal raiment, let him have the
famed Brisinga necklace.

\textbf{17.} ``Let by his side keys jingle, and woman's weeds fall round his
knees, but on his breast place precious stones, and a neat coif set on
his head.''

\textbf{18.} Then said Thor, the mighty As: ``Me the Æsir will call womanish,
if I let myself be clad in bridal raiment.''

\textbf{19.} Then spake Loki, Laufey's son: ``Do thou, Thor! refrain from
suchlike words: forthwith the Jotuns will Asgard inhabit, unless thy
hammer thou gettest back.''

\textbf{20.} Then they clad Thor in bridal raiment, and with the noble
...
\textbf{21.} Then said Loki, Laufey's son: ``I will with thee as a servant go:
we two will drive to Jotunheim.''

\textbf{22.} Straightway were the goats homeward driven, hurried to the
traces; they had fast to run. The rocks were shivered, the earth was
in a blaze; Odin's son drove to Jotunheim.

\textbf{23.} Then said Thrym, the Thursar's lord: ``Rise up, Jotuns! and the
benches deck, now they bring me Freyia to wife, Niord's daughter, from
Noatun.

\textbf{24.} ``Hither to our court let bring gold-horned cows, all-black oxen,
for the Jotuns' joy. Treasures I have many, necklaces many, Freyia
alone seemed to me wanting.''

\textbf{25.} In the evening they early came, and for the Jotuns beer was
...
\textbf{26.} Then said Thrym, the Thursar's prince: ``Where hast thou seen
brides eat more voraciously? I never saw brides feed more amply, nor a
maiden drink more mead.''

\textbf{27.} Sat the all-crafty serving-maid close by, who words fitting
found against the Jotun's speech: ``Freyia has nothing eaten for eight
nights, so eager was she for Jotunheim.''

\textbf{28.} Under her veil he stooped desirous to salute her, but sprang
back along the hall. ``Why are so piercing Freyia's looks? Methinks
that fire burns from her eyes.''

\textbf{29.} Sat the all-crafty serving-maid close by, who words fitting
found against the Jotun's speech: ``Freyia for eight nights has not
slept, so eager was she for Jotunheim.''

\textbf{30.} In came the Jotun's luckless sister, for a bride-gift she dared
to ask: ``Give me from thy hands the ruddy rings, if thou wouldst gain
my love, my love and favour all.''

\textbf{31.} Then said Thrym, the Thursar's lord: ``Bring the hammer in, the
bride to consecrate; lay Miollnir on the maiden's knee; unite us each
with other by the hand of Vor.''

\textbf{32.} Laughed Hlorridi's soul in his breast, when the fierce-hearted
his hammer recognized. He first slew Thrym, the Thursar's lord, and
the Jotun's race all crushed;

\textbf{33.} He slew the Jotun's aged sister, her who a bride-gift had
demanded; she a blow got instead of skillings, a hammer's stroke for
many rings. So got Odin's son his hammer back.

\xchapter{The Lay of the Dwarf Alvis.}

\emph{Alvis}.

\textbf{1.} The benches they are decking, now shall the bride\footnote{Thrud, Thor's daughter by his wife Sif. \emph{Skaldskap}.} with me
bend her way home. That beyond my strength I have hurried will to
every one appear: at home naught shall disturb my quiet.

\emph{Vingthor}.

\textbf{2.} What man is this? Why about the nose art thou so pale? Hast thou
last night with corpses lain? To me thou seemst to bear resemblance to
the Thursar. Thou art not born to carry off a bride.

\emph{Alvis}.

\textbf{3.} Alvis I am named, beneath the earth I dwell, under the rock I own
a place. The lord of chariots I am come to visit. A promise once
confirmed let no one break.\footnote{This appears to allude to a promise made to the dwarf;
but of which the story is lost.}

\emph{Vingthor}.

\textbf{4.} I will break it; for o'er the maid I have, as father, greatest
power. I was from home when the promise was given thee. Among the gods
I the sole giver am.

\emph{Alvis}.

\textbf{5.} What man is this, who lays claim to power over that fair, bright
maiden? For far-reaching shafts few will know thee. Who has decked
thee with bracelets?

\emph{Vingthor}.

\textbf{6.} Vingthor I am named, wide I have wandered; I am Sidgrani's son:
with my dissent thou shalt not that young maiden have, nor that union
obtain.

\emph{Alvis}.

\textbf{7.} Thy consent I fain would have, and that union obtain. Rather
would I possess than be without that snow-white maiden.

\emph{Vingthor}.

\textbf{8.} The maiden's love shall not, wise guest! be unto thee denied, if
thou of every world canst tell all I desire to know.

\emph{Alvis}.

\textbf{9.} Vingthor! thou canst try, as thou art desirous the knowledge of
the dwarf to prove. All the nine worlds I have travelled over, and
every being known.

\emph{Vingthor}.

\textbf{10.} Tell me, Alvis!—for all men's concerns I presume thee, dwarf,
to know—how the earth is called, which lies before the sons of men,
in every world.

\emph{Alvis}.

\textbf{11.} Jord among men 'tis called, but with the Æsir fold; the Vanir
call it vega, the Jotuns igroen, the Alfar groandi, the powers supreme
aur.

\emph{Vingthor}.

\textbf{12.} Tell me, Alvis, etc. how the heaven is called, which is
perceptible in every world.

\emph{Alvis}.

\textbf{13.} Himinn 'tis called by men; but hlyrnir with the gods; vindofni
the Vanir call it, uppheimr the Jotuns, the Alfar fagraræfr, the
dwarfs driupansal.

\emph{Vingthor}.

\textbf{14.} Tell me, Alvis! etc., how the moon is called, which men see in
every world.

\emph{Alvis}.

\textbf{15.} Mani 'tis called by men, but mylinn with the gods, hverfanda
hvel in Hel\footnote{When this composition was written, it appears that Hel
was no longer regarded as a person, but as a place.} they call it, skyndi the Jotuns, but the dwarfs skin;
the Alfar name it artali.

\emph{Vingthor}.

\textbf{16.} Tell me, Alvis! etc., how the sun is called, which men's sons
see in every world.

\emph{Alvis}.

\textbf{17.} Sol among men 'tis called, but with the gods sunna, the dwarfs
call it Dvalinn's leika, the Jotuns eyglo, the Alfar fagrahvel, the
Æsir's sons alskir.

\emph{Vingthor}.

\textbf{18.} Tell me, Alvis, etc., how the clouds are called, which with
showers are mingled in every world.

\emph{Alvis}.

\textbf{19.} Sky they are called by men, but skurvan by the gods; the Vanir
call them vindflot, the Jotuns urvan, the Alfar vedrmegin; in Hel they
are called hialm hulids.

\emph{Vingthor}.

\textbf{20.} Tell me, Alvis! etc., how the wind is called, which widely
passes over every world.

\emph{Alvis}.

\textbf{21.} Windr 'tis called by men, but vavudr by the gods, the
wide-ruling powers call it gneggiud, the Jotuns oepir, the Alfar
dynfari, in Hel they call it hvidudr.

\emph{Vingthor}.

\textbf{22.} Tell me, Alvis! etc., how the calm is called, which has to rest
in every world.

\emph{Alvis}.

\textbf{23.} Logn 'tis called by men, but lægi by the gods, the Vanir call it
vindslot, the Jotuns ofhly, the Alfar dagsevi, the Dwarfs call it dags
vera.

\emph{Vingthor}.

\textbf{24.} Tell me, Alvis! etc., what the sea is called, which men row over
in every world.

\emph{Alvis}.

\textbf{25.} Sær 'tis called by men, but silægia with the gods; the vanir
call it vagr, the Jotuns alheimr, the Alfar lagastafr, the Dwarfs call
it diupan mar.

\emph{Vingthor}.

\textbf{26.} Tell me, Alvis! etc., how the fire is called, which burns before
men's sons in every world.

\emph{Alvis}.

\textbf{27.} Eldr 'tis called by men, but by the Æsir funi; the Vanir call it
vagr, the Jotuns frekr, but the Dwarfs forbrennir; in Hel they call it
hrodudr.

\emph{Vingthor}.

\textbf{28.} Tell me, Alvis! etc., how the forest is called, which grows for
the sons of men in every world.

\emph{Alvis}.

\textbf{29.} Vidr 'tis called by men, but vallarfax by the gods, Hel's
inmates call it hlidthangr, the Jotuns eldi, the Alfar fagrlimi; the
Vanir call it vondr.

\emph{Vingthor}.

\textbf{30.} Tell me, Alvis! etc., how the night is called, that Norvi's
daughter hight, in every world.

\emph{Alvis}.

\textbf{31.} Nott it is called by men, but by the gods niol; the wide-ruling
powers call it grima, the Jotuns olios, the Alfar svefngaman; the
Dwarfs call it draumniorunn.

\emph{Vingthor}.

\textbf{32.} Tell me, Alvis! etc., how the seed is called, which the sons of
men sow in every world.

\emph{Alvis}.

\textbf{33.} Bygg it is called by men, but by the gods barr, the Vanir call
it vaxtr, the Jotuns æti, the Alfar lagastafr; in Hel 'tis hnipinn
called.

\emph{Vingthor}.

\textbf{34.} Tell me, Alvis! etc., how the beer is called, which the sons of
men drink in every world.

\emph{Alvis}.

\textbf{35.} Ol it is called by men, but by the Æsir biorr, the Vanir call it
veig, hreina logr the Jotuns, but in Hel 'tis called miodr: Suttung's
sons call it sumbl.

\emph{Vingthor}.

\textbf{36.} In one breast I have never found more ancient lore. By great
wiles thou hast, I tell thee, been deluded. Thou art above ground,
dwarf! at dawn; already in the hall the sun is shining!

\xchapter{The Lay of Harbard.}
...
\textbf{1.} Who is the knave of knaves, that by the sound stands yonder?

\emph{Harbard}.

\textbf{2.} Who is the churl of churls, that cries across the water?

\emph{Thor}.

\textbf{3.} Ferry me across the sound, to-morrow I'll regale thee. I have a
...
\textbf{4.} Thou art in haste to praise thy meal: thou surely hast no
foreknowledge; for sad will be thy home: thy mother, I believe, is
dead.

\emph{Thor}.

\textbf{5.} Thou sayest now what seems to every one most unwelcome to
know—that my mother is dead.

\emph{Harbard}.

\textbf{6.} Thou dost not look like one who owns three country dwellings,
bare-legged thou standest, and like a beggar clothed; thou hast not
even breeches.

\emph{Thor}.

\textbf{7.} Steer hitherward thy boat; I will direct thee where to land. But
who owns this skiff, which by the strand thou holdest?

\emph{Harbard}.

\textbf{8.} Hildolf fief is named who bade me hold it, a man in council wise,
...
\textbf{9.} I my name will tell, (although I am an outlaw) and all my kin: I
...
\textbf{10.} I am Harbard called; seldom I my name conceal.

\emph{Thor}.

\textbf{11.} Why shouldst thou thy name conceal, unless thou crime hast
perpetrated?

\emph{Harbard}.

\textbf{12.} Yet, though I may crime have perpetrated, I will nathless guard
my life against such as thou art; unless I death-doomed am.

\emph{Thor}.

\textbf{13.} It seems to me a foul annoyance to wade across the strait to
thee, and wet my garments: but I will pay thee, mannikin! for thy
sharp speeches, if o'er the sound I come.

\emph{Harbard}.

\textbf{14.} Here will I stand, and here await thee. Thou wilt have found no
stouter one since Hrungnir's death.

\emph{Thor}.

\textbf{15.} Thou now remindest me how I with Hrungnir fought, that
stout-hearted Jotun, whose head was all of stone; yet I made him fall,
and sink before me. What meanwhile didst thou, Harbard?

\emph{Harbard}.

\textbf{16.} I was with Fiolvari five winters through, in the isle which
Algron hight. There we could fight, and slaughter make, many perils
prove, indulge in love.

\emph{Thor}.

\textbf{17.} How did your women prove towards you?

\emph{Harbard}.

\textbf{18.} Sprightly women we had, had they but been meek; shrewd ones we
...
\textbf{19.} I slew Thiassi, that stout-hearted Jotun: up I cast the eyes of
Allvaldi's son into the heaven serene: they are signs the greatest of
my deeds. What meanwhile didst thou, Harbard?

\emph{Harbard}.

\textbf{20.} Great seductive arts I used against the riders of the night,\footnote{Giantesses, witches, etc.}
...
\textbf{21.} With evil mind then thou didst good gifts requitè \emph{Harbard}.

\textbf{22.} One tree gets that which, is from another scraped: each one in
such case is for self. What meanwhile didst thou, Thor?

\emph{Thor}.

\textbf{23.} In the east I was, and slew the Jotun brides, crafty in evil, as
...
\textbf{24.} I was in Valland, and followed warfare; princes I excited, but
never reconciled. Odin has all the jarls that in conflict fall; but
Thor the race of thralls.

\emph{Thor}.

\textbf{25.} Unequally thou wouldst divide the folk among the Æsir, if thou
but hadst the power.

\emph{Harbard}.

\textbf{36.} Thor has strength over-much, but courage none; from cowardice
...
\textbf{27.} Harbard, thou wretch! I would strike thee dead, could I but
stretch my arm across the sound.

\emph{Harbard}.

\textbf{28.} Why wouldst thou stretch thy arm across the sound, when there is
altogether no offence? But what didst thou, Thor?

\emph{Thor}.

\textbf{39.} In the east I was, and a river I defended, when the sons of
...
\textbf{30.} I was in the east, and with a certain lass held converse; with
that fair I dallied, and long meetings had. I that gold-bright one
delighted; the game amused her.

\emph{Thor}.

\textbf{31.} Then you had kind damsels there?

\emph{Harbard}.

\textbf{32.} Of thy aid I had need, Thor! in retaining that maiden lily-fair.

\emph{Thor}.

\textbf{33.} I would have given it thee, if I had had the opportunity.

\emph{Harbard}.

\textbf{34.} I would have trusted thee, my confidence if thou hadst not
betrayed it.

\emph{Thor}.

\textbf{35.} I am not such a heel-chafer as an old leather shoe in spring.

\emph{Harbard}.

\textbf{36.} What meanwhile didst thou, Thor?

\emph{Thor}.

\textbf{37.} The Berserkers' brides I on Læsso cudgeled; they the worst had
perpetrated, the whole people, had seduced.

\emph{Harbard}.

\textbf{38.} Dastardly didst thou act, Thor! when thou didst cudgel women.

\emph{Thor}.

\textbf{39.} She-wolves they were, and scarcely women. They crushed my ship,
which with props I had secured, with iron clubs threatened me, and
drove away Thialfi. What meanwhile didst thou, Harbard?

\emph{Harbard}.

\textbf{40.} I in the army was, which was hither sent, war-banners to raise,
lances to redden.

\emph{Thor}.

\textbf{41.} Of that thou now wilt speak, as thou wentest forth us hard terms
to offer.

\emph{Harbard}.

\textbf{42.} That shall be indemnified by a hand-ring, such as arbitrators
give, who wish to reconcile us.

\emph{Thor}.

\textbf{43.} Where didst thou learn words than which I never heard more
irritating?

\emph{Harbard}.

\textbf{44.} From men I learned them, from ancient men, whose home is in the
woods.

\emph{Thor}.

\textbf{45.} Thou givest certainly a good name to grave-mounds, when thou
callest them, homes in the woods.

\emph{Harbard}.

\textbf{46.} So speak I of such a subject.

\emph{Thor}.

\textbf{47.} Thy shrewd words will bring thee evil, if I resolve the sound to
ford. Louder than a wolf thou wilt howl, I trow, if of my hammer thou
gettest a touch.

\emph{Harbard}.

\textbf{48.} Sif has a gallant at home; thou wilt anxious be to find him:
thou shalt that arduous work perform; it will beseem thee better.

\emph{Thor}.

\textbf{49.} Thou utterest what comes upmost, so that to me it be most
annoying, thou dastardly varlet! I believe thou art lying.

\emph{Harbard}.

\textbf{50.} I believe I am telling truth. Thou art travelling slowly; thou
wouldst have long since arrived, hadst thou assumed another form.

\emph{Thor}.

\textbf{51.} Harbard! thou wretch! rather is it thou who hast detained me.

\emph{Harbard}.

\textbf{52.} I never thought that a ferryman could the course of Asa-Thor
retard.

\emph{Thor}.

\textbf{53.} One advice I now will give thee: row hither with thy boat; let
us cease from threats; approach the sire of Magni.

\emph{Harbard}.

\textbf{54.} Go farther from the sound, the passage is refused thee.

\emph{Thor}.

\textbf{55.} Show me then the way, if thou wilt not ferry me across the
water.

\emph{Harbard}.

\textbf{56.} That's too little to refuse. 'Tis far to go; 'tis to the stock
...
\textbf{57.} Can I get there to-day?

\emph{Harbard}.

\textbf{58.} With pain and toil thou mayest get there, while the sun is up,
which, I believe, is now nigh.

\emph{Thor}.

\textbf{59.} Our talk shall now be short, as thou answerest with scoffing
only. For refusing to ferry me I will reward thee, if another time we
meet.

\emph{Harbard}.

\textbf{60.} Just go to where all the powers of evil may have thee.

\xchapter{The Journey or Lay of Skirnir.}
...
\textbf{1.} Rise up now, Skirnir! go and request our son to speak; and
inquire with whom he so sage may be offended.

\emph{Skirnir}.

\textbf{2.} Harsh words I have from your son to fear, if I go to speak with
him, and to inquire with whom he so sage may be offended.

\emph{Skirnir}.

\textbf{3.} Tell me now, Frey, prince of gods! for I desire to know, why
alone thou sittest in the spacious hall the livelong day?

\emph{Frey}.

\textbf{4.} Why shall I tell thee, thou young man, my mind's great trouble?
for the Alfs' illuminator shines every day, yet not for my pleasure.

\emph{Skirnir}.

\textbf{5.} Thy care cannot, I think, be so great, that to me thou canst not
tell it; for in early days we were young together: well might we trust
each other.

\emph{Frey}.

\textbf{6.} In Gymir's courts I saw walking a maid for whom I long. Her arms
gave forth light wherewith shone all air and water.

\textbf{7.} Is more desirable to me that maid than to any youth in early
days; yet will no one, Æsir or Alfar, that we together live.

\emph{Skirnir}.

\textbf{8.} Give me but thy steed, which can bear me through the dusk,
flickering flame, and that sword, which brandishes itself against the
Jotuns' race.

\emph{Frey}.

\textbf{9.} I will give thee my steed, which can bear thee through the dusk,
flickering flame, and that sword, which will itself brandish, if he is
bold who raises it.

\emph{Skirnir Speaks to the Horse}.

\textbf{10.} Dark it is without, 'tis time, I say, for us to go across the
...
\textbf{11.} Tell me, cowherd! as on the mound thou sittest, and watchest all
the ways, how I to the speech may come, of the young maiden, for
Gymir's dogs?

\emph{Cowherd}.

\textbf{12.} Either thou art death-doomed, or thou art a departed one. Speech
wilt thou ever lack with the good maid of Gymir.

\emph{Skirnir}.

\textbf{13.} Better choices than to whine there are for him who is prepared
to die: for one day was my age decreed, and my whole life determined.

\emph{Gerd}.

\textbf{14.} What is that sound of sounds, which I now sounding hear within
our dwelling? The earth is shaken, and with it all the house of Gymir
trembles.

\emph{A serving-maid}.

\textbf{15.} A man is here without, dismounted from his horse's back: he lets
his steed browse on the grass.

\emph{Gerd}.

\textbf{16.} Bid him enter into our hall, and drink of the bright mead;
although I fear it is my brother's slayer who waits without.

\textbf{17.} Who is this of the Alfar's, or of the Æsir's sons, or of the
wise Vanir's? Why art thou come alone, through the hostile fire, our
halls to visit?

\emph{Skirnir}.

\textbf{18.} I am not of the Alfar's, nor of the Æsir's sons, nor of the wise
Vanir's; yet I am come alone, through the hostile fire, your halls to
visit.

\textbf{19.} Apples all-golden I have here eleven: these I will give thee,
Gerd, thy love to gain, that thou mayest say that Frev to thee lives
dearest.

\emph{Gerd}.

\textbf{20.} The apples eleven I never will accept for any mortal's pleasure;
nor will I and Frey, while our lives last, live both together.

\emph{Skirnir}.

\textbf{21.} The ring too I will give thee, which was burnt with the young
son of Odin. Eight of equal weight will from it drop, every ninth
night.

\emph{Gerd}.

\textbf{22.} The ring I will not accept, burnt though it may have been with
the young son of Odin. I have no lack of gold in Gymir's courts; for
my father's wealth I share.

\emph{Skirnir}.

\textbf{23.} Seest thou this sword, young maiden! thin, glittering-bright,
which I have here in hand? I thy head will sever from thy neck, if
thou speakst not favourably to me.

\emph{Gerd}.

\textbf{24.} Suffer compulsion will I never, to please any man; yet this I
foresee, if thou and Gymir meet, ye will eagerly engage in fight.

\emph{Skirnir}.

\textbf{25.} Seest thou this sword, young maiden! thin, glittering-bright,
which I have here in hand? Beneath its edge shall the old Jotun fall:
thy sire is death-doomed.

\textbf{26.} With a taming-wand I smite thee, and I will tame thee, maiden!
to my will. Thou shalt go thither, where the sons of men shall never
more behold thee.

\textbf{27.} On an eagle's mount thou shalt early sit, looking and turned
towards Hel. Food shall to thee more loathsome be than is to any one
the glistening serpent among men.

\textbf{28.} As a prodigy thou shalt be, when thou goest forth; Hrimnir shall
at thee gaze, all beings at thee stare; more wide-known thou shalt
become than the watch among the gods,\footnote{Heimdall.} if thou from thy gratings
gape.

\textbf{29.} Solitude and disgust, bonds and impatience, shall thy tears with
grief augment. Set thee down, and I will tell thee of a whelming flood
of care, and a double grief.

\textbf{30.} Terrors shall bow thee down the livelong day, in the Jotuns'
...
\textbf{31.} With a three-headed Thurs thou shalt be ever bound, or be
...
\textbf{32.} To the wold I have been, and to the humid grove, a magic wand to
get. A magic wand I got.

\textbf{33.} Wroth with thee is Odin, wroth with thee is the Æsir's prince;
Frey shall loathe thee, even ere thou, wicked maid! shalt have felt
the gods' dire vengeance.

\textbf{34.} Hear ye, Jotuns! hear ye, Hrimthursar! sons of Suttung! also ye,
Æsir's friends! how I forbid, how I prohibit man's joy unto the
damsel, man's converse to the damsel.

\textbf{35.} Hrimgrimnir the Thurs is named, that shall possess thee, in the
...
\textbf{36.} Thurs\footnote{Thurs, etc., the names of magical runes.} I cut for thee, and three letters mere: ergi, and
oedi, and othola. So will I cut them out, as I have cut them, in, if
there need shall be.

\emph{Gerd}.

\textbf{37.} Hail rather to thee, youth! and accept an icy cup, filled with
old mead; although I thought not that I ever should love one of Vanir
race.

\emph{Skirnir}.

\textbf{38.} All my errand will I know, ere I hence ride home. When wilt thou
converse hold with the powerful son of Niord?

\emph{Gerd}.

\textbf{39.} Barri the grove is named, which we both know, the grove of
...
\textbf{40.} Tell me, Skirnir! ere thou thy steed unsaddlest, and a foot
hence thou goest, what thou hast accomplished in Jotunheim, for my
pleasure or thine?

\emph{Skirnir}.

\textbf{41.} Barri the grove is named, which we both know, the grove of
tranquil paths. Nine nights hence, there to Niord's son Gerd will
grant delight.

\emph{Frey}.

\textbf{42.} Long is one night, yet longer two will be; how shall I three
endure. Often a month to me less has seemed than half a night of
longing.

\xchapter{The Lay of Rig.}
...
\textbf{1.} In ancient days, they say, along the green ways went the powerful
and upright sagacious As, the strong and active Rig, his onward course
pursuing.

\textbf{2.} Forward he went on the mid-way, and to a dwelling came. The door
...
\textbf{3.} Rig would counsel give to them both, and himself seated in the
middle seat, having on either side the domestic pair.

\textbf{4.} Then Edda from the ashes took a loaf, heavy and thick, and with
...
\textbf{5.} Then rose he up, prepared to sleep: Rig would counsel give to
them both; laid him down in the middle of the bed; the domestic pair
lay one on either side.

\textbf{6.} There he continued three nights together, then departed on the
mid-way. Nine months then passed way.

\textbf{7.} Edda a child brought forth: they with water sprinkled its swarthy
skin, and named it Thræl.

\textbf{8.} It grew up, and well it throve; of its hands the skin was
shriveled, the knuckles knotty, * * * and the fingers thick; a hideous
countenance it had, a curved back, and protruding heels.

\textbf{9.} He then began his strength to prove, bast to bind, make of it
loads; then faggots carried home, the livelong day.

\textbf{10.} Then to the dwelling came a woman walking, scarred were her
foot-soles, her arms sunburnt, her nose compressed, her name was Thy.

\textbf{11.} In the middle seat herself she placed; by her sat the house's
son. They spoke and whispered, prepared a bed, Thræl and Thy, and days
of care.

\textbf{12.} Children they begat, and lived content: Their names, I think,
...
\textbf{13.} The daughters were Drumba and Kumba, Okkvinkalfa, and Arinnefia,
Ysia and Ambatt, Eikintiasna, Totrughypia, and Tronubeina, whence are
sprung the race of thralls.

\textbf{14.} Rig then went on, in a direct course, and came to a house; the
door stood ajar: he went in; fire was on the floor, man and wife sat
there engaged at work.

\textbf{15.} The man was planing wood for a weaver's beam; his beard was
trimmed, a lock was on his forehead, his shirt close; his chest stood
on the floor.

\textbf{16.} His wife sat by, plied her rock, with outstretched arms,
...
\textbf{17.} Rig would counsel give to them both; rose from the table,
prepared to sleep; laid him down in the middle of the bed, the
domestic pair lay one on either side.

\textbf{18.} There he continued three nights together. Nine months then
...
\textbf{19.} It grew up, and well throve; learned to tame oxen, make a
plough, houses build, and barns construct, make carts, and the plough
drive.

\textbf{20.} Then they home conveyed a lass with pendent keys, and goatskin
...
\textbf{21.} Children they begat, and lived content. Hal and Dreng, these
were named, Held, Thegn, Smith, Breidr-bondi, Bundinskegg, Bui and
Boddi, Brattskegg and Segg.

\textbf{22.} But [the daughters] were thus called, by other names: Snot,
Brud, Svanni, Svarri, Sprakki, Fliod, Sprund, and Vif, Feima, Ristil;
whence are sprung the races of churls.

\textbf{23.} Rig then went thence, in a direct course, and came to a hall:
the entrance looked southward, the door was half closed, a ring was on
the door-post.

\textbf{24.} He went in; the floor was strewed, a couple sat facing each
other, Fadir and Modir, with fingers playing.

\textbf{25.} The husband sat, and twisted string, bent his bow, and
arrow-shafts prepared; but the housewife looked on her arms, smoothed
her veil, and her sleeves fastened;

\textbf{26.} Her head-gear adjusted. A clasp was on her breast; ample her
robe, her sark was blue; brighter was her brow, her breast fairer, her
neck whiter than driven snow.

\textbf{27.} Rig would counsel give to them both, and himself seated on the
middle seat, having on either side the domestic pair.

\textbf{28.} Then took Modir a figured cloth of white linen, and the table
decked. She then took thin cakes of snow-white wheat, and on the table
laid.

\textbf{29.} She set forth salvers full, adorned with silver, on the table
...
\textbf{30.} Rig then rose, the bed prepared; there he then remained three
nights together, then departed on the mid-way. Nine months after that
passed away.

\textbf{31.} Modir then brought forth a boy: in silk they wrapped him, with
water sprinkled him, and named him Jarl. Light was his hair, bright
his cheeks, his eyes piercing as a young serpent's.

\textbf{32.} There at home Jarl grew up, learned the shield to shake, to fix
...
\textbf{33.} Thither from the forest came Rig walking, Rig walking: runes he
...
\textbf{34.} Jarl then rode thence, through a murky way, over humid fells,
...
\textbf{35.} Then he ruled alone over eight vills, riches distributed, gave
to all treasures and precious things; lank-sided horses, rings he
dispersed, and collars cut in pieces.\footnote{A common practice: the pieces served as money.}

\textbf{36.} The nobles drove through humid ways, came to a hall, where
Hersir dwelt; there they found a slender maiden, fair and elegant,
Erna her name.

\textbf{37.} They demanded her, and conveyed her home, to Jarl espoused her;
she under the linen\footnote{The nuptial veil.} went. They together lived, and well throve,
had offspring, and old age enjoyed.

\textbf{38.} Bur was their eldest, Barn the second, Jod and Adal, Arfi, Mog,
Nid and Nidjung. They learned games; Son and Svein swam and at tables
played. One was named Kund, Kon was youngest.

\textbf{39.} There grew up Jarl's progeny; horses they broke, curved shields,
cut arrows, brandished spears.

\textbf{40.} But the young Kon understood runes, æfin-runes, and aldr-runes;
he moreover knew men to preserve, edges to deaden, the sea to calm.

\textbf{41.} He knew the voice of birds, how fires to mitigate, assuage and
quench; sorrows to allay. He of eight men had the strength and energy.

\textbf{42.} He with Rig Jarl in runes contended, artifices practised, and
superior proved; then acquired Rig to be called, and skilled in runes.

\textbf{43.} The young Kon rode through swamps and forests, hurled forth
darts, and tamed birds.

\textbf{44.} Then sang the crow, sitting lonely on a bough! ``Why wilt thou,
young Kon: tame the birds? rather shouldst thou, young Kon! on horses
ride * * * and armies overcome.

\textbf{45.} Nor Dan nor Danp halls more costly had, nobler paternal seats,
than ye had. They well knew how the keel to ride, the edge to prove,
wounds to inflict.

The rest is wanting.

\xchapter{Oegir's Compotation, or Loki's Altercation.}
...
\textbf{1.} Tell me, Eldir! ere thou thy foot settest one step forward, on
what converse the sons of the triumphant gods at their potation?

\emph{Eldir}.

\textbf{2.} Of their arms converse, and of their martial fame, the sons of
the triumphant gods. Of the Æsir and the Alfar that are here within
not one has a friendly word for thee.

\emph{Loki}.

\textbf{3.} I will go into Oegir's halls, to see the compotation. Strife and
hate to the Æsir's sons I bear, and will mix their mead with bale.

\emph{Eldir}.

\textbf{4.} Knowest thou not that if thou goest into Oegir's halls to see the
compotation, but contumely and clamour pourest forth on the kindly
powers, they will wipe it all off on thee?

\emph{Loki}.

\textbf{5.} Knowest thou not, Eldir, that if we two with bitter words
...
\textbf{6.} I Lopt am come thirsty into this hall, from a long journey, to
beseech the Æsir one draught to give me of the bright mead.

\textbf{7.} Why gods! are ye so silent, so reserved, that ye cannot speak? A
seat and place choose for me at your board, or bid me hie me hence.

\emph{Bragi}.

\textbf{8.} A seat and place will the Æsir never choose for thee at their
board; for well the Æsir know for whom they ought to hold a joyous
compotation.

\emph{Loki}.

\textbf{9.} Odin! dost thou remember when we in early days blended our blood
together? When to taste beer thou didst constantly refuse, unless to
both 'twas offered?

\emph{Odin}.

\textbf{10.} Rise up, Vidar! and let the wolf's sire sit at our compotation;
...
\textbf{24.} But, it is said, thou wentest with tottering steps in Samso, and
...
\textbf{25.} Your doings ye should never publish among men, what ye, Æsir
twain, did in days of yore. Ever forgotten be men's former deeds!

\emph{Loki}.

\textbf{26.} Be thou silent, Frigg! Thou art Fiorgyn's daughter, and ever
hast been fond of men, since Ve and Vili, it is said, thou, Vidrir's
wife, didst both to thy bosom take.

\emph{Frigg}.

\textbf{27.} Know thou that if I had, in Oegir's halls, a son like Baldr, out
thou shouldst not go from the Æsir's sons: thou should'st have been
fiercely assailed.

\emph{Loki}.

\textbf{28.} But wilt thou, Frigg! that of my wickedness I more recount? I am
the cause that thou seest not Baldr riding to the halls.

\emph{Freyia}.

\textbf{29.} Mad art thou, Loki! in recounting thy foul misdeeds. Frigg, I
believe, knows all that happens, although she says it not.

\emph{Loki}.

\textbf{30.} Be thou silent, Freyia! I know thee full well; thou art not free
from vices: of the Æsir and the Alfar, that are herein, each has been
thy paramour.

\emph{Freyia}.

\textbf{31.} False is thy tongue. Henceforth it will, I think, prate no good
to thee. Wroth with thee are the Æsir, and the Asyniur. Sad shalt thou
home depart.

\emph{Loki}.

\textbf{32.} Be silent, Freyia! Thou art a sorceress, and with much evil
blended; since against thy brother thou the gentle powers excited. And
then, Freyia! what didst thou do?

\emph{Niord}.

\textbf{33.} It is no great wonder, if silk-clad dames get themselves
husbands, lovers; but 'tis a wonder that a wretched As, that has borne
children, should herein enter.

\emph{Loki}.

\textbf{34.} Be silent, Niord! Thou wast sent eastward hence, a hostage from
the gods. Hymir's daughters had thee for an utensil, and flowed into
thy mouth.\footnote{The events related in this strophe are probably a mere
perversion, by the poet, of what we know of Niord's history.} \emph{Niord}.

\textbf{35.} 'Tis to me a solace, as I a long way hence was sent, a hostage
from the gods, that I had a son, whom no one hates, and accounted is a
chief among the Æsir.

\emph{Loki}.

\textbf{36.} Cease now, Niord! in bounds contain thyself; I will no longer
keep it secret: it was with thy sister thou hadst such a son; hardly
worse than thyself.

\emph{Ty}.

\textbf{37.} Frey is best of all the exalted gods in the Æsir's courts: no
maid he makes to weep, no wife of man, and from bonds looses all.

\emph{Loki}.

\textbf{38.} Be silent, Ty! Thou couldst never settle a strife 'twixt two; of
thy right hand also I must mention make, which Fenrir from thee tore.

\emph{Ty}.

\textbf{39.} I of a hand am wanting, but thou of honest fame; sad is the lack
of either. Nor is the wolf at ease: he in bonds must bide, until the
gods' destruction.

\emph{Loki}.

\textbf{40.} Be silent, Ty; to thy wife it happened to have a son by me. Nor
rag nor penny ever hadst thou, poor wretch! for this injury.

\emph{Frey}.

\textbf{41.} I the wolf see lying at the river's mouth, until the powers are
swept away. So shalt thou be bound, if thou art not silent, thou
framer of evil.

\emph{Loki}.

\textbf{42.} With gold thou boughtest Gymir's daughter, and so gavest away
thy sword: but when Muspell's sons through the dark forest ride, thou,
unhappy, wilt not have wherewith to fight.

\emph{Byggvir}.

\textbf{43.} Know that were I of noble race, like Ingun's Frey, and had so
fair a dwelling, than marrow softer I would bray that ill-boding crow,
and crush him limb by limb.

\emph{Loki}.

\textbf{44.} What little thing is that I see wagging its tail, and snapping
eagerly? At the ears of Frey thou shouldst ever be, and clatter under
mills.

\emph{Byggvir}.

\textbf{45.} Byggvir I am named, and am thought alert, by all gods and men;
therefore am I joyful here, that all the sons of Hropt drink beer
together.

\emph{Loki}.

\textbf{46.} Be silent, Byggvir! Thou couldst never dole out food to men,
when, lying in thy truckle bed, thou wast not to be found, while men
were fighting.

\emph{Heimdall}.

\textbf{47.} Loki, thou art drunk, and hast lost thy wits. Why dost thou not
leave off, Loki? But drunkenness so rules every man, that he knows not
of his garrulity.

\emph{Loki}.

\textbf{48.} Be silent, Heimdall! For thee in early days was that hateful
life decreed: with a wet back thou must ever be, and keep watch as
guardian of the gods.

\emph{Skadi}.

\textbf{49.} Thou art merry, Loki! Not long wilt thou frisk with an unbound
tail; for thee, on a rock's point, with the entrails of thy ice-cold
son, the gods will bind.

\emph{Loki}.

\textbf{50.} Know, if on a rock's point, with the entrails of my ice-cold
son, the gods will bind me, that first and foremost I was at the
slaying, when we assailed Thiassi.

\emph{Skadi}.

\textbf{51.} Know, if first and foremost thou wast at the slaying, when ye
assailed Thiassi, that from my dwellings and fields shall to thee ever
cold counsels come.

\emph{Loki}.

\textbf{52.} Milder wast thou of speech to Laufey's son, when to thy bed thou
...
\textbf{63.} Silence, thou impure being! My mighty hammer, Miollnir, shall
stop thy prating. Hrungnir's bane shall cast thee down to Hel, beneath
the gratings of the dead.

\emph{Loki}.

\textbf{64.} I have said before the Æsir, I have said before the Æsir's sons,
that which my mind suggested: but for thee alone will I go out;
because I know that thou wilt fight.

\textbf{65.} Oegir! thou hast brewed beer; but thou never shalt henceforth a
...
\xchapter{The Lay of Fiolsvith.}

\textbf{1.} From the outward wall he saw one ascending to the seat of the
giant race.
...
\textbf{2.} What monster is it before the fore-court standing, and hovering
round the perilous flame? Whom dost thou seek? Of what art thou in
quest? Or what, friendless being! desirest thou to know?

\emph{Wanderer}.

\textbf{3.} What monster is that, before the fore-court standing, who to the
wayfarer offers not hospitality? Void of honest fame, prattler! hast
thou lived: but hence hie thee home.

\emph{Fiolsvith}.

\textbf{4.} Fiolsvith is my name; wise I am of mind, though of food not
prodigal. Within these courts thou shalt never come: so now, wretch!
take thyself off.

\emph{Wanderer}.

\textbf{5.} From the eye's delight few are disposed to hurry, where there is
something pleasant to be seen. These walls, methinks, shine around
golden halls. Here I could live contented with my lot.

\emph{Fiolsvith}.

\textbf{6.} Tell me, youth; of whom thou art born, or of what race hast
sprung.

\emph{Wanderer}.

\textbf{7.} Vindkald I am called, Varkald was my father named, his sire was
Fiolkald.

\textbf{8.} Tell me, Fiolsvith! that which I will ask thee, and I desire to
know: who here holds sway, and has power over these lands and costly
halls?

\emph{Fiolsvith}.

\textbf{9.} Menglod is her name, her mother her begat with Svaf, Thorin's
son. She here holds sway, and has power over these lands and costly
halls.

\emph{Vindkald}.

\textbf{10.} Tell me, Fiolsvith! etc., what the grate is called, than which
among the gods mortals never saw a greater artifice?

\emph{Fiolsvith}.

\textbf{11.} Thrymgioll it is called, and Solblindi's three sons constructed
it: a fetter fastens, every wayfarer, who lifts it from its opening.

\emph{Vindkald}.

\textbf{12.} Tell me, Fiolsvith! etc., what that structure is called, than
which among the gods mortals never saw a greater artifice?

\emph{Fiolsvith}.

\textbf{13.} Gastropnir it is called, and I constructed it of Leirbrimir's
limbs. I have so supported it, that it will ever stand while the world
lasts.

\emph{Vindkald}.

\textbf{14.} Tell me, Fiolsvith! etc., what those dogs are called, that chase
away the giantesses, and safety to the fields restore?

\emph{Fiolsvith}.

\textbf{15.} Gifr the one is called, the other Geri, if thou that wouldst
know. Eleven watches they will keep, until the powers perish.

\emph{Vindkald}.

\textbf{16.} Tell me, Fiolsvith! etc., whether any man can enter while those
fierce assailants sleep?

\emph{Fiolsvith}.

\textbf{17.} Alternate sleep was strictly to them enjoined, since to the
watch they were appointed. One sleeps by night, by day the other, so
that no wight can enter if he comes.

\emph{Vindkald}.

\textbf{18.} Tell me, Fiolsvith! etc., whether there is any food that men can
get, such that they can run in while they eat?

\emph{Fiolsvith}.

\textbf{19.} Two repasts lie in Vidofnir's wings, if thou that wouldst know:
that is alone such food as men can give them and run in while they
eat.

\emph{Vindkald}.

\textbf{20.} Tell me, Fiolsvith! etc., what that tree is called that with its
branches spreads itself over every land?

\emph{Fiolsvith}.

\textbf{21.} Mimameidir it is called; but few men know from what roots it
springs: it by that will fall which fewest know. Nor fire nor iron
will harm it.

\emph{Vindkald}.

\textbf{22.} Tell me, Fiolsvith! etc., to what the virtue is of that famed
tree applied, which nor fire nor iron will harm?

\emph{Fiolsvith}.

\textbf{23.} Its fruit shall on the fire be laid, for labouring women; out
then will pass what would in remain: so is it a creator of mankind.

\emph{Vindkald}.

\textbf{24.} Tell me, Fioisvith! etc., what the cock is called that sits in
that lofty tree, and all-glittering is with gold?

\emph{Fiolsvith}.

\textbf{25.} Vidofnir he is called; in the clear air he stands, in the boughs
of Mima's tree: afflictions only brings, together indissoluble, the
swart bird at his lonely meal.

\emph{Vindkald}.

\textbf{26.} Tell me, Fiolsvith! etc., whether there be any weapon, before
which Vidofnir may fall to Hel's abode?

\emph{Fiolsvith}.

\textbf{27.} Hævatein the twig is named, and Lopt plucked it, down by the
gate of Death. In an iron chest it lies with Sinmoera, and is with
nine strong locks secured.

\emph{Vindkald}.

\textbf{28.} Tell me, Fiolsvith! etc., whether he will alive return, who
seeks after, and will take, that rod?

\emph{Fiolsvith}.

\textbf{29.} He will return who seeks after, and will take, the rod, if he
bears that which few possess to the dame of the glassy clay.

\emph{Vindkald}.

\textbf{30.} Tell me, Fiolsvith! etc., whether there is any treasure, that
mortals can obtain, at which the pale giantess will rejoice?

\emph{Fiolsvith}.

\textbf{31.} The bright sickle that lies in Vidofnir's wings, thou in a bag
shalt bear, and to Sinmoera give, before she will think fit to lend an
arm for conflict.

\emph{Vindkald}.

\textbf{32.} Tell me, Fiolsvith! etc., what this hall is called, which is
girt round with a curious flickering flame?

\emph{Fiolsvith}.

\textbf{33.} Hyr it is called, and it will long tremble as on a lance's
point. This sumptuous house shall, for ages hence, be but from hearsay
known.

\emph{Vindkald}.

\textbf{34.} Tell me, Fiolsvith! etc., which of the Æsir's sons has that
constructed, which within the court I saw?

\emph{Fiolsvith}.

\textbf{35.} Uni and Iri, Bari and Ori, Var and Vegdrasil, Dorri and Uri,
Delling and Atvard, Lidskialf, Loki.

\emph{Vindkald}.

\textbf{36.} Tell me, Fiolsvith! etc., what that mount is called, on which I
see a splendid maiden stand?

\emph{Fiolsvith}.

\textbf{37.} Hyfiaberg 'tis called, and long has it a solace been to the
bowed-down and sorrowful: each woman becomes healthy, although a
year's disease she have, if she can but ascend it.

\emph{Vindkald}.

\textbf{38.} Tell me, Fiolsvith! etc., how those maids are called, who sit at
Menglod's knees in harmony together?

\emph{Fiolsvith}.

\textbf{39.} Hlif the first is called, the second is Hlifthursa, the third
Thiodvarta, Biort and Blid, Blidr, Frid, Eir and Orboda.

\emph{Vindkald}.

\textbf{40.} Tell me, Fiolsvith! etc., whether they protect those who offer
to them, if it should, be needful?

\emph{Fiolsvith}.

\textbf{41.} Every summer in which men offer to them, at the holy place, no
pestilence so great shall come to the sons of men, but they will free
each from peril.

\emph{Vindkald}.

\textbf{42.} Tell me, Fiolsvith! etc., whether there is any man that may in
Menglod's soft arms sleep?

\emph{Fiolsvith}.

\textbf{43.} There is no man who may in Menglod's soft arms sleep, save only
Svipdag; to him the sun-bright maid is for wife betrothed.

\emph{Vindkald}.

\textbf{44.} Set the doors open! Let the gate stand wide; here thou mayest
Svipdag see; but yet go learn if Menglod will accept my love.

\emph{Fiolsvith}.

\textbf{45.} Hear, Menglod! A man is hither come: go and behold the stranger;
the dogs rejoice; the house has itself opened. I think it must be
Svipdag.

\emph{Menglod}.

\textbf{46.} Fierce ravens shall, on the high gallows, tear out thy eyes, if
thou art lying, that hither from afar is come the youth unto my halls.

\textbf{47.} Whence art thou come? Whence hast thou journeyed? How do thy
kindred call thee? Of thy race and name I must have a token, if I was
betrothed to thee.

\emph{Svipdag}.

\textbf{48.} Svipdag I am named, Solbiart was my father named; thence the
winds on the cold ways drove me. Urd's decree may no one gainsay,
however lightly uttered.

\emph{Menglod}.

\textbf{49.} Welcome thou art: my will I have obtained; greeting a kiss shall
follow. A sight unlooked-for gladdens most persons, when one the other
loves.

\textbf{50.} Long have I sat on my loved hill, day and night expecting thee.
Now that is come to pass which I have hoped, that thou, dear youth,
again to my halls art come.

\emph{Svipdag}.

\textbf{51.} Longing I have undergone for thy love; and thou, for my
affection. Now it is certain, that we shall pass our lives together.

\xchapter{The Lay of Hyndla.}
...
\textbf{1.} Wake, maid of maids! Wake, my friend! Hyndla! Sister! who in the
cavern dwellest. Now there is dark of darks; we will both to Valhall
ride, and to the holy fane.

\textbf{2.} Let us Heriafather pray into our minds to enter, he gives and
grants gold to the deserving. He gave to Hermod a helm and corslet,
and from him Sigmund a sword received.

\textbf{3.} Victory to his sons he gives, but to some riches; eloquence to
the great, and to men, wit; fair wind he gives to traders, but poesy
to skallds; valour he gives to many a warrior.

\textbf{4.} She to Thor will offer, she to him will pray, that to thee he may
be well disposed; although he bears ill will to Jotun females.

\textbf{5.} Now of thy wolves take one from out the stall; let him run with
runic rein.\footnote{That is, with a rein inscribed with runes.} \emph{Hyndla}.

\textbf{6.} Sluggish is thy hog the god's way to tread:

\emph{Freyia}.

\textbf{7.} I will my noble palfrey saddle.

\emph{Hyndla}.

\textbf{8.} False are thou, Freyia! who temptest me: by thy eyes thou showest
it, so fixed upon us; while thou thy man hast on the dead-road,\footnote{The road to Valhall.}
the young Ottar, Innstein's son.

\textbf{9.} Dull art thou, Hyndla! methinks thou dreamest, since thou sayest
...
\textbf{10.} A duty 'tis to act so that the young prince his paternal
heritage may have, after his kindred.

\textbf{11.} An offer-stead to me he raised, with stones constructed; now is
that stone as glass become. With the blood of oxen he newly sprinkled
it. Ottar ever trusted in the Asyniur.

\textbf{12.} Now let us reckon up the ancient families, and the races of
...
\textbf{29.} There were eleven Æsir reckoned, when Baldr on the pile was
laid; him Vali showed himself worthy to avenge, his own brother: he
the slayer slew. All that race is thine, Ottar Heimski!

\textbf{30.} Baldr's father was son of Bur: Frey to wife had Gerd, she was
Gymir's daughter, from Jotuns sprung and Aurboda; Thiassi also was
their relation, that haughty Jotun; Skadi was his daughter.

\textbf{31.} We tell thee much, and remember more: I admonish thee thus much
to know. Wishest thou yet a longer narrative?

\textbf{32.} Haki was not the worst of Hvedna's sons, and Hiorvard was
Hvedna's father; Heid and Hrossthiof were of Hrimnir's race.

\textbf{33.} All the Valas are from Vidolf; all the soothsayers from
Vilmeidr, all the sorcerers from Svarthofdi; all the Jotuns come from
Ymir.

\textbf{34.} We tell thee much, and more remember, I admonish thee thus much
to know. Wishest thou yet a longer narrative?

\textbf{35.} There was one born, in times of old, with wondrous might
endowed, of origin divine: nine Jotun maids gave birth to the gracious
god, at the world's margin.

\textbf{36.} Gialp gave him birth, Greip gave him birth, Eistla gave him
birth, and Angeia; Ulfrun gave him birth, and Eyrgiafa, Imd and Atla,
and Jarnsaxa.

\textbf{37.} The boy was nourished with the strength of earth, with the
...
\textbf{1.} Of life and property a fierce freebooter despoiled mankind; over
the ways beset by him might no one living pass.

\textbf{2.} Alone he ate most frequently, no one invited he to his repast;
until weary, and with failing strength, a wandering guest came from
the way.

\textbf{3.} In need of drink that way-worn man, and hungry feigned to be:
with trembling heart he seemed to trust him who had been so
evil-minded.

\textbf{4.} Meat and drink to the weary one he gave, all with upright heart;
on God he thought, the traveller's wants supplied; for he felt he was
an evil-doer.

\textbf{5.} Up stood the guest, he evil meditated, he had not been kindly
treated; his sin within him swelled, he while sleeping murdered his
wary cautious host.

\textbf{6.} The God of heaven he prayed for help, when being struck he woke;
but he was doomed the sins of him on himself to take, whom sackless he
had slain.

\textbf{7.} Holy angels came from heaven above, and took to them his soul: in
a life of purity it shall ever live with the almighty God.

\textbf{8.} Riches and health no one may command, though all go smoothly with
him. To many that befalls which they least expect. No one may command
his tranquillity.

\textbf{9.} Unnar and Sævaldi never imagined that happiness would fall from
them, yet naked they became, and of all bereft, and, like wolves, ran
to the forest.

\textbf{10.} The force of pleasure has many a one bewailed. Cares are often
caused by women; pernicious they become, although the mighty God them
pure created.

\textbf{11.} United were Svafud and Skarthedin, neither might without the
other be, until to frenzy they were driven for a woman: she was
destined for their perdition.

\textbf{12.} On account of that fair maid, neither of them cared for games or
joyous days; no other thing could they in memory bear than that bright
form.

\textbf{13.} Sad to them were the gloomy nights, no sweet sleep might they
enjoy: but from that anguish rose hate intense between the faithful
friends.

\textbf{14.} Hostile deeds are in most places fiercely avenged. To the holm
they went,\footnote{That is, \emph{they engaged in single combat}; the spot for
such encounters being called a \emph{holm}, consisting of a circular space
marked out by stones.} for that fair woman, and each one found his death.

\textbf{15.} Arrogance should no one entertain: I indeed have seen that those
who follow her, for the most part, turn from God.

\textbf{16.} Rich were both, Radey and Vebogi, and thought only of their
well-being; now they sit and turn their sores to various hearths.

\textbf{17.} They in themselves confided, and thought themselves alone to be
above all people; but their lot Almighty God was pleased otherwise to
appoint.

\textbf{18.} A life of luxury they led, in many ways, and had gold for
sport. Now they are requited, so that they must walk between frost and
fire.

\textbf{19.} To thy enemies trust thou never, although they speak thee fair:
promise them good: 'tis good to have another's injury as a warning.

\textbf{20.} So it befell Sorli the upright, when he placed himself in
Vigolf's power; he confidently trusted him, his brother's murderer,
but he proved false.

\textbf{21.} Peace to them he granted, with heart sincere; they in return
promised him gold, feigned themselves friends, while they together
drank; but then came forth their guile.

\textbf{22.} Then afterwards, on the second day, when they in Rygiardal rode,
they with swords wounded him who sackless was, and let his life go
forth.

\textbf{23.} His corpse they dragged (on a lonely way, and cut up piecemeal)
into a well, and would it hide; but the holy Lord beheld from heaven.

\textbf{24.} His soul summoned home the true God into his joy to come; but
the evil doers will, I wean, late be from torments called.

\textbf{25.} Do thou pray the Disir of the Lord's words to be kind to thee in
spirit: for a week after, all shall then go happily, according to thy
will.

\textbf{26.} For a deed of ire that thou hast perpetrated, never atone with
evil: the weeping thou shalt soothe with benefits: that is salutary to
the soul.

\textbf{27.} On God a man shall for good things call, on him who has mankind
created. Greatly sinful is every man who late finds the Father.

\textbf{28.} To be solicited, we opine, is with all earnestness for that
which is lacking: of all things may be destitute he who for nothing
asks: few heed the wants of the silent.

\textbf{29.} Late I came, though called betimes, to the supreme Judge's door;
thitherward I yearn; for it was promised me, he who craves it shall of
the feast partake.

\textbf{30.} Sins are the cause that sorrowing we depart from this world: no
one stands in dread, if he does no evil: good it is to be blameless.

\textbf{31.} Like unto wolves all those seem who have a faithless mind: so he
will prove who has to go through ways strewed with gleeds.

\textbf{32.} Friendly counsels, and wisely composed, seven I have imparted to
thee: consider thou them well, and forget them never: they are all
useful to learn.

\textbf{33.} Of that I will speak, how happy I was in the world, and
secondly, how the sons of men reluctantly become corpses.

\textbf{34.} Pleasure and pride deceive the sons of men who after money
crave; shining riches at last become a sorrow: many have riches driven
to madness.

\textbf{35.} Steeped in joys I seemed to men; for little did I see before me:
our worldly sojourn has the Lord created in delights abounding.

\textbf{36.} Bowed down I sat, long I tottered, of life was most desirous;
but He prevailed who was all-powerful: onward are the ways of the
doomed.

\textbf{37.} The cords of Hel were tightly bound round my sides; I would rend
them, but they were strong. 'Tis easy free to go.

\textbf{38.} I alone knew, how on all sides my pains increased. The maids of
Hel each eve with horror bade me to their home.

\textbf{39.} The sun I saw, true star of day, sink in its roaring home; but
Hel's grated doors on the other side I heard heavily creaking.

\textbf{40.} The sun I saw with blood-red beams beset: (fast was I then from
this world declining) mightier she appeared, in many ways, than she
was before.

\textbf{41.} The sun I saw, and it seemed to me as if I saw a glorious god: I
bowed before her, for the last time, in the world of men.

\textbf{42.} The sun I saw: she beamed forth so that I seemed nothing to
know; but Gioll's streams roared from the other side mingled much with
blood.

\textbf{43.} The sun I saw, with quivering eyes, appalled and shrinking; for
my heart in great measure was dissolved in languor.

\textbf{44.} The sun I saw seldom sadder; I had then almost from the world
declined: my tongue was as wood become, and all was cold without me.

\textbf{45.} The sun I saw never after, since that gloomy day; for the
mountain-waters closed over me, and I went called from torments.

\textbf{46.} The star of hope, when I was born, fled from my breast away;
high it flew, settled nowhere, so that it might find rest.

\textbf{47.} Longer than all was that one night, when stiff on my straw I
lay; then becomes manifest the divine word: ``Man is the same as
earth.''

\textbf{48.} The Creator God can it estimate and know, (He who made heaven
and earth) how forsaken many go hence, although from kindred parted.

\textbf{49.} Of his works each has the reward: happy is he who does good. Of
my wealth bereft, to me was destined a bed strewed with sand.

\textbf{50.} Bodily desires men oftentimes seduce, of them has many a one too
much: water of baths was of all things to me most loathsome.

\textbf{51.} In the Norns' seat nine days I sat, thence I was mounted on a
horse: there the giantess's sun shone grimly through the dripping
clouds of heaven.

\textbf{52.} Without and within, I seemed to traverse all the seven nether
worlds: up and down, I sought an easier way, where I might have the
readiest paths.

\textbf{53.} Of that is to be told, which I first saw, when I to the worlds
of torment came:—scorched birds, which were souls, flew numerous as
flies.

\textbf{54.} From the west I saw Von's dragons fly, and Glæval's paths
obscure: their wings they shook; wide around me seemed the earth and
heaven to burst.

\textbf{55.} The sun's hart I saw from the south coming, he was by two
together led: his feet stood on the earth, but his horns reached up to
heaven.

\textbf{56.} From the north riding I saw the sons of Nidi, they were seven in
all: from full horns, the pure mead they drank from the heaven-god's
well.

\textbf{57.} The wind was silent, the waters stopped their course; then I
heard a doleful sound: for their husbands false-faced women ground
earth for food.

\textbf{58.} Gory stones those dark women turned sorrowfully; bleeding hearts
hung out of their breasts, faint with much affliction.

\textbf{59.} Many a man I saw wounded go on those gleed-strewed paths; their
faces seemed to me all reddened with reeking blood.

\textbf{60.} Many men I saw to earth gone down, who holy service might not
have; heathen stars stood above their heads, painted with deadly
characters.

\textbf{61.} I saw those men who much envy harbour at another's fortune;
bloody runes were on their breasts graved painfully.

\textbf{62.} I there saw men many not joyful; they were all wandering wild:
this he earns, who by this world's vices is infatuated.

\textbf{63.} I saw those men who had in various ways acquired other's
property: in shoals they went to Castle-covetous, and burthens bore of
lead.

\textbf{64.} I saw those men who many had of life and property bereft:
through the breasts of those men passed strong venomous serpents.

\textbf{65.} I saw those men who the holy days would not observe: their hands
were on hot stones firmly nailed.

\textbf{66.} I saw those men who from pride valued themselves too highly;
their garments ludicrously were in fire enveloped.

\textbf{67.} I saw those men who had many false words of others uttered:
Hel's ravens from their heads their eyes miserably tore.

\textbf{68.} All the horrors thou wilt not get to know which Hel's inmates
suffer. Pleasant sins end in painful penalties: pains ever follow
pleasure.

\textbf{69.} I saw those men who had much given for God's laws; pure lights
were above their heads brightly burning.

\textbf{70.} I saw those men who from exalted mind helped the poor to aid:
angels, read holy books above their heads.

\textbf{71.} I saw those men who with much fasting had their bodies wasted:
God's angels bowed before them: that is the highest joy.

\textbf{72.} I saw those men who had put food into their mothers' mouth:
their couches were on the rays of heaven pleasantly placed.

\textbf{73.} Holy virgins had cleanly washed the souls from sin of those men,
who for a long time had themselves tormented.

\textbf{74.} Lofty cars I saw towards heaven going; they were on the way to
God: men guided them who had been murdered wholly without crime.

\textbf{75.} Almighty Father! greatest Son! holy Spirit of heaven! Thee I
pray, who hast us all created; free us all from miseries.

\textbf{76.} Biugvor and Iyistvor sit at Herdir's doors, on resounding seat;
iron gore falls from their nostrils, which kindles hate among men.

\textbf{77.} Odin's wife rows in earth's ship, eager after pleasures; her
sails are reefed late, which on the ropes of desire are hung.

\textbf{78.} Son! I thy father and Solkatla's sons have alone obtained for
thee that horn of hart, which from the grave-mound bore the wise
Vigdvalin.

\textbf{79.} Here are runes which have engraven Niord's daughters nine,
Radvor the eldest, and the youngest Kreppvor, and their seven sisters.

\textbf{80.} How much violence have they perpetrated Svaf and Svaflogi!
bloodshed they have excited, and wounds have sucked, after an evil
custom.

\textbf{81.} This lay, which I have taught thee, thou shalt before the living
sing, the Sun-Song, which will appear in many parts no fiction.

\textbf{82.} Here we part, but again shall meet on the day of men's
rejoicing. Oh Lord! unto the dead grant peace, and to the living
comfort.

\textbf{83.} Wondrous lore has in dream to thee been sung, but thou hast seen
the truth: no man has been so wise created that has before heard the
Sun-song.

\xchapter{The Lay of Volund.}
...
\textbf{4.} From the chase came the ardent hunters, Slagfid and Egil, found
their house deserted, went out and in, and looked around. Egil went
east after Olrun, and Slagfid west after Svanhvit;

\textbf{5.} But Volund alone remained in Ulfdal. He the red gold set with the
hard gem, well fastened all the rings on linden bast, and so awaited
his bright consort, if to him she would return.

\textbf{6.} It was told to Nidud, the Niarars' lord, that Volund alone
remained in Ulfdal. In the night went men, in studded corslets, their
shields glistened in the waning moon.

\textbf{7.} From their saddles they alighted at the house's gable, thence
went in through the house. On the bast they saw the rings all drawn,
seven hundred, which the warrior owned.

\textbf{8.} And they took them off, and they put them on, all save one, which
they bore away. Came then from the chase the ardent hunter, Volund,
gliding\footnote{On snow-shoes.} on the long way.

\textbf{9.} To the fire he went, bear's flesh to roast. Soon blazed the
brushwood, and the arid fir, the wind-dried wood, before Volund.

\textbf{10.} On the bearskin sat, his rings counted, the Alfar's companion:
one was missing. He thought that Hlodver's daughter had it, the young
Alvit, and that she was returned.

\textbf{11.} So long he sat until he slept; and he awoke of joy bereft: on
his hands he felt heavy constraints, and round his feet fetters
clasped.

\textbf{12.} ``Who are the men that on the rings' possessor have laid bonds?
and me have bound?''

\textbf{13.} Then cried Nidud, the Niarars' lord: ``Whence gottest thou,
Volund! Alfars' chief!\footnote{The designation of Alfars' chief, or prince, applied to
...
to the heroic or romantic.} our gold, in Ulfdal?''

\textbf{14.} ``No gold was here in Grani's path, far I thought our land from
the hills of Rhine. I mind me that we more treasures possessed, when,
a whole family, we were at home.

\textbf{15.} Hladgud and Hervor were of Hlodver born; known was Olrun, Kiar's
...
\textbf{16.} His teeth he shows, when the sword he sees, and Bodvild's ring
...
\textbf{17.} ``The sword shines in Nidud's belt, which I whetted as I could
...
\textbf{25.} ``I will so repair the fractured gold, that to thy father it
shall fairer seem, and to thy mother much more beautiful, and to
thyself, in the same degree.''

\textbf{26.} He then brought her beer, that he might succeed the better, as
on her seat she fell asleep. ``Now have I my wrongs avenged, all save
one in the wood perpetrated.''\footnote{The translation of this line is founded solely on a
conjectural emendation of the text. The wrong alluded to may be the
hamstringing.}

\textbf{27.} ``I wish,'' said Volund, ``that on my feet I were, of the use of
...
\textbf{28.} Stood without Nidud's wily wife; then she went in through the
hall; but he on the enclosure sat down to rest. ``Art thou awake
Niarars' lord!''

\textbf{29.} ``Ever am I awake, joyless I lie to rest, when I call to mind my
children's death: my head is chilled, cold are to me thy counsels.
Now with Volund I desire to speak.''

\textbf{30.} ``Tell me, Volund, Alfars' chief! of my brave boys what is
become?''

\textbf{31.} ``Oaths shalt thou first to me swear, by board of ship, by rim of
...
\textbf{32.} To the smithy go, which thou hast made, there wilt thou the
bellows find with blood besprinkled. The heads I severed of thy boys,
and under the prison's mixen laid their bodies.

\textbf{33.} But their skulls beneath the hair I in silver set, and to Nidud
gave; and of their eyes precious stones I formed, which to Nidud's
wily wife I sent.

\textbf{34.} Of the teeth of the two, breast-ornaments I made, and to Bodvild
sent. Now Bodvild goes big with child, the only daughter of you both.''

\textbf{35.} ``Word didst thou never speak that more afflicted me, or for
...
\textbf{36.} Laughing Volund rose in air, but Nidud sad remained sitting.

\textbf{37.} ``Rise up Thakrad, my best of thralls! bid Bodvild, my
fair-browed daughter, in bright attire come, with her sire to speak.

\textbf{38.} Is it, Bodvild! true what has been told to me, that thou and
Volund in the isle together sat?''

\textbf{39.} ``True it is, Nidud! what has been told to thee, that Volund and
...
\xchapter{The Lay of Helgi Hiorvard's Son.}
...
\textbf{1.} Hast thou seen Sigrlinn, Svafnir's daughter, of maidens fairest,
in her pleasant home? though fair the wives of Hiorvard seem to men in
Glasis-lund.

\emph{Atli.}

\textbf{2.} With Atli, Idmund's son, sagacious bird! wilt thou further speak?
...
\textbf{3.} Choose not Hiorvard nor his sons, nor the fair daughters of that
prince, nor the wives which the king has. Let us together bargain;
that is the part of friends.

\emph{Bird.}

\textbf{4.} A fane I will chose, offer steads many, gold-horned cows from the
...
\textbf{5.} Labour we have had, but errand none performed; our horses failed
...
\textbf{6.} Late wilt thou, Helgi! rings possess, a potent warrior, or
Rodulsvellir,—so at morn the eagle sang—if thou art ever silent;
although thou, prince! a fierce mood mayest show.

\emph{Helgi}.

\textbf{7.} What wilt thou let accompany the name of Helgi, maid of aspect
...
\textbf{8.} Swords I know lying in Sigarsholm, fewer by four than five times
ten: one of them is of all the best, of shields the bale, with gold
adorned.

\textbf{9.} A ring is on the hilt, courage in the midst, in the point terror
...
\textbf{10.} Hiorvard! thou art not a king of wholesome counsel, leader of
...
\textbf{11.} But Hrodmar shall of the rings dispose, which our relations have
...
\textbf{27.} Hear now, Hrimgerd! If I may indemnify thee, say fully to the
king: was it one being only, that saved the prince's ships, or went
many together?

\emph{Hrimgerd}.

\textbf{28.} Three troops of maidens; though one maid foremost rode, bright,
...
\textbf{29.} Look eastward now, Hrimgerd! whether Helgi has not stricken thee
with death-bearing words. By land and water the king's fleet is safe,
and the chief's men also.

\textbf{30.} It is now day, Hrimgerd! and Atli has thee detained to thy loss
...
vows at the Bragi-cup.\footnote{At guilds the Bragi-cup (Bragafull) was drunk. It was
...
that might be made a subject for the song of the skalld.} Hedin bound himself by a vow to possess
...
\textbf{31.} Welcome art thou, Hedin! What new tidings canst thou give from
Norway? Why art thou, prince! from the land driven, and alone art come
to find us?

\emph{Hedin}.

\textbf{32.} Of a much greater crime I am guilty. I have chosen a royal
daughter, thy bride, at the Bragi-cup.

\emph{Helgi}.

\textbf{33.} Accuse not thyself; true will prove words at drinking uttered by
...
\textbf{34.} Thou saidst, Helgi! that Hedin well deserved of thee, and great
...
\textbf{35.} On a wolf rode, at evening twilight, a woman who him offered to
...
\textbf{16.} Forthwith inquired the chieftain bold, from the wolf-congress of
the southern Disir, whether they would, with the warriors, that night
go home?—then was a clash of arms!

\textbf{17.} One from her horse, Hogni's daughter, stilled the crash of
shields, and to the leader said: ``We have, I ween, other objects than
with princely warriors to drink beer.

\textbf{18.} My father has his daughter promised to the fierce son of
Granmar; but I have, Helgi! declared Hodbrodd, the proud prince, like
to a cat's son.

\textbf{19.} That chief will come in a few days, unless thou him call to a
hostile meeting; or the maiden take from the prince.''

\emph{Helgi}.

\textbf{20.} Fear thou not Isung's slayer; there shall be first a clash of
foes, unless I am dead.

\textbf{21.} Thence sent messengers the potent prince through air and over
water, succours to demand, and abundance of ocean's gleam to men to
offer, and to their sons.

\textbf{22.} ``Bid them speedily to the ships to go, and those from Brandey to
hold them ready.'' There the king abode, until thither came warriors in
hundreds from Hedinsey.

\textbf{23.} From the strands also, and from Stafnsnes, a naval force went
out, with gold adorned. Helgi then of Hiorleif asked: ``Hast thou
mustered the valiant people?''

\textbf{24.} But the young king the other answered: ``Slowly'' said he ``are
counted from Tronuey the long-beaked ships, under the seafarers, which
sail without in the Oresund,—

\textbf{25.} Twelve hundred faithful men; though in Hatun there is more than
half of the king's host—We are to war inured.''

\textbf{26.} Then the steersman threw the ship's tents aside, that the
...
\textbf{27.} There was a dash of oars, and clash of iron, shield against
shield resounded: the vikings rowed; roaring went, under the
chieftains the royal fleet far from the land.

\textbf{28.} So might be heard, when together came the tempest's sister\footnote{Kolga Systir. Kolga was one of the daughters of Oeglr
and Ran; they were the waves.}
and the long keels, as when rock and surge on each other break.

\textbf{29.} Higher still bade Helgi the deep sail be hauled. No port gave
shelter to the crews; when Oegir's terrific daughter the chieftains'
vessels would o'erwhelm,

\textbf{30.} But from above Sigrun intrepid, saved them and their fleet also;
from the hand of Ran powerfully was wrested the royal ship at
Gnipalund.

\textbf{31.} At eve they halted in Unavagar; the splendid ships might into
port have floated, but the crews, from Svarinshaug, in hostile mood,
espied the host.

\textbf{32.} Then demanded the god-born Gudmund: ``Who is the chieftain that
commands the fleet, and that formidable force brings to our land?''

\textbf{33.} Sinfiotli said, slinging up on the yard a red-hued shield with
golden rim;—He at the strait kept watch, and able was to answer, and
with nobles words exchange—

\textbf{34.} ``Tell it at eve, when you feed your pigs, and your dogs lead to
their food, that the Ylfings from the east are come, ready to fight at
Gnipalund.

\textbf{35.} Hodbrodd will Helgi find in the fleet's midst, a king hard to
make flee, who has oft the eagles sated, while thou wast at the mills,
kissing the thrall-wenches.

\emph{Gudmund}.

\textbf{36.} Little dost thou remember of ancient saws, when of the noble
...
\textbf{37.} Thou wast a Valacrone in Varinsey, cunning as a fox, a spreader
of lies. Thou saidst thou no man wouldst ever marry, no corsleted
warrior, save Sinfiotli.

\textbf{38.} A mischievous crone wast thou, a giantess, a Valkyria, insolent,
...
\textbf{39.} Father thou wast not of Fenriswolves, older than all, as far as
I remember; since by Gnipalund, the Thurs-maidens thee emasculated
upon Thorsnes.

\textbf{40.} Thou wast Siggeir's stepson, at home under the benches layest,
...
\textbf{41.} Thou wast Grani's bride at Bravollr, hadst a golden bit, ready
for the course. Many a time have I ridden thee tired, hungry and
saddled, through the fells, thou hag!

\emph{Gudmund}.

\textbf{42.} A graceless lad thou wast thought to be, when Gulnir's goats
thou didst milk. Another time thou wast a giantess's daughter, a
tattered wretch. Wilt thou a longer chat?

\emph{Sinfiotli}.

\textbf{43.} I rather would at Frekastein the ravens cram with thy carcase,
than thy dogs lead to their meat, or thy hogs feed. May the fiend deal
with thee!

\emph{Helgi}.

\textbf{44.} ``Much more seemly, Sinfiotli! would it be for you both in battle
to engage, and the eagles gladden, than with useless words to contend,
however princes\footnote{Literally \emph{ring-breakers, or-dispensers}.} may foster hate.

\textbf{45.} Not good to me appear Granmar's sons, yet 'tis right that
princes should speak the truth: they have shown, at Moinsheimar, that
they have courage to draw the sword.''—

\textbf{46.} Rapidly they their horses made to run, Svipud and Svegiud, to
Solheimar, over dewy dales, dark mountain-sides; trembled the sea of
mist, where the men went.

\textbf{47.} The king they met at the burgh's gate, to the prince announced
...
\textbf{48.} ``Hither to the shore are come rapid keels, towering masts, and
long yards, shields many, and smooth-shaven oars, a king's noble host,
joyous Ylfings.

\textbf{49.} Fifteen bands are come to land; but there are out at sea, before
...
\textbf{50.} ``Let a bridled steed to the chief assembly run, but Sporvitnir
to Sparinsheid; Melnir and Mylnir to Myrkvid; let no man stay behind
of those who swords can brandish.

\textbf{51.} Summon to you Hogni, and the sons of Hring, Atli and Yngvi, Alf
the old; they will gladly engage in conflict. We will let the Volsungs
find resistance.''

\textbf{52.} It was a whirlwind, when together came the fallow\footnote{It would appear that their swords were of bronze.} blades at
...
\textbf{53.} Then came a maid from heaven, helmed, from above—the clash of
arms increased—for the king's protection. Then said Sigrun—well
skilled to fly to the host of heroes from Hugin's grove—\footnote{Hugin's grove. The raven's grove, i.e., the battlefield,
strewed with corpses, the raven's food.}

\textbf{54.} ``Unscathed shalt thou, prince! possess thy people, pillar of
...
\xchapter{The Second Lay of Helgi Hundingcide.}
...
\textbf{1.} ``Say thou to Heming, that Helgi bears in mind who the mailed
...
\textbf{2.} Sharp are the eyes of Hagal's thrall-wench; of no churlish race
...
\textbf{3.} No wonder 'tis that the receiver rattles, when a royal damsel the
...
Brunavagar, and carried on ``strand-hogg''\footnote{Slaughtering and carrying off the cattle on the
sea-shore.} and ate raw flesh. There
...
\textbf{4.} What men cause a ship along the coasts to float? where do ye
warriors a home possess? what await ye in Brunavagar? whither desire
ye to explore a way?

\emph{Helgi}.

\textbf{5.} Hamal causes a ship along the coasts to float; we have home in
Hlesey; a fair wind we await in Brunavagar; eastward we desire to
explore a way.

\emph{Sigrun}.

\textbf{6.} Where, O prince! hast thou wakened war, or fed the birds of
conflict's sisters?\footnote{The Valkyriur.} Why is thy corslet sprinkled with blood? Why
beneath the helm eat ye raw flesh?

\emph{Helgi}.

\textbf{7.} It was the Ylfings' son's last achievement,—if thou desirest to
...
\textbf{8.} To a battle thou alludest. Before Helgi has King Hunding been
doomed to fall. In conflict ye have engaged, when your kindred ye
avenged, and stained with blood the falchion's edge.

\emph{Helgi}.

\textbf{9.} Why dost thou suppose, sagacious maiden! that it was they, who
their kin avenged? Many a warrior's bold sons there are, and hostile
to our kindred.

\emph{Sigrun}.

\textbf{10.} I was not far, leader of people! eager, at many a chieftain's
end: yet crafty I account Sigmund's son, when in val-runes\footnote{Dark words of deadly import.} the
slaughter he announces.

\textbf{11.} A while ago I saw thee commanding the warships, when thou hadst
...
\textbf{12.} Sigrun sought the joyous prince, Helgi's hand she forthwith
grasped, kissed and addressed the helm-decked king.

\textbf{13.} Then was the chieftain's mind to the lady turned. She declared
that she had loved, with her whole heart, Sigmund's son, before she
had seen him.

\textbf{14.} ``To Hodbrodd I was in th' assembly betrothed, but I another
prince would have: yet, chieftain! I foresee my kindred's wrath: I
have my father's promise broken.''

\textbf{15.} Hogni's daughter spoke not at variance with her heart: she said
that Helgi's affection she must possess.

\emph{Helgi}.

\textbf{16.} Care thou not for Hogni's wrath, nor for the evil mind of thy
...
\textbf{17.} Who is the warrior that commands the ships, and lets his golden
...
\textbf{18.} Here may Hodbrodd Helgi learn to know, the hard of flight, in
the fleet's midst: he the possession holds of thy race; he the fishes'
heritage has to him subjected.

\emph{Gudmund}.

\textbf{19.} Therefore ought we first, at Frekastein, to settle together, and
decide our quarrels! Hodbrodd! 'tis time vengeance to take, if an
inferior lot we long have borne.

\emph{Sinfiotli}.

\textbf{20.} Rather shalt thou, Gudmund! tend goats, and steep mountain-tops
...
\textbf{27.} Sigrun! console thyself; a Hild thou hast been to us. Kings
...
\textbf{28.} Loath am I, sister! sad news to tell thee; for unwillingly I
...
\textbf{29.} Thee shall the oaths all gnaw, which to Helgi thou didst swear,
at the limpid Leiptr's water, and at the cold dank wave-washed rock.

\textbf{30.} May the ship not move forward, which under thee should move,
...
\textbf{31.} May the sword not bite which thou drawest, unless it sing round
...
\textbf{35.} So had Helgi struck with fear all his foes and their kindred, as
before the wolf the goats run frantic from the fell, of terror full.

\textbf{36.} So himself Helgi among warriors bore, as the towering ash is
...
\textbf{37.} Thou, Hunding! shalt for every man a foot-bath get, and fire
...
\textbf{38.} Is it a delusion which methinks I see, or the powers'
dissolution, that ye, dead men, ride, and your horses with spurs urge
on, or to warriors is a home journey granted?

\emph{Helgi}.

\textbf{39.} 'Tis no delusion which thou thinkst to see, nor of mankind the
...
\textbf{40.} Sigrun! go forth from Sefafioll, if the people's chief thou
...
\textbf{41.} Now am I as glad, at our meeting, as the voracious hawks of
Odin, when they of slaughter know; of warm prey, or, dewy-feathered,
see the peep of day.

\textbf{43.} I will kiss my lifeless king, ere thou thy bloody corslet layest
...
\textbf{43.} Thou art alone the cause,\footnote{The superstition commemorated In this strophe is, no
...
Brim full of blood and gore.''} Sigrun of Sefafioll! that Helgi is
...
\textbf{44.} We shall surely drink delicious draughts, though we have lost
...
\textbf{35.} Here, Helgi! have I for thee a peaceful couch prepared, for the
Ylfings' son. On thy breast I will, chieftain! repose, as in my hero's
lifetime I was wont.

\emph{Helgi}.

\textbf{46.} Nothing I now declare unlooked for, at Sefafioll, late or early,
since in a corpse's arms thou sleepest, Hogni's fair daughter! in a
mound, and thou art living, daughter of kings!

\textbf{47.} Time 'tis for me to ride on the reddening ways: let the pale
...
\textbf{48.} Now would he come, if he to come intended, Sigmund's son, from
...
\textbf{49.} Be not so rash alone to go, daughter of heroes! to the house of
draugs:\footnote{Probably house of draffs; place of swine, swill, lees.} more powerful are, in the night-season, all dead warriors,
...
\textbf{SIEGFRIED AWAKENS BRYNHILD.}

(\emph{after the painting of R. Bung.})
...
\xchapter{The First Lay of Sigurd Fafnicide, or Gripir's Prophecy.}
...
\textbf{1.} Who here inhabits, in these towers? what nation's king do people
name him?
...
\textbf{2.} Is the wise king of the land at home? Will the chief with me come
and converse? With him needs speech an unknown man: I desire speedily
Gripir to see.

\emph{Geitir}.

\textbf{3.} The glad king will of Geitir ask, who the man is that demands
speech of Gripir.
...
\textbf{33.} Prince! thou wilt be snared in another's wiles, thou wilt pay
...
\textbf{46.} What atonement will that woman take, for the frauds we shall
have practised on her? From me the maiden has oaths sworn, but never
kept, and but little joy.

\emph{Gripir.}

\textbf{47.} She to Gunnar will plainly declare, that thou didst not well the
oaths observe, when the noble king, Giuki's heir, with his whole soul,
in thee confided.

\emph{Sigurd.}

\textbf{48.} What will then follow? let me know that. Will that tale appear
as true, or that the noble woman falsely accuses me, and herself also.
Tell me that, Gripir!

\emph{Gripir}.

\textbf{49.} From spite towards thee, and from o'erwhelming grief, the
...
\textbf{50.} Will the prudent Gunnar, Guthorm, and Hogni, at her instigation,
then proceed? Will Giuki's sons on their relative redden their swords?
Tell me further, Gripir!

\emph{Gripir}.

\textbf{51.} Then will Gudrun be furious at heart, when her brothers shall on
thy death resolve. In nothing then will that wise woman take delight.
Such is Grimhild's work.

\textbf{52.} In this thou shalt find comfort, leader of hosts! This fortune
...
\textbf{1.} What fish is this, that in the river swims, and cannot from harm
itself protect? Redeem thy life from Hel, and find me the water's
flame.\footnote{One of many periphrases for gold.} \emph{The Pike}.

\textbf{2.} Andvari I am named, Oin was my father named; many a cataract have
I passed. A luckless Norn in times of old decreed, that in the water I
should wade.

\emph{Loki}.

\textbf{3.} Tell me, Andvari! if thou wilt enjoy life in the halls of men,
what retribution get the sons of mortals, if with foul words they
assail each other.

\emph{Andvari}.

\textbf{4.} Cruel retribution get the sons of mortals, who in Vadgelmir wade:
...
\textbf{5.} That gold which the dwarf possessed, shall to two brothers be
...
\textbf{6.} There is gold for thee, and thou hast a great redemption for my
life. For thy son no blessing is decreed; of both it shall prove the
bane.

\emph{Hreidmar}.

\textbf{7.} Gifts thou hast given, friendly gifts thou hast given not; with a
kind heart thou hast not given. Of your lives ye should have been
deprived, had I foreknown that peril.

\textbf{8.} But that is worse, what I seem to know,—a strife of kinsmen for
a woman. Princes yet unborn I think them to be, for whose hate that
gold is destined.

\textbf{9.} The red gold, I trust, I shall possess while I am living: of thy
...
\textbf{10.} Lyngheid and Lofnheid! Know my life is departing. To many things
need compels.\footnote{To wit, \emph{to avenge my death on your brothers}.} \emph{Lyngheid}.
...
\textbf{11.} Then bring forth a daughter, wolf-hearted fury! If by a chief
...
\textbf{12.} Thou of thy brother shalt mildly demand thy patrimony and a
...
\textbf{13.} Hither is come the son of Sigmund to our Hall, that man of
energy: courage he has greater than I aged man: now of a conflict have
I hope from the fierce wolf.\footnote{Sigurd.}

\textbf{14.} I will nurture the bold-hearted prince: now Yngvi's kinsman is
...
``Oegis-helm,''\footnote{A terrific helm or headpiece.} at which all living beings were terror-stricken.
...
\textbf{15.} Loud will laugh Hunding's sons, they who Eylimi of life
...
\textbf{16.} Who ride yonder, on Rævils horses, the towering billows, the
roaring main: the sail-steeds are with sweat bedewed, the
wave-coursers will not the wind withstand.

\emph{Regin}.

\textbf{17.} Here am I and Sigurd in sea-trees; a fair wind is given us for
death itself: higher than our prows the steep waves dash, the rolling
horses plunge. Who is it that inquires?

\emph{Hnikar}.

\textbf{18.} They called me Hnikar, when I Hugin gladdened, young Volsung!
...
\textbf{19.} Tell me, Hnikar! since thou knowest the omens both of gods and
men, which omens are the best—if to fight 'tis needful—at the swing
of glaves?

\emph{Hnikar}.

\textbf{20.} Good omens there are many, if men but knew them, at the swing of
glaves, a faithful fellowship, I think, is the dark raven's, with the
sworded warrior.

\textbf{21.} The second is, if, when thou art gone out, and about to depart,
thou seest two renown-seeking men standing in the fore-court.

\textbf{22.} The third omen is, if wolves thou hearest howl under the
ash-boughs, it will victory to thee announce over helmed warriors, if
thou seest them go before thee.

\textbf{23.} No man should fight against the moon's late-shining sister. They
have victory, who can see keenly at the play of swords, or to form the
wedge-array.

\textbf{24.} Most perilous it is, if with thy foot thou strikest, when thou
to battle goest. Wily Disir stand on either side of thee, and wish to
see thee wounded.

\textbf{25.} Combed and washed let every brave man be, and at morning fed;
...
\textbf{26.} Now is the bloody eagle, with the trenchant blade, graven on the
...
\textbf{1.} Young fellow! young fellow! by what fellow art thou begot? of
...
\textbf{2.} Gofugt-dyr I am called, but I have wandered a motherless child;
nor have I a father like the sons of men: alone I wander.

\emph{Fafnir}.

\textbf{3.} If thou hast no father like the sons of men, by what wonder art
thou begotten?

\emph{Sigurd}.

\textbf{4.} My race, I tell thee, is to thee unknown, and myself also.
Sigmund was my father named, my name is Sigurd, who with weapon have
assailed thee.

\emph{Fafnir}.

\textbf{5.} Who has incited thee? why hast thou suffered thyself to be
incited to take my life? youth of the sparkling eyes! Thou hadst a
cruel father— * * * *

\emph{Sigurd}.

\textbf{6.} My heart incited me, my hands gave me aid, and my keen sword.
Rarely a man is bold, when of mature age, if in childhood he was
faint-hearted.

\emph{Fafnir}.

\textbf{7.} I know if thou hadst chanced to grow in the lap of friends, they
would have seen thee fierce in fight. Now thou art a captive, taken in
war, and, 'tis said, slaves ever tremble.

\emph{Sigurd}.

\textbf{8.} Why Fafnir! dost thou upbraid me that I am far from my paternal
home? I am not a captive, although in war I was taken: thou hast found
that I am free.

\emph{Fafnir}.

\textbf{9.} Thou wilt account only as angry words all I to thee shall say,
but I will say the truth. The jingling gold, and the gleed-red
treasure, those rings, shall be thy bane.

\emph{Sigurd}.

\textbf{10.} Treasure at command every one desires, ever till that one day;
for at some time each mortal shall hence to Hel depart.

\emph{Fafnir}.

\textbf{11.} The Norns' decree thou wilt hold in contempt as from a witless
wight: In water thou shalt be drowned, if in wind thou rowest. All
things bring peril to the fated.

\emph{Sigurd}.

\textbf{12.} Tell me, Fafnir! as thou art wise declared, and many things to
know: who those Norns are, who help in need, and from babes loose the
mothers.

\emph{Fafnir}.

\textbf{13.} Very diversely born I take those Norns to be: they have no
common race. Some are of Æsir-race, some of Alfar-race, some are
Dvalin's daughters.

\emph{Sigurd}.

\textbf{14.} Tell me, Fafnir! as thou art wise declared, and many things to
know, how that holm is called, where Surt and the Æsir will
sword-liquor together mingle?

\emph{Fafnir}.

\textbf{15.} Oskopnir it is called; there shall the gods with lances play;
Bifrost shall be broken, when they go forth, and their steeds in the
river swim.

\textbf{16.} An Oegis-helm I bore among the sons of men, while I o'er the
treasures lay; stronger than all I thought myself to be; stronger I
found not many!

\emph{Sigurd}.

\textbf{17.} An Oegis-helm is no protection, where men impelled by anger
fight: soon he finds, who among many comes, that no one is alone the
boldest.

\emph{Fafnir}.

\textbf{18.} Venom I blew forth, when on my father's great heritage I lay.

\emph{Sigurd}.

\textbf{19.} Thou, glistening serpent! didst a great belching make, and wast
so hard of heart. Fierceness so much the greater have the sons of men,
when they possess that helm.

\emph{Fafnir}.

\textbf{20.} Sigurd! I now counsel thee, do thou take my counsel; and hence
ride home. The jingling gold, and the gleed-red treasure, those rings,
shall be thy bane.

\emph{Sigurd}.

\textbf{21.} Counsel regarding thee is taken, and I to the gold will ride, on
the heath that lies. But lie thou, Fafnir! in the pangs of death,
until Hel have thee!

\emph{Fafnir}.

\textbf{22.} Regin betrayed me, he will thee betray, he of us both will be
...
\textbf{27.} Sit now, Sigurd!—but I must go to sleep—and Fafnir's heart
hold to the fire. Of this refection I would fain partake, after that
drink of blood.

\emph{Sigurd}.

\textbf{28.} Thou wentst far off, while I in Fafnir my keen sword reddened.
With my strength I strove against the serpent's might, while in the
ling thou layest.

\emph{Regin}.

\textbf{29.} Long hadst thou allowed in the ling to lie that Jotun old, hadst
thou the sword not used that I forged for thee, thy keen-edged glave.

\emph{Sigurd}.

\textbf{30.} Valour is better than might of sword, when foes embittered
fight; for a brave man I have ever seen gain victory with a dull
sword.

\textbf{31.} For the brave 'tis better than for the timid to join in the game
...
\textbf{38.} There sits Sigurd sprinkled with blood; Fafnir's heart at the
fire he roasts. Wise methinks were the ring-dispenser, if he the
glistening life-pulp ate.

\emph{Second eagle}.

\textbf{33.} There lies Regin communing with himself; he will beguile the
youth, who in him trusts: in rage he brings malicious words together,
the framer of evil will avenge his brother.

\emph{Third eagle}.

\textbf{34.} By the head shorter, let him the hoary babbler send hence to
Hel; then can he all the gold possess alone, the mass that under
Fafnir lay.

\emph{Fourth eagle}.

\textbf{35.} He would, methinks, be prudent, if he could have your friendly
counsel, my sisters! If he would bethink himself, and Hugin gladden.
There I expect the wolf, where his ears I see.

\emph{Fifth eagle}.

\textbf{36.} Not so prudent is that tree of battle, as I that martial leader
had supposed, if he one brother lets depart, now he the other has of
life bereft.

\emph{Sixth eagle}.

\textbf{37.} He is most simple, if he longer spares that people's pest. There
lies Regin, who has betrayed him.—He cannot guard against it.

\emph{Seventh eagle}.

\textbf{38.} By the head shorter let him make the ice-cold Jotun, and of his
rings deprive him; then of that treasure thou,\footnote{I.e., Sigurd; a transition from the 3d person to the
2nd.} which Fafnir owned,
sole lord wilt be!

\emph{Sigurd}.

\textbf{39.} Fate shall not so resistless be, that Regin shall my death-word
...
\textbf{40.} Bind thou, Sigurd! the red-gold rings. It is not kingly many
things to fear. I a maid know by far the fairest, with gold adorned.
Couldst thou but her obtain!

\emph{Second eagle}.

\textbf{41.} To Giuki lead all-verdant ways; the fates point out to
wayfarers where the good king a born daughter has; her wilt thou,
Sigurd! purchase with bridal gifts.

\emph{Third eagle}.

\textbf{42.} There stands a hall on the high Hindarfiall, without 'tis all
with fire surrounded; sagacious men have it constructed of the
resplendent radiance of the flood.\footnote{Another periphrasis for gold.}

\emph{Fourth eagle}.

\textbf{43.} On the fell I know a warrior maid to sleep, over her waves the
linden's bane.\footnote{A periphrasis for fire.} Ygg whilom stuck a sleep-thorn in the robe of the
maid who would heroes choose.

\textbf{44.} Thou, youth! mayest see the helmed maiden, her whom Vingskornir
from battle bore. May not Sigrdrifa's slumber break the son of
warriors,\footnote{Of Skioldungs.} against the Norns' decrees.
...
\textbf{1.} What has my corslet cut? why from sleep have I started? who has
cast from me the fallow bands?

\emph{Sigurd}.

Sigmund's son has just now ript the raven's perch,\footnote{The original words, hrafns hrælundir, \emph{the raven's
corpse-trees.} So Grimm understands the line; because that bird hops
about upon the armour as upon a tree.} with Sigurd's
sword.

\emph{She}.

\textbf{2.} Long have I slept, long been with sleep oppressed, long are
...
mead, and gave him the \emph{minnis-cup}.

\emph{She}.

\textbf{3.} Hail to Day! Hail to the sons of Day! To Night and her daughter
hail! With placid eyes behold us here, and here sitting give us
victory.

\textbf{4.} Hail to the Æsir! Hail to the Asyniur! Hail to the bounteous
earth! Words and wisdom give to us noble twain, and healing hands\footnote{The superstition of the \emph{healing hand} is not yet
...
\textbf{5.} Beer I bear to thee, column\footnote{Literally \emph{apple-tree}.} of battle! with might mingled,
and with bright glory: 'tis full of song, and salutary saws, of potent
incantations, and joyous discourses.

\textbf{6.} Sig-runes thou must know, if victory (sigr) thou wilt have, and
on thy sword's hilt grave them; some on the chapes, some on the guard,
and twice name the name of Ty.

\textbf{7.} Ol- (beer-) runes thou must know, if thou wilt not that another's
wife thy trust betray, if thou in her confide. On the horn must they
be graven, and on the hand's back, and Naud\footnote{The name of a rune.} on the nail be scored.

\textbf{8.} A cup must be blessed, and against peril guarded, and garlick in
the liquor cast: then I know thou wilt never have mead with treachery
mingled.

\textbf{9.} Biarg- (help-) runes thou must know, if thou wilt help, and loose
the child from women. In the palm they must be graven, and round the
joints be clasped, and the Disir prayed for aid.

\textbf{10.} Brim- (sea-) runes thou must know, if thou wilt have secure
...
\textbf{11.} Lim- (branch-) runes thou must know, if thou a leech wouldst be,
...
\textbf{12.} Mal- (speech-) runes thou must know, if thou wilt that no one
...
\textbf{13.} Hug- (thought-) runes thou must know, if thou a wiser man wilt
...
\textbf{14.} On a rock he stood, with edged sword, a helm on his head he
bore. Then spake Mim's head its first wise word, and true sayings
uttered.

\textbf{15.} They are, it said, on the shield graven, which stands before the
...
\textbf{16.} On the bear's paw, and on Bragi's tongue, on the wolf's claws,
and the eagle's beak, on bloody wings, and on the bridge's end, on the
releasing hand, and on healing's track.

\textbf{17.} On glass and on gold, on amulets of men, in wine and in wort,
and in the welcome seat, on Gungnir's point, and on Grani's breast, on
the Norn's nail, and the owl's neb.

\textbf{18.} All were erased that were inscribed, and mingled with the sacred
...
\textbf{19.} Those are bok-runes,\footnote{Literally beech- (book-) runes, from being used for book
writing or graving on thin leaves of beech (bok), whence our \emph{book}.
Bok also signifies \emph{acupictile}, vel \emph{acupictum (velum, auloeum}).} those are biarg-runes, and all
...
\textbf{20.} Now thou shalt choose, since a choice is offered thee, keen
armed warrior! my speech, or silence: think over it in thy mind. All
evils\footnote{An allusion to Sigurd's unhappy end.} have their measure.

\emph{Sigurd}.

\textbf{21.} I will not flee, though thou shouldst know me doomed. I am not
born a craven. Thy friendly counsels all I will receive, as long as
life is in me.

\emph{Sigrdrifa}.

\textbf{22.} This I thee counsel first: that towards thy kin thou bear thee
blameless. Take not hasty vengeance, although they raise up strife:
that, it is said, benefits the dead.

\textbf{23.} This I thee counsel secondly: that no oath thou swear, if it be
not true. Cruel bonds follow broken faith: accursed is the
faith-breaker.

\textbf{24.} This I thee counsel thirdly: that in the assembly thou contend
not with a fool; for an unwise man oft utters words worse than he
knows of.

\textbf{25.} All is vain, if thou holdest silence; then wilt thou seem a
...
\textbf{26.} This I counsel thee fourthly: if a wicked sorceress dwells by
the way, to go on is better than there to lodge, though night may
overtake thee.

\textbf{27.} Of searching eyes the sons of men have need, when fiercely they
have to fight: oft pernicious women by the way-side sit, who swords
and valour deaden.

\textbf{28.} This I thee counsel fifthly: although thou see fair women on the
benches sitting, let not their kindred's silver over thy sleep have
power. To kiss thee entice no woman.

\textbf{29.} This I thee counsel sixthly: although among men pass offensive
tipsy talk, never while drunken quarrel with men of war: wine steals
the wits of many.

\textbf{30.} Brawls and drink to many men have been a heartfelt sorrow; to
some their death, to some calamity: many are the griefs of men!

\textbf{31.} This I thee counsel seventhly: if thou hast disputes with a
daring man, better it is for men to fight than to be burnt within
their dwelling.

\textbf{32.} This I thee counsel eighthly: that thou guard thee against evil,
and eschew deceit. Entice no maiden, nor wife of man, nor to
wantonness incite.

\textbf{33.} This I thee counsel ninthly: that thou corpses bury, wherever on
the earth thou findest them, whether from sickness they have died, or
from the sea, or are from weapons dead.

\textbf{34.} Let a mound be raised for those departed; let their hands and
head be washed, combed, and wiped dry, ere in the coffin they are
laid: and pray for their happy sleep.

\textbf{35.} This I thee counsel tenthly: that thou never trust a foe's
...
\textbf{36.} Strifes and fierce enmities think not to be lulled, no more than
deadly injury. Wisdom and fame in arms a prince not easily acquires,
who shall of men be foremost.

\textbf{37.} This I counsel thee eleventhly: that thou at evil look, what
...
\xchapter{Fragments of the Lay of Sigurd and Brynhild.}

\footnote{These fragments from the Volsunga-Saga, which are
...
\textbf{1.} The fire began to rage, and the earth to tremble, high rose the
flame to heaven itself: there ventured few chiefs of people through
that fire to ride, or to leap over.

\textbf{2.} Sigurd Grani with his word urged, the fire was quenched before
...
some to Guthorm dealt out gold; gave him Geri's\footnote{The name of one of Odin's wolves; here used poetically
for \emph{wolf} in general.} flesh with his
...
\xchapter{The Third Lay of Sigurd Fafnicide.}

\textbf{1.} It was of old that Sigurd, the young Volsung, Giuki sought, after
his conflict, received the pledge of friendship from the two brothers;
oaths exchanged the bold of deed.

\textbf{2.} A maid they offered him, and treasures many, Gudrun, Giuki's
youthful daughter. Drank and conversed, many days together, Sigurd the
young and Giuki's sons.

\textbf{3.} Until they went to woo Brynhild, and with them Sigurd, the
youthful Volsung, rode in company, who knew the way. He would have
possessed her, if her possess he might.

\textbf{4.} Sigurd the southern laid a naked sword, a glittering falchion,
...
\textbf{5.} She to herself of body was of no sin conscious, nor at her
death-day, of any crime, that could be a stain, or thought to be:
intervened therein the grisly fates.

\textbf{6.} Alone she sat without, at eve of day, began aloud with herself to
speak: ``Sigurd must be mine; I must die, or that blooming youth clasp
in my arms.''

\textbf{7.} ``Of the words I have uttered I now repent; he is Gudrun's
consort, and I am Gunnar's. The hateful Norns long suffering have
decreed us.''

\textbf{8.} Oftentimes she wandered, filled with evil thoughts, o'er ice and
...
\textbf{9.} ``Devoid I go of spouse and pleasure; I will beguile myself with
vengeful thoughts.''

\textbf{10.} By those fits of fury she was impelled to murder. ``Thou, Gunnar!
shalt wholly lose my land, and myself also. Never shall I be happy,
king! with thee.

\textbf{11.} I will return thither from whence I came, to my near kindred, my
...
\textbf{12.} Let the son go together with the father, the young wolf may not
longer be fostered. For whom will vengeance be the easier to appease,
if the son lives?''

\textbf{13.} Wroth was Gunnar, and with grief borne down; in his mind
...
\textbf{19.} I know full well whence the causes spring: Brynhild's
importunity is over-great.

\textbf{20.} We will Guthorm, our younger brother, and not over-wise, for the
deed prepare: he is free from sworn oaths, sworn oaths, and plighted
faith.''

\textbf{21.} Easy it was to instigate the ferocious spirit: in the heart of
Sigurd stood his sword.

\textbf{22.} On vengeance bent, the warrior in his chamber hurled his brand
after the fierce assassin; to Guthorm flew dartlike Gram's gleaming
steel from the king's hand.

\textbf{23.} Fell the murderer in two parts, arms and head flew far away, but
his feet's part fell backwards on the place.

\textbf{24.} Sunk in sleep was Gudrun, in her bed, void of cares, by Sigurd's
side: but she awoke of joys bereft, when in the blood of Frey's friend
she swam.

\textbf{25.} So violently struck she her hands together, that the stout of
heart rose in his bed. ``Weep not, Gudrun! so cruelly, my blooming
bride! thy brothers live.

\textbf{26.} An heir I have, alas! too young; he cannot flee from the hostile
house; among themselves they recently have dark and evil counsels
devised.

\textbf{27.} Never henceforth, although seven thou bear, will such a son to
the trysting with them ride. Full well I know how this has befallen:
Brynhild the sole cause is of all the evil.

\textbf{28.} Me the maiden loved more than any man; but towards Gunnar I
sinned not; affinity I held sacred, and sworn oaths; thence forward I
was called his consort's friend.''

\textbf{29.} The woman gave forth sighs, and the king his life. So violently
she struck her hands together, that the beakers on the wall responsive
rang, and in the court the geese loudly screamed.

\textbf{30.} Laughed then Brynhild, Budli's daughter, once only, from her
whole soul, when in her bed she listened to the loud lament of Giuki's
daughter.

\textbf{31.} Then said Gunnar, the hawk-bearing prince: ``Laugh not thereat,
...
\textbf{32.} Well dost thou deserve, above all women, that before thy eyes,
we should lay Atli low, that thou shouldst see thy brother's
blood-streaming sore, his gory wounds shouldst have to bind.''

\textbf{33.} Then said Brynhild, Budli's daughter: ``No one provokes thee,
...
\textbf{34.} Gunnar! will tell thee, though thou well knowest it, how early
we resolved on crimes. I was o'er-young and unrestrained, with wealth
endowed, in my brother's house.

\textbf{35.} Nor did I desire to marry any man, before ye Giukungs rode to
our dwelling, three on horseback, powerful kings: would that journey
had never been!

\textbf{36.} Then myself I promised to the great king, who with gold sat on
Grani's back. In eyes he did not you resemble, nor was at all in
aspect like: yet ye thought yourselves mighty kings.

\textbf{37.} And to me apart Atli said, that he would not have our heritage
...
\textbf{38.} Then distracted was my mind thereon, whether I should engage in
...
\textbf{39.} Our reconciliation we let follow: to me it had been more
...
Menskogul\footnote{That is, Skogul with the necklace; Brynhild applies this
name to herself, which is a compound of men, \emph{necklace, monile}, and
Skogul, the name of a Valkyria.} had not a changing mind.

\textbf{40.} All this will Atli hereafter find, when he shall hear of my
...
\textbf{41.} Up rose Gunnar, prince of warriors, and round his consort's neck
laid his hands; all drew nigh, yet each one singly, through honest
feeling, to dissuade her.

\textbf{42.} She from her neck those about her cast; she let no one stay her
from her long journey.

\textbf{43.} He then called Hogni to consultation. ``I will that all our folk
...
\textbf{44.} To him Hogni answer gave: ``Let no one hinder her from the long
...
\textbf{45.} Downcast he from the meeting turned to where the lady treasures
...
\textbf{46.} On the pillow she turned to the other side, and, wounded with
the glave, on her last counsels thought.

\textbf{47.} ``Now let come those who desire gold, and aught less precious, to
receive from me. To every one I give a gilded necklace,\footnote{Necklaces usually consisted in gold and silver chains or
laces with ornaments attached to them; if these resembled the sun or
moon they were called Sigli, \emph{suns} (such were those here spoken of);
and such was the necklace worn by Freyia, the bright goddess of the
Vanir.}
needle-work and coverlets, splendid weeds.''

\textbf{48.} All were silent, thought on what to do, and all together answer
gave: ``Too many are there dead: we will yet live, still be hungry
hall-servants, to do what fitting is.''

\textbf{49.} At length after reflection, the lady linen-clad, young in years,
words in answer uttered: ``I desire that none, dead to entreaty, should
by force, for our sake, lose their life.

\textbf{50.} Yet o'er your bones will burn fewer ornaments, Menia's good
meal,\footnote{Menia's meal, or flour, is gold.} when ye go hence me to seek.

\textbf{51.} Gunnar! sit down, I will tell to thee, that of life now hopeless
is thy bright consort. Thy vessel will not be always afloat, though I
shall have my life resigned.

\textbf{52.} With Gudrun thou wilt be reconciled, sooner than thou thinkest:
that wise woman has by the king sad memorials, after her consort's
death.

\textbf{53.} There is born a maid, which her mother rears; brighter far than
the clear day, than the sun's beam, will Svanhild be.

\textbf{54.} Gudrun thou wilt give to an illustrious one, a warrior, the bane
of many men: not to her wish will she be married; Atli will come her
to espouse, Budli's son, my brother.

\textbf{55.} Much have I in memory how I was treated, when ye me so cruelly
had deceived: robbed I was of happiness, while my life lasted.

\textbf{56.} Thou wilt desire Oddrun to possess, but Atli will permit it not;
in secret ye will each other meet. She will love thee, as I had done,
if us a better fate had been allotted.

\textbf{57.} Thee will Atli barbarously treat; in the narrow serpent-den wilt
thou be cast.

\textbf{58.} It will too come to pass, not long after, that Atli will his
...
\textbf{62.} One prayer I have to thee yet to make, in this world 'twill be
...
\textbf{63.} Bedeck the pile about with shields and hangings, a variegated
corpse-cloth, and multitude of slain. Let them burn the Hun\footnote{Sigurd.} on the
one side of me;

\textbf{64.} Let them with the Hun burn on the other side, my household
slaves, with collars splendid, two at our heads, and two hawks; then
will all be equally distributed.

\textbf{65.} Let also lie between us both the sword with rings adorned, the
keen-edged iron, so again be placed, as when we both one couch
ascended, and were then called by the name of consorts.

\textbf{66.} Then will not clang against his heel the hall's bright gates,
with splendid ring, if my train him hence shall follow. Then will our
procession appear not mean.

\textbf{67.} For him will follow five female thralls, eight male slaves of
gentle birth, fostered with me, and with my patrimony, which to his,
daughter Budli gave.

\textbf{68.} Much I have said, and more would say, if the sword would grant
me power of speech. My voice fails, my wounds swell: truth only I have
uttered; so I will cease.''

\textbf{A FEAST IN VALHALLA.}

(\emph{From a painting by Jno. Kellar.})
...
\textbf{17.} Ill Gunnar! didst thou remember, when blood ye in your footsteps
both let flow; now hast thou him ill for all that requited, because he
would prove himself foremost.

\textbf{18.} Then was it proved, when the hero had ridden to see me, to woo
me, how the warlike chief whilom held sacred his oath towards the
youthful prince.

\textbf{19.} Laid his sword, with gold adorned, the illustrious king between
...
\xchapter{The First Lay of Gudrun.}
...
\textbf{25.} Then said Brynhild, Budli's daughter: ``Atli my brother, Budli's
offspring, is the sole cause of all the evil;

\textbf{26.} When in the hall of the Hunnish folk, with the king we beheld
the fire of the serpent's bed.\footnote{A periphrasis for gold.} Of that journey, I have paid the
penalty, that sight I have ever rued.''

\textbf{27.} She by a column stood, the wood violently clasped. From the eyes
...
\xchapter{The Second Lay of Gudrun.}
...
\textbf{18.} Gunnar was ready gold to offer, for the injuries to atone, and
...
\textbf{19.} Valdar and the Danes with Jarizleif, Eymod the third with
...
\textbf{20.} For me each one would choose precious gifts, precious gifts, and
to my heart would speak, if for my many woes they might gain my
confidence, and I would in them trust.

\textbf{21.} Grimhild to me brought a potion to drink cold and bitter, that I
my injuries might forget; it was mingled with Urd's power, with cold
sea-water, and with Son's blood.

\textbf{22.} In that horn were characters of every kind graven and red-hued;
nor could I comprehend them: the long lyng-fish\footnote{That is the long fish of the heath, or Ung, a snake or
serpent.} of the Haddings'
land, an uncut ear of corn: the wild-beasts' entrance.

\textbf{23.} In that potion were many ills together, a herb from every wood,
and the acorn, the fire-stead's dew,\footnote{Soot.} entrails of offerings,
swine's liver seethed; for that deadens strife.

\textbf{24.} And then I forgot, when I had taken it, all the king's words in
the hall spoken. There to my feet three kings came, before she herself
sought to speak with me.

\textbf{25.} ``Gudrun! I will give thee gold to possess, of all the riches
much of thy dead father; rings of red gold, Hlodver's halls, all the
hangings left by the fallen king.

\textbf{26.} Hunnish maids, those who weave tapestry, and in bright gold
work, so that it may delight thee. Over Budli's wealth thou alone
shalt rule, adorned with gold, and given to Atli.''

\textbf{27.} ``I will not have any man, nor Brynhild's brother marry: it
beseems me not with Budli's son to increase a race, or life enjoy.''

\textbf{28.} ``Take care not to pay the chiefs with hate; for 'tis we who have
been the aggressors: so shouldst thou act as if yet lived Sigurd and
Sigmund, if sons thou bearest.''

\textbf{29.} ``Grimhild! I cannot in mirth indulge, nor, for my hero's sake,
cherish a hope, since the bloodthirsty [wolf and] raven have together
cruelly drunk my Sigurd's heart's blood.''

\textbf{30.} ``Him\footnote{Atli: Grimhild speaks.} of all I have found to be a king of noblest race, and
in much most excellent: him shalt thou have until age lays thee low,
or mateless be, if him thou wilt not take.''

\textbf{31.} ``Cease to offer that cup of ills so pertinaciously, that race to
...
\textbf{32.} Weeping Grimhild caught the words, by which to her sons Gudrun
...
\textbf{33.} ``Him then I will choose among the kings, and from my relatives
reluctantly receive him. Never will he be to me a welcome consort, nor
my brothers' bale a protection to our sons.''

\textbf{34.} Forthwith on horseback was each warrior to be seen; but the
...
\textbf{35.} There the gate-wards of the lofty burgh the latticed entrance
opened, ere the court we entered.

\textbf{36.} Atli waked me, but I seemed to be full of evil thoughts, for my
kinsmen's death.

\textbf{37.} ``So me just now\footnote{Atli speaks.} have the Norns waked,—a grateful
...
\textbf{38.} ``Fire it forebodes,\footnote{Gudrun answers.} when one of iron dreams, arrogance and
pleasure, a woman's anger. Against evil I will go burn thee, cure and
medicate thee, although to me thou art hateful.''

\textbf{39.} ``Seemed to me here in the garden\footnote{Atli speaks.} that young shoots had
...
\textbf{40.} ``Seemed to me that hawks flew from my hand, lacking their
quarry, to the house of woes; seemed to me I ate their hearts with
honey swollen with blood, with sorrowing mind.

\textbf{41.} ``Seemed to me from my hand whelps I let slip; lacking cause of
joy, both of them howled: seemed to me their bodies became dead
carcases: of the carrion I was compelled to eat.''

\textbf{42.} ``There will warriors\footnote{Gudrun answers.} round thy couch converse, and of the
white-locked ones take off the head; death-doomed they are within a
few nights, a little ere day: thy court will eat of them.''

\textbf{43.} ``Lie down I would not,\footnote{Atll speaks.} nor sleep after, obstinate in my
fate—That I will execute!''

\xchapter{The Third Lay of Gudrun.}

Atli had a serving-woman named Herkia,\footnote{Herkia, the Erka or Helche of the German tradition, who
...
(II., p. 319) ascribes it to Sæmund himself.} who had been his concubine.
She informed Atli that she had seen Thiodrek and Gudrun together;
whereat Atli was much afflicted. Then Gudrun said:

\textbf{1.} What ails thee ever, Atli! Budli's son! Hast thou sorrow in thy
...
\textbf{2.} It grieves me, Gudrun! Giuki's daughter! that in my palace here,
Herkia has said, that thou and Thiodrek have under one covering slept,
and wantonly been in the linen wrapt.

\emph{Gudrun}.

\textbf{3.} For all this charge I will give my oaths by the white sacred
stone, that with me and Thiodrek nothing has passed, which to man and
wife only belongs;

\textbf{4.} Save that I embraced the prince of armies, the honoured king, a
single time. Other were our cogitations, when sorrowful we two sat to
converse.

\textbf{5.} Hither came Thiodrek, with thirty warriors; now there lives not
one of those thirty men. Surround me with thy brothers, and with
mailed warriors; surround me with all thy noblest kinsmen.

\textbf{6.} Send to Saxi the Southmen's prince; he can hallow the boiling
cauldron.''

\textbf{7.} Seven hundred men entered the hall, ere in the cauldron the queen
dipt her hand.

\textbf{8.} ``Now Gunnar comes not, nor call I Hogni: I shall not see again my
loved brothers: with his sword would Hogni such wrong avenge: now I
must myself purify from crime.''

\textbf{9.} She to the bottom, plunged her snow-white hand, and up she drew
the precious stones.\footnote{The iarknastein of the original was a milk-white opal.} ``See now, ye men! I am proved guiltless in
holy wise, boil the vessel as it may.''

\textbf{10.} Laughed then Atli's heart within his breast, when he unscathed
...
to a foul slough.\footnote{This punishment was known to the old Germans.} So were Gudrun's wrongs avenged.

\xchapter{Oddrun's Lament.}
...
\textbf{1.} I have heard tell, in ancient stories how a damsel came to the
eastern land: no one was able, on the face of earth, help to afford to
Heidrek's daughter.

\textbf{2.} When Oddrun, Atli's sister, heard that the damsel had great
pains, from the stall she led her well-bridled steed, and on the swart
one the saddle laid.

\textbf{3.} She the horse made run on the smooth, dusty way, until she came
...
\textbf{4.} ``What is most noteworthy in this country? or what most desirable
in the Hunnish land?''

\emph{Borgny}.

\textbf{5.} Here lies Borgny with pains overwhelmed, thy friend, Oddrun! See
if thou canst help her.

\emph{Oddrun}.

\textbf{6.} What chieftain has on thee brought this dishonour? Why so acute
are Borgny's pains?

\emph{Borgny}.

\textbf{7.} Vilmund is named the falcon-bearer's friend: he the damsel wrapt
in a warm coverlet five whole winters, so that from her father she was
hidden.

\textbf{8.} They, I ween, spoke not more than this: kindly she went to sit at
the damsel's knee. Vehemently sang Oddrun, fervently sang Oddrun songs
of power over Borgny.

\textbf{9.} A girl and boy might then tread the mould-way, gentle babes, born
of Hogni's bane. Then began to speak the death-sick damsel, who before
had no word uttered.

\textbf{10.} ``So may thee help the benignant genii, Frigg and Freyia, and
other gods besides, as thou hast from me peril removed!''

\textbf{11.} ``I was not inclined to give thee help, because thou never wast
...
\textbf{12.} Mad art thou, Oddrun! and hast lost thy wits, when in hostile
spirit most of thy words thou utterest; for I have been thy companion
upon the earth, as if from brothers we both were born.

\emph{Oddrun}.

\textbf{13.} I remember yet what thou one evening saidst, when I for Gunnar,
a compotation made. Such a case, saidst thou, would not thenceforth
happen, to any maiden, save to me alone.''

\textbf{14.} Then sat down the sorrowing lady to tell her woes, from her
great grief:

\textbf{15.} ``I was nurtured in the kingly hall, I was the joy of many in the
council of men. Life I enjoyed, and my father's wealth, five winters
only, while my father lived.

\textbf{16.} These last words the noble-hearted king strove to utter, ere he
departed hence.

\textbf{17.} He bade me be endowed with ruddy gold, and in the south be given
to Grimhild's son. He said no maiden could more excellent in the world
be born, if fate willed it not otherwise.

\textbf{18.} Brynhild in her bower was occupied in broidery: she had people
and lands around her. Earth slumbered, and the heavens above, when
Fafnir's bane her burgh first saw.

\textbf{19.} Then was conflict waged with the Walish sword, and the burgh
taken which Brynhild owned. It was not long—which was not
surprising—ere she discovered all those frauds.

\textbf{20.} These she caused cruelly to be avenged, so that we all have
great afflictions. Known it will be through every land of men, that
she caused herself to die with Sigurd.

\textbf{21.} But I for Gunnar, rings' dispenser, love conceived, such as
Brynhild should. But he Brynhild bade a helmet take, said she a
Valkyria should become.

\textbf{22.} They forthwith offered\footnote{For Brynhild's death.} ruddy rings to my brother, and
indemnity not small. He\footnote{Gunnar.} besides offered for me fifteen vills, and
the load of Grani's sides, if he would accept them.

\textbf{23.} But Atli said he never would a marriage-gift receive from
Giuki's son. Still we could not our loves withstand, but I my head
must lay upon the ring-breaker.

\textbf{24.} Many things said my relations; declared they had surprised us
...
\textbf{25.} Atli sent his emissaries about the Murkwood, that he might prove
me; and they came to where they ought not to have come, to where we
had one couch prepared.

\textbf{26.} To the men we offered red-gold rings, that they it might not to
Atli tell; but they forthwith hastened home, and it quickly to Atli
told.

\textbf{27.} But they from Gudrun carefully concealed it, yet rather by half
she should have known it.\footnote{From here the narrative appears to be very fragmentary.}

\textbf{28.} A sound was heard of gold-shod hoofs, when into the court rode
Giuki's heirs. * * * Of Hogni they the heart cut out, and into a
serpent-pen the other cast.

\textbf{29.} I had gone yet once again to Geirmund, to prepare a banquet. * *
* The brave king\footnote{Gunnar while in the serpent-pen.} began the harp to sound; for the prince of noble
race hoped that I to his aid might come.

\textbf{30.} I it heard from Hlesey, how of trouble there the harp-strings
sang.

\textbf{31.} I my thralls bade all be ready: I the prince's life would save.
The vessel we let float past the forest,\footnote{For ``lund'' (\emph{forest, wood}), which is the reading of the
MSS., the Copenhagen editor favors the correction to sund (a \emph{sound}
or \emph{strait, the Sound})?} until I saw all Atli's
courts.

\textbf{32.} Then came Atli's miserable mother crawling forth:—may she
perish!—she Gunnar pierced to the heart; so that the hero I could not
save.

\textbf{33.} Oftentimes I wonder, woman gold-adorned!\footnote{Borgny.} how I after can
life retain; for I seemed the formidable sword-dispenser as myself to
love:

\textbf{34.} Thou sitst and listenest, while I recount to thee many an evil
fate, my own and theirs.'' Each one lives as he best may. Now is ended
\emph{Oddrun's lament}.

\xchapter{The Lay of Atli.}
...
\textbf{1.} Atli sent riding a messenger to Gunnar, a crafty man, Knefrud was
his name. To Giuki's courts he came, and to Gunnar's hall, to the
seats of state,\footnote{The epithet aringreypr is applied both to benches and
helmets (see Strophes 3 and 16). Its meaning is doubtful: it has been
rendered \emph{iron-bound}, \emph{brass-bound}, \emph{hearth-encircling}, \emph{curved
...
the same.} and the glad potation:

\textbf{2.} There drank the courtiers wine in their Valhall—but the guileful
ones\footnote{The messengers of Atli.} silence kept—the Huns' wrath they\footnote{The Giukungs.} feared. Then said
Knefrud, with chilling voice:—the southern warrior on a high bench
sat—

\textbf{3.} ``Atli has sent me hither on his errand riding on a bit-griping
steed, through the unknown Murkwood, to pray you, Gunnar! that to his
bench ye come, with helms of state, Atli's home to visit.

\textbf{4.} ``Shields ye there can choose, and smooth-shaven spears, gold-red
helms, and of Huns a multitude, silver-gilt saddle-cloths, sarks
gory-red, the dart's obstruction, and bit-griping steeds.

\textbf{5.} ``The plain he will also give you, the broad Gnitaheid, whistling
javelins, and gilded prows, vast treasures, and Danp's towns, with
that famed forest, which men the Murkwood call.''

\textbf{6.} Gunnar his head then turned, and to Hogni said: ``What counselest
thou, bold warrior? now suchlike we hear? Of no gold I knew on Gnita's
heath, to which we possess not other equal.

\textbf{7.} ``Seven halls have we filled with swords, of each of which the
...
\textbf{8.} ``What thinkest thou the woman\footnote{Gudrun: she had sent, by Atli's messengers, a ring to
her brothers, as a warning, in which a wolf's hair was entwined,
together with a note in runes, which were falsified by Vingi.} means, by sending us a ring in
...
\textbf{14.} Atli's land they saw, and the high watch-towers; Bikki's people
...
\textbf{15.} Their sister forthwith saw, when the hall they had entered, her
...
\textbf{16.} ``Better hadst thou, Gunnar! in corslet come, than with helm of
...
\textbf{17.} ``Sister! 'tis now too late the Niflungs to assemble, long 'tis
to seek the aid of men, of valiant heroes, over the rugged fells of
Rhine.''

\textbf{18.} Then the Burgundians' friends\footnote{Atli's men.} Gunnar seized, in fetters
laid, and him fast bound.

\textbf{19.} Hogni hewed down seven, with the keen sword, but the eighth he
thrust into the raging fire. So should a valiant man defend himself
from foes.

\textbf{20.} Hogni had Gunnar's hands\footnote{That is Gunnar himself.} protected. The bold chief they
asked, if the Goths' lord would with gold his life redeem?

\textbf{21.} ``Hogni's heart in my hand shall lie, cut bloody from the breast
...
\textbf{23.} Then said Gunnar, lord of men: ``Here have I the heart of the
...
\textbf{24.} Hogni laughed, when to his heart they cut the living
crest-crasher; no lament uttered he. All bleeding on a dish they laid
it, and it to Gunnar bare.

\textbf{25.} Calmly said Gunnar, the warrior Niflung: ``Here have I the heart
...
\textbf{26.} ``So far shalt thou, Atli! be from the eyes of men as thou wilt
from the treasures be. In my power alone is all the hidden Niflungs'
gold, now that Hogni lives not.

\textbf{27.} ``Ever was I wavering, while we both lived; now am I so no
...
\textbf{28.} ``Drive your wheel-chariots, the captive is now in bonds.''

\textbf{29.} Atli the mighty, their sister's husband, rode with resounding
steeds, with strife-thorns\footnote{Spears.} surrounded. Gudrun perceived the
heroes' peril, she from tears refrained, on entering the hall of
tumult.

\textbf{30.} ``So be it with thee, Atli! as towards Gunnar thou hast held the
...
thence the more did the bit-shaker\footnote{The horse.} the treasure's guardian, the
warrior chief, drag to death.

\textbf{31.} The living prince then did a host of men into a pen cast down,
...
\textbf{32.} Atli turned his brass-shod\footnote{The original word is eyrskan, a word of doubtful
signification.} steed, his home to revisit, back
from the murder. Din was in the court with horses thronged, men's
weapon-song, from the heath they were come.

\textbf{33.} Out then went Gudrun, Atli to meet, with a golden cup to do her
duty to the king. ``Thou canst, O King! joyful in thy hall receive
from Gudrun the arms of the departed.''

\textbf{34.} The drinking-cups of Atli groaned with wine heavy, when in the
hall together the Huns were counted. Long-bearded, bold, the warriors
entered.

\textbf{35.} Hastened the bright-faced dame to bear their potions to them,
the wondrous lady to the chiefs; and reluctantly to the pallid Atli
the festal dainties offered, and uttered words of hate.

\textbf{36.} ``Thou, swords' dispenser! hast thy two sons' hearts,
...
\textbf{38.} Uproar was on the benches, portentous the cry of men, noise
...
\textbf{42.} To fire she then gave all that were therein, and from her
brothers' murder were from the dark den\footnote{The serpent-pen.} returned. The old
...
\textbf{43.} Of this enough is said. No such woman will henceforth arms again
...
\textbf{THE DEATH OF ATLI.}

(\emph{From a painting by S. Goldberg.})
...
\xchapter{The Groenland Lay of Atli.}

\textbf{1.} Of those misdeeds men have heard tell, when warriors of old a
...
\textbf{2.} The warriors' fate ripened, they were death-doomed: ill advised
...
\textbf{3.} Wise was the house-dame, prudently she thought; the words in
order she had heard, that in secret they had said: the sage lady was
at a loss: fain would she help them; they\footnote{The messengers.} o'er the sea must sail,
but she herself could not go.

\textbf{4.} Runes she graved, Vingi them falsified, before he gave them from
him; of ill he was the bearer. Then departed Atli's messengers,
through the branched firth, for where the bold warriors dwelt.

\textbf{5.} They with beer were cheered, and fires they kindled, naught
...
\textbf{6.} Then came Kostbera, she was Hogni's wife, a woman greatly
...
\textbf{7.} Hogni they home invited, if he would be pleased to go. Treachery
was manifest, had they but reflected! Gunnar then promised, if only
Hogni would, but Hogni refused what the other proposed.

\textbf{8.} The noble dames bore mead, of many things there was abundance,
many horns passed round, until it seemed they had full drunken.

\textbf{9.} The household prepared their couches, as to them seemed best.
...
\textbf{10.} To their bed they went, she and Hogni. The gentle lady dreamed,
and concealed it not, to the prince wisely said it as soon as she
awoke.

\textbf{11.} ``From home thou art going, Hogni! give ear to counsel; few are
fully prudent: go another time.

\textbf{12.} I have the runes interpreted, which thy sister graved: that fair
...
are the cause.''\footnote{It would seem that the original runes, as graved by
...
\textbf{13.} ``They are,'' said Hogni, ``all suspicious; I have no knowledge of
...
\textbf{14.} ``Tottering ye will go, if thitherward ye tend. No kind
...
\textbf{15.} ``Methought thy coverlet was with fire consumed; that the
towering flame rushed through my dwelling.''

\emph{Hogni}.

\textbf{16.} ``Here lie linen cloths, which thou hadst little noticed: these
will quickly burn where thou the coverlet sawest.''

\emph{Kostbera}.

\textbf{17.} ``Methought a bear came in, and broke down the columns; and so
...
\textbf{18.} ``A tempest there will be furious and sudden: the white bear thou
sawest will be a storm from the east.''

\emph{Kostbera}.

\textbf{19.} ``Methought an eagle flew herein, all through the house: that
will largely concern us. He sprinkled all with blood: from his threats
I thought it to be the 'ham'\footnote{Ham (hamr. \emph{fem.} hamingia) a guardian angel, an
attendant spirit.} of Atli.''

\emph{Hogni}.

\textbf{20.} ``We often slaughter largely, and then red we see: often are oxen
...
\textbf{21.} The high-born awoke, there the like befell: Glaumvor had
perceived that her dreams were ill-boding, adverse to Gunnar's going
to and fro.

\textbf{22.} ``Methought a gallows was for thee erected,\footnote{Here a gallows in our sense of the word, but usually a
stake on a scaffold, to which the condemned to a death of torture was
bound hand and foot.} thou wentest to
...
\textbf{23.} ``Methought a bloody glave from thy sark was drawn—ill 'tis such
a dream to a consort to recount—methought a lance was thrust through
thy middle: wolves howled on every side.''

\emph{Gunnar}.

\textbf{24.} ``Where dogs run they are wont to bark: oft bodes the bay of dogs
the flight of javelins.''

\emph{Glaumvor}.

\textbf{25.} ``Methought a river ran herein, through the whole house, that it
...
\textbf{29.} They went fair-appointed, until the firth them parted: ever
would their wives have stayed them, they would not be stayed.

\textbf{30.} Glaumvor then spake, Gunnar's consort, Vingi she addressed, as
...
\textbf{31.} Then Vingi swore, little spared he himself: ``May him the Jotuns
have, if towards you he lies! the gallows hold him, if aught against
peace he meditates!''

\textbf{32.} Bera took up the word, she of gentle soul: ``Sail ye prosperous,
and may success attend you: may it be as I pray, and if nothing
hinder!''

\textbf{33.} Hogni answered—he to his kin meant well—``Be of good cheer, ye
prudent! whatever may befall. Many say the same, though with great
difference; for many little care how they depart from home.''

\textbf{34.} On each other then they looked before they parted: then, I ween,
their fates were severed, and their ways divided.

\textbf{35.} Vigorously they rowed, their bark was well nigh riven; backward
...
they quitted it.\footnote{So great was their haste to land.}

\textbf{36.} A little after—I will the end relate—they saw the mansion
stand that Budli had possessed. Loud creaked the latticed gates, when
Hogni knocked.

\textbf{37.} Then said Vingi, what he had better not, ``Go far from the house,
...
\textbf{38.} Hogni answered—little thought he of yielding, or of aught
fearful that was to be proved:—``Think not to frighten us: try that
seldom. If one word thou addest, thou wilt thy harm prolong.''

\textbf{39.} They rushed on Vingi, and struck him dead, laid on their axes,
while life within him throbbed.

\textbf{40.} Atli his men assembled, in their byrnies they issued forth, went
...
\textbf{48.} Giuki's daughter caused two warriors to fall; Atli's brother she
...
\textbf{49.} A conflict then ensued, which was widely famed, but that
...
\textbf{50.} At morning most they fought, until mid-day had passed; all early
...
\textbf{51.} Then the fierce Atli spoke, wroth though he was: ``'Tis ill to
...
\textbf{52.} ``A great affinity I obtained, that I cannot deny, pernicious
...
\textbf{53.} ``This thou callest to mind, Atli! but thou so first didst act:
...
\textbf{57.} Beiti spake,—he was Atli's steward—Take we Hialli, but Hogni
let us save. Let us do half the work; he is death-worthy. As long as
he lives a slug he will ever be.

\textbf{58.} Terrified was the kettle-watcher, the place no longer held him:
...
\textbf{59.} Budli's cook they took, and the knife brought towards him.
...
\textbf{60.} Hogni all this observed—few so act, as for a slave to
...
\textbf{61.} Hands on the good prince they laid. Then was no option for the
...
\textbf{62.} A harp Gunnar took, with his foot-branches touched it. He could
...
\textbf{63.} There died the noble, as the dawn of day; at the last they
caused their deeds to live.

\textbf{64.} Atli thought himself great: over them both he strode, to the
...
\textbf{65.} Joyful art thou, Atli! slaughter to announce: repentance shall
...
\textbf{66.} That I can prevent; another course I see, easier by half: the
...
\textbf{67.} Of that there is \emph{no} hope; I will all reject; atonement I have
...
\textbf{68.} We were both nurtured in one house; many a play we played, and
...
\textbf{69.} Men's too great power women's lot oppresses; on the knee the
...
\textbf{70.} Most unwise it was, when to this the prince gave credit: the
...
with two shields she played.\footnote{She played a double game.}

\textbf{71.} A banquet she would prepare, her brothers' funeral feast; the
same would Atli also for his own do.

\textbf{72.} With this they ended; the banquet was prepared; the feasting was
too luxurious. The woman great of heart was stern, she warred on
Budli's race; on her spouse she would cruel vengeance wreak.

\textbf{73.} The young ones she enticed, and on a block laid them, the fierce
babes were terrified, and wept not, to their mother's bosom crept,
asked what she was going to do.

\textbf{74.} ``Ask no questions, both I intend to kill; long have I desired to
cut short your days.''

\textbf{75.} ``Slay as thou wilt thy children, no one hinders it; thy rage
...
\textbf{76.} Atli oft inquired whither his boys were gone to play, as he
nowhere saw them?

\emph{Gudrun.}

\textbf{77.} Over I am resolved to go, and to Atli tell it. Grimhild's
...
\textbf{78.} Very seldom have I slept since they fell. Bitterly I threatened
...
\textbf{79.} Thou thy sons hast lost, as thou least shouldest; know that
their skulls thou hast had for beer-cups; thy drink I prepared, I
their red blood have shed.

\textbf{80.} I their hearts took, and on a spit staked them, then to thee
...
\textbf{81.} Thy children's fate thou knowest, few a worse awaits. I have my
part performed, though in it glory not.

\emph{Atli.}

\textbf{82.} Cruel wast thou, Gudrun! who couldst so act, with thy children's
...
\textbf{83.} I could still desire thyself to slay; rarely too ill it fares
...
\textbf{96.} Now, Atli! thou liest, though of that I little reck. Gentle I
...
\textbf{97.} Brothers and sisters we were three, we thought ourselves
...
\textbf{98.} The chief king we slew, there a land obtained, the ``hersar''
...
\textbf{99.} The Hun king\footnote{Sigurd.} died, then suddenly my fortune changed: great
...
\textbf{100.} Thou didst never from a contest come, as we had heard, where
...
\textbf{101.} Gudrun! now thou liest. Little will be bettered the lot of
either: we have all suffered. Now act thou, Gudrun! of thy goodness,
and for our honour, when I forth am borne.

\emph{Gudrun.}

\textbf{102.} I a ship will buy, and a painted cist;\footnote{The ancient usage of laying the body in a ship and
sending it adrift, seems inconsistent with the later custom of
depositing it in a cist or coffin.} will the
winding-sheet well wax, to enwrap thy corpse; will think of every
requisite, as if we had each other loved.

\textbf{103.} Atli was now a corpse, lament from his kin arose: the
...
\textbf{1.} Then heard I tell of quarrels dire, hard sayings uttered from
great affliction, when her sons the fierce-hearted Gudrun, in deadly
words, to slaughter instigated.

\textbf{2.} ``Why sit ye here? why sleep life away? why does it pain you not
...
\textbf{3.} Ye are not like to Gunnar and the others, nor of soul so valiant
as Hogni was. Her ye should seek to avenge, if ye had the courage of
my brothers, or the fierce spirit of the Hunnish kings.''

\textbf{4.} Then said Hamdir, the great of heart: ``Little didst thou care
Hogni's deed to praise, when Sigurd he from sleep awaked. Thy
blue-white bed-clothes were red with thy husband's gore, with
death-blood covered.

\textbf{5.} ``For thy brothers thou didst o'er-hasty vengeance take, dire and
bitter, when thou thy sons didst murder. We young ones\footnote{Themselves and the two sons of Atli.} could on
Jormunrek, acting all together, have avenged our sister.

\textbf{6.} ``Bring forth the arms of the Hunnish kings: thou hast us
stimulated to a sword-mote.''

\textbf{7.} Laughing Gudrun to the storehouse turned, the kings' crested
helms from the coffers drew, their ample corslets, and to her sons
them bore. The young heroes loaded their horses' shoulders.

\textbf{8.} Then said Hamdir, the great of heart: ``So will no more come his
...
\textbf{15.} ``But around Svanhild bond-maidens sat; of all my children her I
loved the best. Svanhild was, in my hall, as was the sun-beam, fair to
behold.

\textbf{16.} ``I with gold adorned her, and with fine raiment, before I gave
...
\textbf{17.} ``But that was yet more painful, when my Sigurd they ingloriously
...
\textbf{18.} ``Many griefs I call to memory, many ills I call to memory.
...
\textbf{19.} ``Remember, Sigurd! what we together said, when on our bed we
both were sitting, that thou, brave one, wouldst come to me from Hel's
abode, but I from the world to thee.

\textbf{20.} ``Raise, ye Jarls! an oaken pile; let it under heaven the highest
be. May it burn a breast full of woes! the fire round my heart its
sorrows melt!''

\textbf{21.} May all men's lot be bettered, all women's sorrow lessened, to
whom this tale of woes shall be recounted.

\xchapter{The Lay of Hamdir.}

\textbf{1.} In that court\footnote{See Str. 10, and Ghv. 9, and. Luning, Glossar.} arose woeful deeds, at the Alfar's doleful
lament;\footnote{``The Alfar's Lament'' is the early dawn, and is in
...
strophe.} at early morn, men's afflictions, troubles of various
kinds; sorrows were quickened.

\textbf{2.} It was not now, nor yesterday, a long time since has passed
...
\textbf{3.} ``She was your sister, her name Svanhild, she whom Jormunrek with
horses trod to death, white and black, on the public way, with grey
and way-wont Gothic steeds.

\textbf{4.} ``Thenceforth all is sad to you, kings of people! Ye alone
survive,

\textbf{5.} ``Branches of my race. Lonely I am become, as the asp-tree in the
...
\textbf{9.} Then said Sorli—he had a prudent mind—``I with my mother will
...
\textbf{10.} ``For thy brothers weep, and thy dear sons, thy nearest kin,
drawn to the strife: for us both shalt thou, Gudrun! also have to
weep, who here sit fated on our steeds, far away to die.''

\textbf{11.} From the court they went, for conflict ready. The young men
journeyed over humid fells, on Hunnish steeds, murder to avenge.

\textbf{12.} Then said Erp, all at once—the noble youth was joking on his
horse's back—``Ill 'tis to a timid man to point out the ways.'' They
said the bastard\footnote{In this and the four following strophes the person
alluded to is their half-brother Erp, of whose story nothing more is
known. He, it appears, had preceded or outridden the others.} was over bold.

\textbf{13.} On their way they had found the wily jester. ``How will the
swarthy dwarf afford us aid?''

\textbf{14.} He of another mother answered: so he said aid he would to his
kin afford, as one foot to the other\footnote{Malmesbury relates a similar story of King Æthelstan
and his cupbearer.} [or, grown to the body, one
hand the other].

\textbf{15.} ``What can a foot to a foot give; or, grown to the body, one hand
the other?''

\textbf{16.} From the sheath they drew the iron blade, the falchion's edges,
for Hel's delight. They their strength diminished by a third part,
they their young kinsman caused to earth to sink.

\textbf{17.} Their mantles then they shook, their weapons grasped; the
high-born were clad in sumptuous raiment.

\textbf{18.} Forward lay the ways, a woeful path they found, and their
sister's son wounded on a gibbet, wind-cold outlaw-trees,\footnote{Lit. wolf-trees; a fugitive criminal being called vargr
\emph{wolf}.} on the
town's west. Ever vibrated the ravens' whet: there to tarry was not
good.

\textbf{19.} Uproar was in the hall, men were with drink excited, so that the
horses' tramp no one heard, until a mindful man winded his horn.

\textbf{20.} To announce they went to Jormunrek that were seen helm-decked
warriors. ``Take ye counsel, potent ones are come; before mighty men ye
have on a damsel trampled.''

\textbf{21.} Then laughed Jormunrek, with his hand stroked his beard, asked
...
\textbf{22.} ``Happy should I seem, if I could see Hamdir and Sorli within my
hall. I would them then with bowstrings bind, the good sons of Giuki
on the gallows hang.''

\textbf{23.} Then said Hrodrglod, on the high steps standing; ``Prince'' said
...
\textbf{24.} Tumult was in the mansion, the beer-cups flew in shivers, men
lay in blood from the Goths' breasts flowing.

\textbf{25.} Then said Hamdir, the great of heart: ``Jormunrek! thou didst
desire our coming, brothers of one mother, into thy burgh:\footnote{According to the Skalda it would appear that they cut
off his hands and feet while he was asleep. Erp, had they not murdered
him, was to have cut off his head.} now
seest thou thy feet, seest thy hands Jormunrek! cast into the glowing
fire.''

\textbf{26.} Then roared forth a godlike\footnote{Odin, as in the battle of Bravalla.} mail-clad warrior, as a bear
roars: ``On the men hurl stones, since spears bite not, nor edge of
sword, nor point, the sons of Jonakr.''

\textbf{27.} Then said Hamdir, the great of heart: ``Harm didst thou, brother!
when thou that mouth didst ope. Oft from that mouth bad counsel
comes.''

\textbf{28.} ``Courage hast thou, Hamdir! if only thou hadst sense: that man
lacks much who wisdom lacks.

\textbf{29.} ``Off would the head now be, had but Erp lived, our brother bold
...
\textbf{30.} ``I ween not that ours should be the wolves' example, that with
ourselves we should contend, like the Norns' dogs, that voracious are
in the desert nurtured.''

\textbf{31.} ``Well have we fought, on slaughtered Goths we stand, on those
...
\textbf{33.} There fell Sorli, at the mansion's front; but Hamdir sank at the
house's back.

This is called the Old Lay of Hamdir.

\xchapter{The Younger Eddas of Sturleson.}

\xsubsection{THE DELUDING OF GYLFI.}

\xsubsection{GEFJON'S PLOUGHING.}

\footnote{This chapter is probably the interpolation of an early
...
\textbf{1.} King Gylfi ruled over the land which is now called Svithiod
...
\xsubsection{GYLFI'S JOURNEY TO ASGARD.}

\textbf{2.} King Gylfi was renowned for his wisdom and skill in magic. He
...
is Jafnhar (\emph{i.e}. equal to the High); but he who sitteth on the
...
\xsubsection{OF THE SUPREME DEITY.}

\textbf{3.} Gangler thus began his discourse:—``'Who is the first, or eldest
of the gods?''
...
``He was then,'' replied Har, ``with the Hrimthursar.''\footnote{Rime Giants, or Giants of the Frost.}

\xsubsection{OF THE PRIMORDIAL STATE OF THE UNIVERSE.}

\textbf{4.} ``But with what did he begin, or what was the beginning of
...
and glowing to be entered by those who are not indigenous there.\footnote{Literally, ``It is light and hot, insomuch so that it is
...
\xsubsection{ORIGIN OF THE HRIMTHURSAR, OR FROST-GIANTS.}

\textbf{5.} ``Tell me,'' said Gangler, ``what was the state of things ere the
...
\xsubsection{OF THE COW AUDHUMLA, AND THE BIRTH OF ODIN.}

\textbf{6.} ``Where dwelt Ymir, and on what did he live?'' asked Gangler.
...
\xsubsection{HOW THE SONS OF BOR SLEW YMIR AND FROM HIS BODY MADE HEAVEN AND EARTH.}

\textbf{7.} ``Was there,'' asked Gangler, ``any kind of equality or any degree
...
\textbf{8.} ``And what became of the sons of Bor, whom ye look upon as gods?''
asked Gangler.
...
Midgard\footnote{More properly speaking, to the earth which it
encircled.} They afterwards tossed Ymir's brains into the air, and
...
\xsubsection{OF THE FORMATION OF THE FIRST MAN AND WOMAN.}

\textbf{9.} ``To make heaven and earth, to fix the sun and the moon in the
...
\xsubsection{OF NIGHT AND DAY.}

\textbf{10.} ``A giant called Njorvi,'' continued Har, ``who dwelt in Jotunheim,
...
\xsubsection{OF THE SUN AND MOON.}

\textbf{11.} ``How doth All-father regulate the course of the sun and moon?''
asked Gangler.
...
\emph{isarnkul}.\footnote{A ferreous or glacial refrigeration.} Mani was set to guide the moon in his course, and
...
\xsubsection{OF THE WOLVES THAT PURSUE THE SUN AND MOON}

\textbf{12.} ``But the sun,'' said Gangler, speeds at such a rate as if she
...
\xsubsection{OF THE WAY THAT LEADS TO HEAVEN.}

\textbf{13.} ``I must now ask,'' said Gangler, ``which is the path leading from
earth to heaven?''
...
\xsubsection{THE GOLDEN AGE.}

\textbf{14.} ``What did All-father do after Asgard was made?'' demanded
Gangler.
...
\xsubsection{ORIGIN OF THE DWARFS.}

\textbf{15.} ``Then the gods, seating themselves upon their thrones,
...
\xsubsection{OF THE ASH YGGDRASILL, MIMIR'S WELL., AND THE NORNS OR DESTINIES.}

\textbf{16.} ``Where,'' asked Gangler, ``is the chief or holiest seat of
the gods?''
...
boiling hot would become the holy waters.''\footnote{\emph{i.e.} If Thor drove over Bifrost with his thunder
chariot.} ``But tell me,'' said
...
Verdandi, and Skuld.\footnote{\emph{i.e.} Present, Past, and Future.} These maidens fix the lifetime of all men,
...
\textbf{17.} ``What more wonders hast thou to tell me,'' said Gangler,
``concerning the ash?''
...
\xsubsection{OF THE VARIOUS CELESTIAL REGIONS.}

\textbf{18.} ``Thou tellest me many wonderful things of heaven,'' said Gangler,
...
\xsubsection{OF THE WIND AND THE SEASONS.}

\textbf{19.} ``Tell me,'' said Gangler, ``whence comes the wind, which is so
...
\textbf{20.} ``Tell me further,'' said Gangler, ``why the summer should be hot,
and the winter cold.''
...
\textbf{21.} ``I must now ask thee,'' said Gangler, ``who are the gods that men
...
\textbf{22.} ``I now ask thee,'' said Gangler, ``what are the names of the other
...
\xsubsection{OF BALDUR.}

\textbf{23.} ``I would rather,'' said Gangler, ``hear something about the other
Æsir.''
...
\xsubsection{OF NJORD.}

\textbf{24.} ``The third god,'' continued Har, ``is Njord, who dwells in the
...
\xsubsection{OF THE GOD FREY, AND THE GODDESS FREYJA.}

\textbf{25.} ``Njord had afterwards, at his residence at Noatun, two children,
...
\textbf{26.} ``All the gods appear to me,'' said Gangler, ``to have great power,
...
surpasses all others in valour that he is \emph{Tyr-strong}, or valiant as
...
\xsubsection{OF THE OTHER GODS.}

\textbf{27.} ``There is another god,'' continued Har, ``named Bragi, who is
...
but the art itself is called from his name \emph{Bragr}, which epithet is
...
\textbf{28.} ``One of them is Heimdall, called also the White God. He is the
...
\xsubsection{HODUR THE BLIND, ASSASSIN OF BALDUR}

\textbf{29.} ``Among the Æsir,'' continued Har, ``we also reckon Hodur, who is
...
cause to remember the deed perpetrated by his hand.\footnote{Namely, his having killed Baldur.}

\textbf{30.} ``Another god is Vidar, surnamed the Silent, who wears very thick
shoes. He is almost as strong as Thor himself, and the gods place
great reliance on him in all critical conjunctures.

\textbf{31.} ``Vali, another god, is the son of Odin and Rinda, he is bold in
war, and an excellent archer.

\textbf{32.} ``Another is called Ullur, who is the son of Sif, and stepson of
...
\textbf{33.} ``The name of another god is Forseti, who is the son of Baldur
...
\xsubsection{OF LOKI AND HIS PROGENY.}

\textbf{34.} ``There is another deity,'' continued Har, ``reckoned in the number
...
\textbf{35.} ``Loki,'' continued Har, ``has likewise had three children by
...
\xsubsection{BINDING THE WOLF FENIR}
...
\xsubsection{OF THE GODDESSES.}

\textbf{36.} ``Tell me now,'' said Gangler, ``which are the goddesses?''
...
(\emph{hnosir}.) But Odur left his wife in order to travel into very remote
...
hence a wooer is called, from her name, \emph{Sjafni}. The eighth, called
...
\textbf{37.} ``There are besides these a great many other goddesses, whose
...
\xsubsection{OF FREY AND GERDA.}

\textbf{38.} ``There was a man,'' continued Har, ``named Gymir, who had for wife
...
\xsubsection{OF THE JOYS OF VALHALLA.}

\textbf{39.} ``If it be as thou hast told me,'' said Gangler, ``that all men who
...
Munin.\footnote{Mind or Thought, and Memory.} He sends them out at dawn of day to fly over the whole
...
\textbf{40.} ``What have the heroes to drink,'' said Gangler, ``in sufficient
...
\textbf{41.} ``Wondrous things are these which thou tellest me of,'' said
...
\textbf{42.} ``A mighty band of men must be in Valhalla,'' said Gangler, ``and
...
\xsubsection{OF THE HORSE SLEIPNIR.}

\textbf{43.} ``Thou mad'st mention,'' said Gangler, ``of the horse Sleipnir. To
...
\xsubsection{OF THE SHIP SKIDBLADNIR.}

\textbf{44.} ``What hast thou to say,'' demanded Gangler, ``of Skidbladnir,
...
\xsubsection{THOR'S ADVENTURES ON HIS JOURNEY TO THE LAND OF THE GIANTS.}

\textbf{45.} ``But tell me,'' he (Gangler) continued, ``did it ever happen to
...
\textbf{46.} ``One day the God Thor set out in his car drawn by two he-goats,
...
\textbf{47.} ``Thor and his companions proceeded on their way, and towards
...
the bench, and whose name was Logi,\footnote{\emph{i.e.} Devouring flame.} to come forward and try his
...
on, and calling a young man named Hugi,\footnote{\emph{i.e.} Spirit or thought.} bade him run a match with
...
\textbf{50.} ``Utgard-Loki then asked Thor in what feats he would choose to
...
\textbf{51.} ``'I now see plainly,' said Utgard-Loki, 'that thou are not quite
...
let somebody, however, call hither that old crone, my nurse Elli,\footnote{\emph{i.e.} Eld or Old Age.}
...
\textbf{53.} ``A toothless old woman then entered the hall, and was told by
...
\textbf{54.} ``The next morning, at break of day, Thor and his companions
...
\textbf{55.} ``'Nay,' said Utgard-Loki, 'it behooves me to tell thee the truth
...
\xsubsection{HOW THOR WENT TO FISH FOR THE MIDGARD SERPENT.}

\textbf{56.} ``I find by your account,'' said Gangler, ``that Utgard-Loki
...
\xsubsection{THE DEATH OF BALDUR THE GOOD.}

\textbf{57}. ``Verily,'' said Gangler, ``it was a famous exploit which Thor
...
\textbf{58.} ``Hodur then took the mistletoe, and under the guidance of Loki,
...
\textbf{59.} ``The Æsir then took the dead body and bore it to the seashore,
...
\xsubsection{BALDUR IN THE ABODE OF THE DEAD}

\textbf{60.} ``Meanwhile, Hermod was proceeding on his mission. For the space
...
\xsubsection{THE FLIGHT AND PUNISHMENT OF LOKI.}

\textbf{61.} ``Evil are the deeds of Loki truly,'' said Gangler; ``first of all
...
\xsubsection{OF RAGNAROK, OR THE TWILIGHT OE THE GODS, AND THE CONFLAGRATION OF THE UNIVERSE.}

\textbf{63.} ``I have not heard before of Ragnarok,'' said Gangler; ``what hast
...
\textbf{64.} ``Then shall happen such things as may truly be accounted great
...
\textbf{65.} ``Meanwhile Heimdall stands up, and with all his force sounds the
...
\xsubsection{OF THE ABODES OF FUTURE BLISS AND MISERY.}

\textbf{66.} ``What will remain,'' said Gangler, ``after heaven and earth and
...
\xsubsection{THE RENOVATION OF THE UNIVERSE.}

\textbf{67.} ``Will any of the gods survive, and will there be any longer a
...
\xsubsection{ÆGIR'S JOURNEY TO ASGARD.}

\textbf{68.} Ægir, who was well skilled in magic, once went to Asgard, where
...
\xsubsection{IDUNA AND HER APPLES.}

\textbf{69.} ``Once,'' he said, ``when Odin, Loki, and Hoenir went on a journey,
...
\textbf{70.} ``On his return to Asgard, Loki told Iduna that, in a forest at a
...
the firmament.\footnote{Finn Magnusen's explanation of this myth is, that
...
\xsubsection{THE ORIGIN OF POETRY.}

\textbf{71.} Ægir having expressed a wish to know how poetry originated,
...
\xsubsection{ODIN BEGUILES THE DAUGHTER OF BAUGI}

\textbf{72.} Æsir then asked how the gods obtained possession of so valuable
...
ANDHRIMNIR, soul, spirit, breath: from hrim, congealed vapour, \emph{rime}.
...
BALEYGR, Bale-eyed, \emph{i.e.} endowed with a clear, piercing vision.
...
BERGELMIR, Mountain-old, \emph{i.e.} the old man of the mountain.
...
term; or storm-stilling, \emph{i.e.} imparting serenity to the tempest.
...
BOR, prop. BORR, and BUR, prop. BURR or BURI, means \emph{born}, to bear;
whence also the \emph{Old G.} barn, and the \emph{Scotch, bairn}, a child.

BRAGI, the name of the God of Poetry; from braga, to glisten, to
shine, or from bragga, to adorn; ph. cog. with \emph{G}. pracht, splendour.
...
BYRGIR, prob. from v. byrgja, to conceal; \emph{E.} to bury, whence barrow,
a tumulus.

DAINN, prob. the Soporiferous; from da, a swoon, or complete repose.

DELLINGR—a \emph{day-ling}. with the dawn, daybreak.
...
the \emph{E.} to doze, and ph. also dusk.
...
\emph{E.E.} are merely \emph{conjectural}. Grimm says the word embla, emla,
...
hall, mansion, saloon. \emph{See} Valhalla.

FIMBUL. From fimbulfambi comes the \emph{E.} provincialism, to
fimble-famble; and the \emph{D.} famle, to stammer, to hesitate in
speaking.
...
\emph{G.} berg, a mountain.

FOLKVANGR, lit. the folk's field, or habitation.

FORSETI, lit. the Fore-seated, \emph{i.e.} the Judge.

FRANANGURS-FORS, prob. from frann, glittering, and ongr, narrow.

FREKI, \emph{G.} frech, froward: the word has also the sig. of voracious.
...
may have been fire, but afterwards a gem, as in the \emph{N.} word
...
GLÆR, from glær, clear, pellucid; cog. with \emph{E.} glare.
...
GOD. The \emph{Old N.} lang. has two words for God, viz. God and Gud; and
...
GRAFVITNIR, from the v. grafa, to dig, to delve; cog. with \emph{E.} grave:
and the v. vita, to know; \emph{to} wit, wist, wot.
...
cavity, a fosse. From gunnr is derived the \emph{N.} gunn-fani, a
war-banner.

GYLLIR, from gull, gold.

HABROK. The E.E. render this word by \emph{Altipes}, from bar, high; and
...
HAR, prop. HARR, may mean either \emph{high} or \emph{hairy}. As a designation
...
HERFJOTUR, lit. Host's-fetter, \emph{i.e.} having the power to impede or
constrain an army at will: her, an army, a host, a multitude.

HERJANN, the leader of an army; from her.

HERMOD, prop. HERMODR: her from her, courage, (\emph{see} Modgudur).
...
HLINA, prop. HLIN, the \emph{support} on which a person leans, \emph{i.e.} a
tutelary deity.

HLJODALFR, the Genius or Elf of Sound.

HLODYN, the name of Frigga, as the symbol of the earth; \emph{protectress
...
thrust forward, to take by violence; to repel, to impede. \emph{G.} m. Nix,
...
Majesty, as \emph{Old Nick} appears to be a mere corruption of these
...
HRÆSVELGUR, lit. Raw-swallower, \emph{i.e.} swallowing raw flesh like an
eagle.

HRAFNAGUD, the Ravens' god; brafn; \emph{G.} rabe; \emph{E.} raven.

HRIMFAXI: brim, rime, or hoar frost; fax, a crest, a mane. The \emph{E.}
...
JAFNHAR. \emph{The Equally High}; lit. even so high.
...
KJALARR, prob. from v. kjala, to transport, to convey; a ship, \emph{a
keel}.

KVASIR. This word seems to be used in the sense of a \emph{drinking bout.}
...
LODURR, LODR, LOTHR, from the ob. \emph{N.} lod, fire.
...
LOKI, to shut; whence the \emph{E.} to lock, to finish.

LOPTUR, the Aerial, the Sublime; the air; whence the \emph{E.} lofty and
...
MIDGARD, middleweard, the middleward; \emph{see} Asgard. Middling, mean.
...
grind; \emph{E.} mill, and prob. with \emph{L.} malleus, a mallet.

MODGUDUR, a valiant female warrior, \emph{animosa bellona}: courage; mind;
\emph{E.} mood; gracefulness, delectation.

MODSOGNIR, lit. sucking in courage or vigour.

MOINN, dwelling on a moor.

MUNINN, mind; \emph{memory}, recollection; \emph{G.} minne, love.
...
NAL. \emph{G.} nadel; \emph{A.S.} nædl; \emph{E.} a needle.
...
NIFLHEL, from nifi and hel. \emph{See} the latter word.

NIFLUNGAR, the mythic-heroic ghosts of the shadowy realms of death.

NIPINGR, handsome; to contract, to curve.

NJORD, prop. NJORDR, humid; \emph{Sk.} nar, nir, water; a wave; and
Neriman, an aquatic man.

NOTT; \emph{D.} nat; \emph{M.G.} naht; \emph{G.} nacht; \emph{A.S.} niht; \emph{E.} night.

NYI, these dwarfs were symbolical of the new and the waning moon.

ODIN. \emph{E.} to \emph{wade} through, consequently the Omnipotent Being that
\emph{permeates all things}.
...
OFNIR, \emph{E.} to weave. The word would thus sig. the textile or creating
power of Odin.
...
ONDURDIS, Snow skates; \emph{E.} to wander; dis, a nymph, a goddess.
...
RAGNAROKR. The n. ragin signified \emph{rath}, council, the pl. of which,
regin, Is used in the Eddaic Poems for the gods; that is to say, the
consulting, deliberating deities. It answers in fact fully to the \emph{E.}
word \emph{rack}, Indicating atmospheric nebulosity; hence Ragnarok is very
...
derived from \emph{G.} tasche, a pocket or pouch; hence the Permeating
Pouch?

REGIN, Is often used In the sense of vast, immense; the vast sea.

REGINLEIF, dear to the gods, \emph{see} Regin.
...
\emph{G.} sage; \emph{E.} a saying; \emph{L.} Saga, a sorceress; sagax, saga-clous,
to foretell.

SANNGETALL, inquiring after; guessing at truth.

SESSRUMNIR, lit. Seat-roomy, \emph{i.e.} having room for plenty of seats.

SID, declining, hanging, tending downward.

SIDHOTTR, lit. Hanging-hat or hood.

SIDSKEGGR, lit. Hanging-beard; \emph{E.} shag and shaggy.

SIF, signifying peace, friendship, relationship, a goddess, Sibja,
Sippia, and Sib.

SIGFADIR, or SIGFODUR, the Father of Victory; \emph{L.} pater.

SILFRINTOPPR, Silver-mane; \emph{E.} silver: toppr, \emph{see} Gulltoppr.
...
SKIDBLADNIR, lath, shingle, billet of wood, a sheath; \emph{E.} blade, a
blade or \emph{leaf} of grass.
...
SVIPALL, to hasten, to vibrate; to wave, to hover; also with \emph{E.} v.
to sweep.
...
THRYM. F. Mag. says the word is \emph{undoubtedly} derived from thruma,
thunder.
...
TYR, signifying God; as well as the \emph{L.} Jupiter, for which he assumes
...
UTGARD, prop. UTGARDR, lit. Outer-ward. \emph{See} Midgard.
...
VANADIS, prop, a Goddess of the Vanir. \emph{See} that word, and \emph{Dis}.

VANIR, beautiful; with the \emph{L.} venustus and Venus, and ph. with the
\emph{E. wench}.

VASADR, from vas, moisture, a word cog. with the \emph{E.} wet and wash.
