% St. Thomas Aquinas, Summa Theologica -- The Second Part of the Second Part. The Benziger
...
\urlstyle{same}
\hypersetup{pdftitle={Summa Theologica -- The Second Part of the Second Part},pdfauthor={St. Thomas Aquinas}}
\linespread{1.06}
...
\vspace{1.5em}
{\Large\color{subhead} The Second Part of the Second Part\par}
\vspace{2.5em}
