\xchapter{On the Inspiration of Scripture}

[from \emph{The
Nineteenth Century}, Vol. 15, No. 84, Feb. 1884.]

1. It has lately been asked what answer do
...
then, a doubting Anglican contemplate becoming Catholic by way
...
Apostolic, unerring Truth, is obligatory on our faith, that is, \emph{de
fide}?

5. Many truths may be predicated about Scripture
and its contents which are not obligatory on our faith, viz., such as
are private conclusions from premises, or are the \emph{dicta} of
...
are not the subjects of \emph{ex cathedrâ} utterances of the Church.
...
granted to us about them, or is likely to be granted. We are not
...
faith what is not a dogma, or the equivalent of dogma (\emph{vide infra},
section 17), what is not \emph{de fide}; such judgments, however high
...
likely to be brought to such belief by studying it merely on its
secular side.
...
his firm inward assent to the dogmas of the Church, that is, to the \emph{de
...
viz., 'Deus \emph{unus et idem} utriusque Testamanti Auctor.' Since
...
date of Irenæus, and as St. Paul uses the word, in his Epistle to the
Hebrews, the Vatican Council has expressly defined that the concrete \emph{libri}
...
disciple who testifies of these things, and has \emph{written} these
things,' and St. Luke says 'I have thought it good to \emph{write} to
thee' \&c. However, if any one prefers to construe 'auctor' as
'author,' or writer, let it be so—only, then there will be two
writers of the Scriptures, the divine and the human.

11. And now comes the important question, in what
respect are the Canonical books inspired? It cannot be in every
respect, unless we are bound \emph{de fide} to believe that 'terra in
æternum stat,' and that heaven is above us, and that there are no
...
teaching. It declares that the 'Gospel' is 'the Fount of all \emph{saving
truth} and all \emph{instruction in morals},' that in the written
books and in the unwritten traditions, the Holy Spirit dictating, this
\emph{truth} and \emph{instruction} are contained. Then it speaks of
the books and traditions, 'relating whether to \emph{faith} or to \emph{morals},'
and afterwards of 'the confirmation of \emph{dogmas} and establishment
of \emph{morals}.' Lastly, it warns the Christian people, 'in matters
of \emph{faith} and \emph{morals},' against distorting Scripture into
a sense of their own.

In like manner the Vatican Council pronounces
that Supernatural Revelation consists '\emph{in rebus divinis},' and
is \emph{contained} 'in libris scriptis et sine scripto traditionibus;'
and it also speaks of 'petulantia ingenia' advancing wrong
interpretations of Scripture 'in rebus \emph{fidei} et \emph{morum} ad
ædificationem \emph{doctrinæ} Christianæ pertinentium.'
...
analogical applications, of universal history, and on the other
...
fulness to be accepted \emph{de fide} as true. In this point of view,
...
formally and what occurs \emph{obiter}, what is only of temporary and
...
that Interpreter is defined in the following words:—

First by the Council of Trent: 'Nemo suâ
prudentiâ innixus, in rebus fidei et morum ad ædificationem doctrinæ
Christianæ pertinentium, Sacram Scripturam ad suos sensus contorquens,
...
Secondly by the Council of the Vatican: 'Nos,
idem Decretum [Tridentinum] renovantes, hanc illius mentem esse
declaramus, ut in rebus fidei et morum ad ædificationem doctrinæ
Christianæ pertinentiuin, is pro vero sensu Sacræ Scripturæ
habendus sit, quem tenuit et tenet Sancta Mater Ecclesia, cujus est
...
the faith, or the \emph{pietas fidei}, nothing of contempt or
...
'Fide divinâ et Catholicâ ea omnia credenda sunt, quæ in verbo Dei
scripto vel tradito continentur, vel ab Ecclesiâ sive solemni judicio,
sive \emph{ordinario} et \emph{universali magisterio}, tanquam
...
determined of the Fathers, the practical rule of duty is
...
anathema sit'). Of course the Vatican decision is \emph{de fide}, but
...
asked him whence was to come the victim for the sacrifice which
...
21. Nor is it \emph{de fide} (for that alone with
...
in the words of the \emph{Miserere}, could he, possibly, while
...
imply that inspiration allowed them to state what is doubtful as
...
4), does so in order to \emph{boast} that his 'speech was, not in the
...
inquiry, 'according as they delivered them to us, who from the
...
Esdras. A learned writer in a publication of the day \footnote{This representation must not be confused with either of the two views
...
first to last under the action of that inspiration.} says: 'It consists of the contemporary historical journals,
...
Editor \footnote{This representation must not be confused with either of the two views
of canonicity which are pronounced insufficient by the Vatican
Council—viz. 1, that in order to be sacred and canonical, it is
enough for a book to be a work of mere human industry, provided it be
afterwards approved by the authorities of the Church; and 2, that it
...
writer or the writing; what is contemplated above is an inspired
writer in the exercise of his inspiration, and a work inspired from
first to last under the action of that inspiration.}; that is, an inspired mind, authoritative in faith and morals, from whose fingers
...
of Moses,' yet that has not hindered a succession of Catholic
writers, from Athanasius to Bellarmine, from denying it to be his.

Again, the Book of Wisdom professes (\emph{e.g}.,
chs. vii. and ix.) to be written by Solomon; yet our Bibles say, 'It
is written in the \emph{person} of Solomon,' and 'it is uncertain who
...
doubt they do not belong to him.' (Martin. \emph{Pref. to Wisdom and Eccl}.;
Aug. \emph{Opp}. t. iii. p. 733.)
...
be true that He has written it.''' (\emph{Loc. Th}. p. 44.)
...
26. And here I am led on to inquire whether \emph{obiter
...
common opinion is that they are not. Professor Lamy thus writes
...
Tobias, St. Paul's \emph{penula}, and the salutations at the end of
the Epistles.' Neither he nor Fr. Patrizi allow of these exceptions;
but Fr. Patrizi, as Lamy quotes him, 'damnare non audet eos qui hæc
tenerent,' viz., exceptions, and he himself, by keeping silence, seems
unable to condemn them either.

By \emph{obiter dicta} in Scripture I also mean
...
unauthoritative \emph{obiter dicta}, that unlike those which occur in
...
uttered \emph{obiter}, because they are not contained within the scope
...
phrase can be considered \emph{obiter dicta}.

27. It may be questioned, too, whether the
absence of chronological sequence might not be represented as an
infringement of plenary inspiration, more serious than the \emph{obiter
...
says Fr. Patrizi (\emph{De Evang}. lib. ii. p. 1), viz., 'Matthæum de
...
an \emph{obiter} \emph{dictum}. Yet, in spite of this danger,
...
attributed, not to Luke himself, but to his transcribers' (\emph{ibid}.
...
controversy (\emph{vide} Lamy, i. p. 31).
...
Catholics to hold and profess \emph{de fide} about Scripture? that is,
