...
with most force and eloquence wherever he really \emph{did} comprehend it.
...
and Pompey. The famous line, \emph{``Nil actum reputans si quid superesset
agendum,''} is a fine feature of the real character, finely expressed.
...
by this expressive passage, \emph{``Gaudensque viam fecisse ruina.''} Such a
...
``\emph{Si fractus illabatur orbis, impavidum ferient ruinae}'') had, however,
...
moderation \emph{(unum accessisse sobrium ad rempublicam delendam)}….
...
leisure in his thoughts of consolation; the sole danger which \emph{he}
...
conflict and the yoke of practical life, even \emph{his} energies might have
...
but the creatures of Sylla (\emph{adjutores}), who pursued Caesar. We know,
...
amplificando, \emph{ementiendoque}''; as when, upon finding his soldiery
...
shore.'' Finally, we might seek for \emph{characteristic} anecdotes of Caesar
...
presented, in one \emph{congiary}, about two guineas and a half a head. To
his army, in one \emph{donation}, upon the termination of the Civil War, he
...
money it would require to make him worth exactly nothing (\emph{i.e.} simply
...
potero?'' \emph{Sylla found it possible: shall I find it not so?} Possible to
...
could belong to any one of his rivals. And that he \emph{did} enter that
...
taking or \emph{not} taking the shape of triumvirates. He relied, it seems,
...
liberalities. From the senator downwards to the lowest \emph{faex Romuli}, he
...
distant day when he might need assistance, not \emph{from} the state, but
\emph{against} the state. For, amongst the private anecdotes which came to
...
a small aspiring bird, received the popular name of the \emph{Alauda} (or
...
combat. Dramas were represented in every known language (\emph{per omnium
linguarum histriones}). And hence (that is, from the conciliatory
...
India, especially at the great fair of the \emph{Hurdwar} on the Ganges in
...
(\emph{peritissimus}) in the use of arms. But, notwithstanding his skill and
...
\emph{rheda}, a sort of gig, or rather curricle; for it was a \emph{four}-wheeled
...
no extraordinary day's journey for him in a \emph{rheda}, such as we have
...
whilst halting at a little \emph{cabaret}, when one of his retinue was
...
offence—this is no more than we should all anticipate—not \emph{that}, but
...
\emph{splendidus} to Caesar, as though in some exclusive sense, or with some
peculiar emphasis, due to him. His taste was much simpler, chaster, and
less inclined to the \emph{florid} and Asiatic, than that of Cicero. So far
...
the modest title of \emph{Commentaries}, he meant to offer the records of his
...
question, of course, to the classes of men great in \emph{action}: great by
...
Westmoreland they call a good \emph{darroch} (day's work); and, if \emph{navvies}
...
Republic into crowning provinces of 1. France (\emph{Gallia}), 2. Belgium, 3.
Holland (\emph{Batavia}), 4. England (\emph{Britannia}), 5. Savoy (\emph{Allobroges}),
6. Switzerland (\emph{Helvetia}), 7. Spain (\emph{Hispania}),—than to decorate a
...
\emph{Works}: Latin folio, Rome, 1469; Venice, 1471; Florence, 1514; London,
...
Daniel, and Ben Johnson (\emph{sic}). Works: Translated by W. Duncan, 1753,
...
\xchapter{The War in Gaul. Book I}
...
``\emph{friend}'' by the senate of the Roman people), to seize upon the
...
fifth before the kalends of April [\emph{i.e.} the 28th of March], in the
...
they could not be restrained by \emph{him}: nay more, he was well aware that,
...
Aedui at a small cost, because when \emph{he} bids, no one dares to bid
...
hour [\emph{i.e.} 12 (noon)—1 P.M.] to eventide, no one could see an enemy
...
\emph{their} flight might either be concealed or entirely overlooked, having
...
might settle the Boii, in their own (\emph{i.e.} in the Aeduan) territories,
...
Of the \emph{Helvetii} [lit. of the heads of the Helvetii] 263,000

Of the \emph{Tulingi} 36,000

Of the \emph{Latobrigi} 14,000

Of the \emph{Rauraci} 23,000

Of the \emph{Boii} 32,000
...
the \emph{census} of those who returned home was taken, as Caesar had
...
Arverni and the Sequani. That about 15,000 of them [\emph{i.e.} of the
...
did \emph{not} continue to do that, the Roman people's name of 'brothers'
...
entered into a contest with \emph{him} [Ariovistus] without utter ruin to
...
\xchapter{The War in Gaul. Book II}
...
Belgae, to learn what is going on amongst them [\emph{i.e.} the Belgae], and
...
commanded, a rush was made thither [\emph{i.e.} by the Roman soldiers] from
...
\xchapter{The War in Gaul. Book III}
...
own delay, and by the reputation [\emph{i.e.} for cowardice arising thence]
...
\xchapter{The War in Gaul. Book IV}
...
\xchapter{The War in Gaul. Book V}
...
\xchapter{The War in Gaul. Book VI}
...
\xchapter{The War in Gaul. Book VII}
...
\xchapter{The War in Gaul. Book VIII}
...
\xchapter{The Civil War. Book II}
...
\xchapter{The Civil War. Book III}
