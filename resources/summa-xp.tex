% St. Thomas Aquinas, Summa Theologica -- The Supplement. The Benziger
...
\urlstyle{same}
\hypersetup{pdftitle={Summa Theologica -- The Supplement},pdfauthor={St. Thomas Aquinas}}
\linespread{1.06}
...
\vspace{1.5em}
{\Large\color{subhead} The Supplement\par}
\vspace{2.5em}
