...
% Gospel of St. Mark. Oxford translation, 1841, from the fisheaters PDF
% (catena-src/xaquinas-mark.pdf), rebuilt as our own LaTeX by
...
\urlstyle{same}
\hypersetup{pdftitle={Catena Aurea on St. Mark},pdfauthor={St. Thomas Aquinas}}
\linespread{1.06}
...
\vspace{2em}
{\Large\color{subhead} A Commentary on the Gospel of St. Mark\par}
\vspace{2.5em}
