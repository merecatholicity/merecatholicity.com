...
threefold division of philosophy is made—into \emph{Physics}, dealing
with the universe and its laws, the problems of divine government and
teleology; \emph{Logic}, which trains the mind to discern true from false; and
\emph{Ethics}, which applies the knowledge thus gained and tested to practical
life.
...
truth, the \emph{Criterion}. They compared the new-born soul to a sheet of
...
It is instructive to compare the \emph{Meditations} with another famous book, the
\emph{Imitation of Christ}. There is the same ideal of self-control in both. It should
be a man's task, says the \emph{Imitation}, 'to overcome himself, and every day to be
...
idea which does not meet us in the \emph{Meditations}. Both alike realise that man is
...
\emph{Imitation} is addressed to others, the \emph{Meditations} by the writer
to himself. We learn nothing from the \emph{Imitation} of the author's own
life, except in so far as he may be assumed to have practised his own
preachings; the \emph{Meditations} reflect mood by mood the mind of him who
...
Profound as philosophy these \emph{Meditations} certainly are not; but Marcus
...
\emph{Meditations}, and shows how he could retire within himself amid the
...
\xchapter{His First Book}

\xsection{concerning HIMSELF:}
...
that ever I lighted upon Epictetus his \emph{Hypomnemata}, or moral commentaries
...
passion; able at the same time most exactly to observe the Stoic \emph{Apathia},
...
εὐπατρίδαι,
\emph{i.e.} nobly born, are in some sort incapable, or void of natural
affection.
...
\emph{Whilst I was at Carnuntum.}

\xchapter{The Third Book}
...
delight. So will he behold with as much pleasure the true \emph{rictus} of wild
...
another part; and so \emph{in infinitum;} by which kind of mutation, I
also became what I am, and so did they that begot me, and they before
them, and so upwards \emph{in infinitum}. For so we may be allowed to
...
therefore of a man, or the \emph{summum bonum} whereby that end is
...
thee. Unto the \emph{cylindrus}, or roller, it is not granted to move
...
stone downwards, or as the \emph{cylindrus} through that which is
...
[13]
The writer sometimes uses archaisms such as \emph{quom}, which I render
'whenas'.
...
Naher's \emph{Prolegomena}, p. xx. foll.
...
study.[23]
His \emph{Meditations} are written in Greek. He continued his literary studies
...
[27]
The Emperor Antoninus Pius is spoken of as \emph{dominus meus}.
...
honey-water, ejecting it without swallowing: I might say \emph{gargle}, but I
...
It is noteworthy that in his \emph{Meditations} Marcus Aurelius mentions Fronto
only once.[47]
...
indebted to Mr. G. H. Rendall's \emph{Marcus Aurelius}.
...
``For herein lieth all....'' (\textasciitilde{}3). C. translates his conjecture olan for
ola.
...
\xsection{Paragraphs with First Lines}

\textbf{HIS FIRST BOOK}
...
a7\textasciitilde{}o\textasciitilde{} \&d\textasciitilde{}wv, or, a good
