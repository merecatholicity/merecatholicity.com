...
% Gospel of St. John. Oxford translation, 1841, from the fisheaters PDF
% (catena-src/xaquinas-john.pdf), rebuilt as our own LaTeX by
...
\urlstyle{same}
\hypersetup{pdftitle={Catena Aurea on St. John},pdfauthor={St. Thomas Aquinas}}
\linespread{1.06}
...
\vspace{2em}
{\Large\color{subhead} A Commentary on the Gospel of St. John\par}
\vspace{2.5em}
