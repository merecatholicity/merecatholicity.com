...
measures, the venerable epic, Beowulf. \emph{Approximately}, I repeat; for a very
...
our first \emph{epic}? Of those translators who have used verse, several have written
...
What Gummere\footnote{Handbook of Poetics, page 175, 1st edition.} calls the “rime-giver” has been studiously kept; \emph{viz.}, the
...
of his types, however, constantly occur; \emph{e.g.} A and a variant
(/ x | / x) (/ x x | / x);
B and a variant (x / | x / ) (x x / | x / ); a variant of D (/ x | / x x);
E (/ x x | / ). Anacrusis gives further variety to the types used in the translation.

The parallelisms of the original have been faithfully preserved. (\emph{E.g.}, 1 16
...
\emph{Hrothgar, king of the Danes, or Scyldings, builds a great mead-hall, or
...
\emph{Over sea, a day’s voyage off, Beowulf, of the Geats, nephew of Higelac,
...
\emph{Grendel comes, the great march-stepper, bearing God’s anger. He seizes
...
\emph{The next morning, at early dawn, warriors in numbers flock to the hall
Heorot, to hear the news. Joy is boundless. Glee runs high. Hrothgar and
his retainers are lavish of gratitude and of gifts.}

\emph{Grendel’s mother, however, comes the next night to avenge his death. She
is furious and raging. While Beowulf is sleeping in a room somewhat apart from the quarters of the other warriors, she seizes one of Hrothgar’s favorite
...
\emph{Joy is renewed at Heorot. Congratulations crowd upon the victor.
...
\emph{Beowulf leaves Dane-land. Hrothgar weeps and laments at his departure.}

\emph{When the hero arrives in his own land, Higelac treats him as a distinguished
guest. He is the hero of the hour.}

\emph{Beowulf subsequently becomes king of his own people, the Geats. After he
...
\emph{The poem closes with a glowing tribute to his bravery, his gentleness, his
...
\xchapter{List of Words and Phrases Not in General Use.}
...
\xchapter{The Life and Death of Scyld.}

\emph{The famous race of
Spear-Danes.}
...
15
\footnote{For the ‘Þæt’ of verse 15, Sievers suggests ‘Þá’ (= which). If this be
accepted, the sentence ‘He had … afflicted’ will read: \emph{He} (\emph{i.e.} God) \emph{had
perceived the malice-caused sorrow which they, lordless, had formerly long
endured}.}That reaved of their rulers they wretched had erstwhile\footnote{For ‘aldor-léase’ (15) Gr. suggested ‘aldor-ceare’: \emph{He perceived their
...
Long did rule them.\footnote{A very difficult passage. ‘Áhte’ (31) has no object. H. supplies ‘geweald’
from the context; and our translation is based upon this assumption,
though it is far from satisfactory. Kl. suggests ‘lændagas’ for ‘lange’: \emph{And
...
eminent scholar.} The ring-stemmèd vessel,

Bark of the atheling, lay there at anchor,

Icy in glimmer and eager for sailing;

\emph{By his own request,
his body is
laid on a vessel
and wafted seaward.}
...
Soothly to tell us, they in halls who reside,\footnote{The reading of the H.-So. text has been quite closely followed; but some
eminent scholars read ‘séle-rædenne’ for ‘sele-rædende.’ If that be adopted,
the passage will read: \emph{Men cannot tell us, indeed, the order of Fate, etc.}
...
\xchapter{Scyld’s Successors.—hrothgar’s Great Mead-hall.}

\emph{Beowulf succeeds
his father Scyld}
...
Then the mighty war-spirit\footnote{R. and t. B. prefer ‘ellor-gæst’ to ‘ellen-gæst’ (86): \emph{Then the stranger
from afar endured, etc.}} endured for a season,

\emph{The Monster Grendel
is madly envious
of the Danemen’s
joy.}
...
A foe in the hall-building: this horrible stranger\footnote{Some authorities would translate ‘\emph{demon}’ instead of ‘\emph{stranger}.’}

50
Was Grendel entitled, the march-stepper famous

Who\footnote{Some authorities arrange differently, and render: \emph{Who dwelt in the moor-fens,
the marsh and the fastness, the land of the giant-race.}} dwelt in the moor-fens, the marsh and the fastness;
...
\xchapter{Grendel the Murderer.}

\emph{Grendel attacks the
sleeping heroes}
...
5
Asleep after supper; sorrow the heroes,\footnote{The translation is based on ‘weras,’ adopted by H.-So.—K. and Th.
read ‘wera’ and, arranging differently, render 119(2)-120: \emph{They knew not
sorrow, the wretchedness of man, aught of misfortune}.—For ‘unhælo’ (120)
R. suggests ‘unfælo’: \emph{The uncanny creature, greedy and cruel, etc}.}

Misery knew not. The monster of evil

Greedy and cruel tarried but little,

\emph{He drags off thirty
of them, and devours
them}
...
30
\footnote{S. rearranges and translates: \emph{So he ruled and struggled unjustly, one against
all, till the noblest of buildings stood useless (it was a long while) twelve years’
time: the friend of the Scyldings suffered distress, every woe, great sorrows, etc}.}So ruled he and strongly strove against justice

Lone against all men, till empty uptowered

\emph{King Hrothgar’s
agony and suspense
last twelve
years.}
...
35
Endless agony; hence it after\footnote{For ‘syððan,’ B. suggests ‘sárcwidum’: \emph{Hence in mournful words it became
...
\footnote{The H.-So. glossary is very inconsistent in referring to this passage.—‘Sibbe’
(154), which H.-So. regards as an instr., B. takes as accus., obj. of
‘wolde.’ Putting a comma after Deniga, he renders: \emph{He did not desire
peace with any of the Danes, nor did he wish to remove their life-woe, nor to
settle for money}.}Life-woe to lift from no liegeman at all of
...
\emph{God is against the
monster.}

(Since God did oppose him, not the throne could he touch,\footnote{Of this difficult passage the following interpretations among others are
...
Creator; \emph{i.e.} God wished to make his visit fatal to him.—Ne … wisse (169)
W. renders: \emph{Nor had he any desire to do so}; ‘his’ being obj. gen. = danach.}
...
\xchapter{Beowulf Goes to Hrothgar’s Assistance.}

\emph{Hrothgar sees no
way of escape from
the persecutions of
Grendel.}
...
Heard in his home:\footnote{‘From hám’ (194) is much disputed. One rendering is: \emph{Beowulf, being
away from home, heard of Hrothgar’s troubles, etc}. Another, that adopted by
S. and endorsed in the H.-So. notes, is: \emph{B. heard from his neighborhood (neighbors),}
i.e. \emph{in his home, etc}. A third is: \emph{B., being at home, heard this as
occurring away from home}. The H.-So. glossary and notes conflict.} of heroes then living
...
35
At the end of the ocean.\footnote{‘Eoletes’ (224) is marked with a (?) by H.-So.; our rendering simply
follows his conjecture.—Other conjectures as to ‘eolet’ are: (1) \emph{voyage},
(2) \emph{toil}, \emph{labor}, (3) \emph{hasty journey}.} Up thence quickly
...
\footnote{The lacuna of the MS at this point has been supplied by various conjectures.
...
after ‘holmas’, and begins a new sentence at the middle of the line. Translate:
\emph{What warriors are ye, clad in armor, who have thus come bringing the
...
accepted, change line 51 above to, \emph{A ring-stemmed vessel hither o’ersea}.}And hither ’neath helmets have hied o’er the ocean?
...
\emph{He is struck by
Beowulf’s appearance.}

Nothing have known. Never a greater one

Of earls o’er the earth have \emph{I} had a sight of

60
Than is one of your number, a hero in armor;

No low-ranking fellow\footnote{‘Seld-guma’ (249) is variously rendered: (1) \emph{housecarle}; (2) \emph{home-stayer};
(3) \emph{common man}. Dr. H. Wood suggests \emph{a man-at-arms in another’s house}.} adorned with his weapons,
...
\xchapter{The Geats Reach Heorot.}

\emph{Beowulf courteously
replies.}
...
If the anguish of sorrow should ever be lessened,\footnote{‘Edwendan’ (280) B. takes to be the subs. ‘edwenden’ (cf. 1775); and
‘bisigu’ he takes as gen. sing., limiting ‘edwenden’: \emph{If reparation for
...
45
Firmly at anchor); the boar-signs glistened\footnote{Combining the emendations of B. and t.B., we may read: \emph{The boar-images
...
\xchapter{Beowulf Introduces Himself at the Palace.}

The highway glistened with many-hued pebble,

A by-path led the liegemen together.

\footnote{Instead of the punctuation given by H.-So, S. proposed to insert a comma
after ‘scír’ (322), and to take ‘hring-íren’ as meaning ‘ring-mail’ and as
parallel with ‘gúð-byrne.’ The passage would then read: \emph{The firm and
hand-locked war-burnie shone, bright ring-mail, rang ’mid the armor, etc}.}Firm and hand-locked the war-burnie glistened,
...
\footnote{Gr. and others translate ‘unhár’ by ‘bald’; \emph{old and bald}.}Old and hoary, his earlmen attending him;
...
\xchapter{Hrothgar and Beowulf.}

\emph{Hrothgar remembers
Beowulf as a
youth, and also
remembers his
father.}
...
\emph{Beowulf is reported
to have the
strength of thirty
men.}

Who valuable gift-gems of the Geatmen\footnote{Some render ‘gif-sceattas’ by ‘tribute.’—‘Géata’ B. and Th. emended to
‘Géatum.’ If this be accepted, change ‘\emph{of} the Geatmen’ to ‘\emph{to} the Geatmen.’} carried
...
15
Hasten to bid them hither to speed them,\footnote{If t.B.’s emendation of vv. 386, 387 be accepted, the two lines, ‘Hasten
… kinsmen’ will read: \emph{Hasten thou, bid the throng of kinsmen go into the
hall together}.}
...
Foes I escaped from, where five\footnote{For 420 (\emph{b}) and 421 (\emph{a}), B. suggests: Þær ic (on) fífelgeban ýðde
eotena cyn = \emph{where I in the ocean destroyed the eoten-race}.—t.B. accepts B.’s
“brilliant” ‘fífelgeban,’ omits ‘on,’ emends ‘cyn’ to ‘hám,’ arranging: Þær ic
fífelgeban ýðde, eotena hám = \emph{where I desolated the ocean, the home of the
eotens}.—This would be better but for changing ‘cyn’ to ‘hám.’—I suggest:
Þær ic fífelgeband (cf. nhd. Bande) ýðde, eotena cyn = \emph{where I conquered the
monster band, the race of the eotens}. This makes no change except to read
‘\emph{fífel}’ for ‘\emph{fífe}.’} I had bound,
...
That \emph{I} may unaided, my earlmen assisting me,
...
Boldly to swallow\footnote{‘Unforhte’ (444) is much disputed.—H.-So. wavers between adj. and adv.
Gr. and B. take it as an adv. modifying \emph{etan: Will eat the Geats fearlessly}.—Kl.
...
his own nest.} them, as of yore he did often

The best of the Hrethmen! Thou needest not trouble

A head-watch to give me;\footnote{For ‘head-watch,’ cf. H.-So. notes and cf. v. 2910.—Th. translates: \emph{Thou
...
suggests: \emph{Thou wilt not have to bury so much as my head} (for
Grendel will be a thorough undertaker),—grim humor.} he will have me dripping

\emph{In case of my defeat,
thou wilt not
have the trouble of
burying me.}

75
And dreary with gore, if death overtake me,\footnote{S. proposes a colon after ‘nimeð’ (l. 447). This would make no essential
...
\emph{Should I fall, send
my armor to my
lord, King Higelac.}

Find me my food.\footnote{Owing to the vagueness of ‘feorme’ (451), this passage is variously translated.
...
\emph{Thou needst not take care longer as to the consumption of my dead
body.} ‘Líc’ is also a crux here, as it may mean living body or dead body.} If I fall in the battle,
...
\emph{Weird is supreme}

The work of Wayland. Goes Weird as she must go!”

\xchapter{VIII.}

\xchapter{HROTHGAR AND BEOWULF.—Continued.}

\emph{Hrothgar responds.}

Hrothgar discoursed, helm of the Scyldings:

“To defend our folk and to furnish assistance,\footnote{B. and S. reject the reading given in H.-So., and suggested by Grtvg. B.
...
This means: \emph{From the obligations of clientage, my friend Beowulf, and for
...
\emph{Sit down to the
feast, and give us
comfort.}

Sit at the feast now, thy intents unto heroes,\footnote{\emph{Sit now at the feast, and disclose thy purposes to the victorious heroes, as
...
\emph{The gleeman sings}

40
And gleaming-drink poured. The gleeman sang whilom

\emph{The heroes all rejoice
together.}
...
\xchapter{Unferth Taunts Beowulf.}

\emph{Unferth, a thane
of Hrothgar, is
jealous of Beowulf,
and undertakes to
twit him.}
...
Opened the jousting (the journey\footnote{It has been plausibly suggested that ‘síð’ (in 501 and in 353) means
‘arrival.’ If so, translate the bracket: \emph{(the arrival of Beowulf, the brave
seafarer, was a source of great chagrin to Unferth, etc.)}.} of Beowulf,
...
45
More swift on the waves, nor \emph{would} I from him go.

Then we two companions stayed in the ocean

\emph{After five days the
currents separated
us.}
...
\xchapter{Beowulf Silences Unferth.—glee Is High.}
...
But me did it fortune\footnote{The repetition of ‘hwæðere’ (574 and 578) is regarded by some scholars
as a defect. B. suggests ‘swá Þær’ for the first: \emph{So there it befell me, etc.}
Another suggestion is to change the second ‘hwæðere’ into ‘swá Þær’: \emph{So
there I escaped with my life, etc.}} to fell with my weapon
...
A fight was determined,\footnote{Kl. suggests a period after ‘determined.’ This would give the passage
as follows: \emph{Since they no longer could see the light of the sun, and lowering
darkness was down over all, dire under the heavens shadowy beings came going
around them}.} since the light of the sun they
...
\emph{Beowulf is self-confident}

His warlike strength and the Wielder’s protection.

\emph{He prepares for
rest.}
...
\emph{We will fight with
nature’s weapons
only.}

20
No battle-skill\footnote{Gr. understood ‘gódra’ as meaning ‘advantages in battle.’ This rendering
H.-So. rejects. The latter takes the passage as meaning that Grendel,
though mighty and formidable, has no skill in the art of war.} has he, that blows he should strike me,
...
He angrily bided the issue of battle.\footnote{B. in his masterly articles on Beowulf (P. and B. XII.) rejects the division
...
on which the whole subsequent action turns. First, he (Grendel) came \emph{in
the wan night}; second, he came \emph{from the moor}; third, he came \emph{to the hall}.
Time, place from which, place to which, are all given.}

\xchapter{XII.}

\xchapter{Grendel and Beowulf.}
...
10
Hardier hero, hall-thanes\footnote{B. and t.B. emend so as to make lines 9 and 10 read: \emph{Never in his life,
...
usual readings allow them.} more sturdy!

Then came to the building the warrior marching,

\emph{His horrid fingers
tear the door open.}
...
Archwarders raging.\footnote{For ‘réðe rén-weardas’ (771), t.B. suggests ‘réðe, rénhearde.’ Translate:
\emph{They were both angry, raging and mighty}.} Rattled the building;
...
\xchapter{Grendel Is Vanquished.}
...
Who with mirth\footnote{It has been proposed to translate ‘myrðe’ by \emph{with sorrow}; but there
seems no authority for such a rendering. To the present translator, the phrase
‘módes myrðe’ seems a mere padding for \emph{gladly}; i.e., \emph{he who gladly
harassed mankind}.} of mood malice no little
...
\xchapter{Rejoicing of the Danes.}
...
And seething with gore, welling with sword-blood;\footnote{S. emends, suggesting ‘déop’ for ‘déog,’ and removing semicolon after
‘wéol.’ The two half-lines ‘welling … hid him’ would then read: \emph{The
bloody deep welled with sword-gore}. B. accepts ‘déop’ for ‘déog,’ but reads
‘déað-fæges’: \emph{The deep boiled with the sword-gore of the death-doomed one}.}
...
Known for their excellence; oft a thane of the folk-lord,\footnote{Another and quite different rendering of this passage is as follows: \emph{Oft
...
\footnote{Might ‘guma gilp-hladen’ mean ‘a man laden with boasts of the deeds
of others’?}A man of celebrity, mindful of rhythms,
...
War-troopers’ shelter: hence waxed he in honor.\footnote{t.B. accepts B.’s ‘hé þæs áron þáh’ as given by H.-So., but puts a comma
after ‘þáh,’ and takes ‘siððan’ as introducing a dependent clause: \emph{He throve
in honor since Heremod’s strength … had decreased}.}

\emph{Heremod, an unfortunate
Danish
king, is introduced
by way of contrast.}
...
\xchapter{Hrothgar’s Gratitude.}

Hrothgar discoursed (to the hall-building went he,

He stood by the pillar,\footnote{B. and t.B. read ‘staþole,’ and translate \emph{stood on the floor}.} saw the steep-rising hall-roof
...
Snaring from Grendel:\footnote{For ‘snaring from Grendel,’ ‘sorrows at Grendel’s hands’ has been suggested.
This gives a parallel to ‘láðes.’ ‘Grynna’ may well be gen. pl. of
‘gyrn,’ by a scribal slip.} God can e’er ’complish

Wonder on wonder, Wielder of Glory!

\emph{I had given up all
hope, when this
brave liegeman
came to our aid.}
...
Gory uptowered; grief had offfrightened\footnote{The H.-So punctuation has been followed; but B. has been followed in
...
\xchapter{Hrothgar Lavishes Gifts Upon His Deliverer.}

\emph{Heorot is adorned
with hands.}

Then straight was ordered that Heorot inside\footnote{Kl. suggests ‘hroden’ for ‘háten,’ and renders: \emph{Then quickly was
Heorot adorned within, with hands bedecked}.—B. suggests ‘gefrætwon’ instead
of ‘gefrætwod,’ and renders: \emph{Then was it commanded to adorn Heorot
...
\emph{[A vague passage
of five verses.]}

(Whoever will do it!); but he doubtless must come to\footnote{The passage 1005-1009 seems to be hopeless. One difficult point is to
find a subject for ‘gesacan.’ Some say ‘he’; others supply ‘each,’ \emph{i.e., every
...
\xchapter{BANQUET (continued).—THE SCOP’S SONG OF FINN AND HNÆF.}

\emph{Each of Beowulf’s
companions receives
a costly gift.}
...
That he nowise was able to offer resistance\footnote{For 1084, R. suggests ‘wiht Hengeste wið gefeohtan.’—K. suggests ‘wið
Hengeste wiht gefeohtan.’ Neither emendation would make any essential
change in the translation.}

\emph{Hengest succeeds
Hnæf as Danish
general.}
...
The woe-stricken woman wept on his shoulder,\footnote{The separation of adjective and noun by a phrase (cf. v. 1118) being very
unusual, some scholars have put ‘earme on eaxle’ with the foregoing lines,
inserting a semicolon after ‘eaxle.’ In this case ‘on eaxe’ (\emph{i.e.}, on the ashes,
...
65
In measures lamented; upmounted the hero.\footnote{For ‘gúð-rinc,’ ‘gúð-réc,’ \emph{battle-smoke}, has been suggested.}
...
\xchapter{THE FINN EPISODE (continued).—THE BANQUET CONTINUES.}

\emph{The survivors go
to Friesland, the
home of Finn.}
...
5
Wholly unsundered;\footnote{For 1130 (1) R. and Gr. suggest ‘elne unflitme’ as 1098 (1) reads. The
...
I would suggest ‘\emph{very peaceably}’ for both places: (1) \emph{Finn to Hengest very
peaceably vowed with oaths}, etc. (2) \emph{Hengest then still the slaughter-stained
...
‘conquerable.’} of fatherland thought he
...
Could not bide in his bosom. Then the building was covered\footnote{Some scholars have proposed ‘roden’; the line would then read: \emph{Then
...
\xchapter{Beowulf Receives Further Honor.}

\emph{More gifts are offered
Beowulf.}
...
The bracteates and jewels, from the bright-shining city,\footnote{C. suggests a semicolon after ‘city,’ with ‘he’ as supplied subject of
‘fled’ and ‘chose.’}
...
The\footnote{For ‘feorh’ S. suggests ‘feoh’: ‘corpse’ in the translation would then
be changed to ‘\emph{possessions},’ ‘\emph{belongings}.’ This is a better reading than one
joining, in such intimate syntactical relations, things so unlike as ‘corpse’ and
‘jewels.’} corpse of the king then came into charge of
...
The war-troops ready: well-drunken heroes,\footnote{S. suggests ‘\emph{wine-joyous heroes},’ ‘\emph{warriors elated with wine}.’}
...
\emph{They were always
ready for battle.}

And mighty war-spear. ’Twas the wont of that people

55
To constantly keep them equipped for the battle,\footnote{I believe this translation brings out the meaning of the poet, without
...
occurs quite frequently with ‘on’; cf. B. 1110 (\emph{ready for the pyre}), El. 222
(\emph{ready for the glad journey}). Moreover, what has the idea of single combat
...
that they were \emph{always prepared for battle both at home and on the march}.}
...
\xchapter{The Mother of Grendel.}

They sank then to slumber. With sorrow one paid for

His evening repose, as often betid them

While Grendel was holding\footnote{Several eminent authorities either read or emend the MS. so as to make
this verse read, \emph{While Grendel was wasting the gold-bedecked palace}. So 20 15
below: \emph{ravaged the desert}.} the gold-bedecked palace,
...
Return\footnote{For ‘sóna’ (1281), t.B. suggests ‘sára,’ limiting ‘edhwyrft.’ Read then:
\emph{Return of sorrows to the nobles, etc}. This emendation supplies the syntactical
gap after ‘edhwyrft.’} to the nobles, when the mother of Grendel
...
Then the hard-edgèd weapon was heaved in the building,\footnote{Some authorities follow Grein’s lexicon in treating ‘heard ecg’ as an adj.
...
She grasped in its gore;\footnote{B. suggests ‘under hróf genam’ (v. 1303). This emendation, as well as
...
876 (March’s A.-S. Gram. § 355) and Oro. Amaz. I. 10, where ‘under’ = \emph{in
the midst of}. Cf. modern Eng. ‘in such circumstances,’ which interchanges
in good usage with ‘under such circumstances.’} grief was renewed then
...
\emph{Beowulf inquires
how Hrothgar had
enjoyed his night’s
rest.}

The earl of the Ingwins;\footnote{For ‘néod-laðu’ (1321) C. suggests ‘néad-láðum,’ and translates: \emph{asked
whether the night had been pleasant to him after crushing-hostility}.} asked if the night had
...
\xchapter{Hrothgar’s Account of the Monsters.}

\emph{Hrothgar laments
...
By cramming discovered.\footnote{For ‘gefrægnod’ (1334), K. and t.B. suggest ‘gefægnod,’ rendering
‘\emph{rejoicing in her fill}.’ This gives a parallel to ‘æse wlanc’ (1333).} The quarrel she wreaked then,
...
20
And henceforth hath ‘stablished her hatred unyielding,\footnote{The line ‘And … yielding,’ B. renders: \emph{And she has performed a deed
...
Which\footnote{‘Sé Þe’ (1345) is an instance of masc. rel. with fem. antecedent. So
v. 1888, where ‘sé Þe’ refers to ‘yldo.’} availed you in every wish that you cherished.

\emph{I have heard my
vassals speak of
these two uncanny
monsters who lived
in the moors.}
...
Which forests hang over, with frost-whiting covered,\footnote{For ‘hrímge’ in the H.-So. edition, Gr. and others read ‘hrínde’
(=hrínende), and translate: \emph{which rustling forests overhang}.}
...
\xchapter{Beowulf Seeks Grendel’s Mother.}

Beowulf answered, Ecgtheow’s son:

\emph{Beowulf exhorts
the old king to
arouse himself for
action.}
...
\xchapter{Beowulf’s Fight with Grendel’s Mother.}

\emph{Beowulf makes a
parting speech to
Hrothgar.}
...
The famed one to have, the heavy-sword splendid\footnote{Kl. emends ‘wæl-sweord.’ The half-line would then read, ‘\emph{the battle-sword
splendid}.’—For ‘heard-ecg’ in next half-verse, see note to 20 39 above.}

The hard-edgèd weapon; with Hrunting to aid me,

I shall gain me glory, or grim-death shall take me.”

\emph{Beowulf is eager
for the fray.}
...
(He shrank not from battle) seized by the shoulder\footnote{Sw., R., and t.B. suggest ‘feaxe’ for ‘eaxle’ (1538) and render: \emph{Seized
by the hair}.}
...
She gave him requital\footnote{If ‘hand-léan’ be accepted (as the MS. has it), the line will read: \emph{She
hand-reward gave him early thereafter}.} early thereafter,

And stretched out to grab him; the strongest of warriors

Faint-mooded stumbled, till he fell in his traces,

\emph{The monster sits
on him with drawn
sword.}
...
Ruler most righteous arrange it with justice;\footnote{Sw. and S. change H.-So.’s semicolon (v. 1557) to a comma, and translate:
\emph{The Ruler of Heaven arranged it in justice easily, after he arose
again}.}
...
\xchapter{Beowulf Is Double-conqueror.}

\emph{Beowulf grasps a
giant-sword,}
...
Then many concluded the mere-wolf had killed him.\footnote{‘Þæs monige gewearð’ (1599) and ‘hafað þæs geworden’ (2027).—In a
...
times with the meaning ‘agree.’ See Orosius (Sweet’s ed.) 178 7 ; 204 34 ;
208 28 ; 210 15 ; 280 20 . In the two Beowulf passages, the þæt-clause is anticipated
by ‘þæs,’ which is clearly a gen. of the thing agreed on.

The first passage (v. 1599 (b)-1600) I translate literally: \emph{Then many
agreed upon this (namely), that the sea-wolf had killed him}.

The second passage (v. 2025 (b)-2027): \emph{She is promised …; to this the
...
of 1599 and 2027. Translate 1997 then: \emph{Wouldst let the South-Danes themselves
...
The brand early melted, burnt was the weapon:\footnote{‘Bróden-mæl’ is regarded by most scholars as meaning a damaskeened
sword. Translate: \emph{The damaskeened sword burned up}. Cf. 25 16 and note.}
...
75
The highway familiar: men very daring\footnote{‘Cyning-balde’ (1635) is the much-disputed reading of K. and Th. To
render this, “\emph{nobly bold},” “\emph{excellently bold},” have been suggested. B. would
read ‘cyning-holde’ (cf. 290), and render: \emph{Men well-disposed towards the
...
\xchapter{Beowulf Brings His Trophies.—hrothgar’s Gratitude.}

\emph{Beowulf relates his
last exploit.}
...
Then the battle-sword burned, the brand that was lifted,\footnote{Or rather, perhaps, ‘\emph{the inlaid, or damaskeened weapon}.’ Cf. 24 57 and
note.}
...
\xchapter{Hrothgar Moralizes.—rest After Labor.}

\emph{A wounded spirit.}
...
Nor boastfully giveth gold-plated rings,\footnote{K. says ‘\emph{proudly giveth}.’—Gr. says, ‘\emph{And gives no gold-plated rings, in
order to incite the recipient to boastfulness}.’—B. suggests ‘gyld’ for ‘gylp,’
and renders: \emph{And gives no beaten rings for reward}.}
...
Then the bright-shining sun o’er the bottoms came going;\footnote{If S.’s emendation be accepted, v. 57 will read: \emph{Then came the light,
...
\emph{The Geats prepare
to leave Dane-land.}

60
The high-mooded farer would faraway thenceward

Look for his vessel. The valiant one bade then,\footnote{As the passage stands in H.-So., Unferth presents Beowulf with the sword
Hrunting, and B. thanks him for the gift. If, however, the suggestions of Grdtvg.
and M. be accepted, the passage will read: \emph{Then the brave one (}i.e.\emph{Beowulf)
...
\xchapter{Sorrow at Parting.}

\emph{Beowulf’s farewell.}
...
35
Gem-ward of heroes, than \emph{thou} mightest prove thee,
...
Tow’rd foeman and friend firmly established,\footnote{For ‘geworhte,’ the crux of this passage, B. proposes ‘geþóhte,’ rendering:
\emph{I know this people with firm thought every way blameless towards foe and
friends}.}
...
\footnote{S. and B. emend so as to negative the verb ‘meet.’ “Why should
...
have been due to many emotions, especially gratitude, struggling for expression.}That bold in council they’d meet thereafter.
...
\xchapter{The Homeward Journey.—the Two Queens.}
...
Said the bright-armored visitors\footnote{For ‘scawan’ (1896), ‘scaðan’ has been proposed. Accepting this, we
may render: \emph{He said the bright-armored warriors were going to their vessel,
welcome, etc}. (Cf. 1804.)} vesselward traveled
...
As the heirloom’s owner. \footnote{R. suggests, ‘Gewát him on naca,’ and renders: \emph{The vessel set out, to
...
(cf. P. and B. XII. 97) is violent.}Set he out on his vessel,
...
Who long in the past outlooked in the distance,\footnote{B. translates: \emph{Who for a long time, ready at the coast, had looked out into
...
Hrethel’s son Higelac at home there remaineth,\footnote{For ‘wunað’ (v. 1924) several eminent critics suggest ‘wunade’ (=remained).
...
Thrytho nursed anger, excellent\footnote{Why should such a woman be described as an ‘excellent’ queen? C.
suggests ‘frécnu’ = dangerous, bold.} folk-queen,

Hot-burning hatred: no hero whatever

’Mong household companions, her husband excepted

\emph{She is a terror to
all save her husband.}

45
Dared to adventure to look at the woman

With eyes in the daytime;\footnote{For ‘an dæges’ various readings have been offered. If ‘and-éges’ be
accepted, the sentence will read: \emph{No hero … dared look upon her, eye to eye}.
If ‘án-dæges’ be adopted, translate: \emph{Dared look upon her the whole day}.} but he knew that death-chains
...
\emph{Queen Hygd receives
the heroes.}

In words that were formal. The daughter of Hæreth

Coursed through the building, carrying mead-cups:\footnote{‘Meodu-scencum’ (1981) some would render ‘\emph{with mead-pourers}.’ Translate
then: \emph{The daughter of Hæreth went through the building accompanied by
mead-pourers}.}
...
To suffer the South-Danes themselves to decide on\footnote{See my note to 1599, supra, and B. in P. and B. XII. 97.}
...
Who longest liveth of the loth-going kindred,\footnote{For ‘fenne,’ supplied by Grdtvg., B. suggests ‘fácne’ (cf. Jul. 350).
Accepting this, translate: \emph{Who longest lives of the hated race, steeped in
treachery}.}
...
The guard of the kingdom, hath given his sanction,\footnote{See note to v. 1599 above.}
...
\footnote{This is perhaps the least understood sentence in the poem, almost every
...
(= \emph{seldom}), and by others as a noun (= \emph{page}, \emph{companion}). (3) ‘Léod-hryre,’
some render ‘\emph{fall of the people}’; others, ‘\emph{fall of the prince}.’ (4) ‘Búgeð,’
most scholars regard as the intrans. verb meaning ‘\emph{bend},’ ‘\emph{rest}’; but one
great scholar has translated it ‘\emph{shall kill}.’ (5) ‘Hwær,’ Very recently, has
...
= \emph{often has a treaty been (thus) struck, after a prince had fallen: (but only)
a short time is the spear (then) wont to rest, however excellent the bride may be}.}Somewhere not rarely, when the ruler has fallen,
...
\xchapter{Beowulf Narrates His Adventures to Higelac.}
...
30
’Scapeth alive, the land knoweth thoroughly.\footnote{For ‘lifigende’ (2063), a mere conjecture, ‘wígende’ has been suggested.
The line would then read: \emph{Escapeth by fighting, knows the land thoroughly}.}
...
\emph{She suffered not
his body to be
burned, but ate it.}

She the corpse had offcarried in the clutch of the foeman\footnote{For ‘fæðmum,’ Gr.’s conjecture, B. proposes ‘færunga.’ These three
half-verses would then read: \emph{She bore off the corpse of her foe suddenly under
...
By the life of thee the land-prince then me\footnote{The phrase ‘þíne lýfe’ (2132) was long rendered ‘\emph{with thy (presupposed)
permission}.’ The verse would read: \emph{The land-prince then sadly besought me,
...
\xchapter{Gift-giving Is Mutual.}
...
\emph{All my gifts I lay
at thy feet.}

5
Atheling of earlmen, offer them gladly.

And still unto thee is all my affection:\footnote{This verse B. renders, ‘\emph{Now serve I again thee alone as my gracious king}.’}

But few of my folk-kin find I surviving

But thee, dear Higelac!” Bade he in then to carry\footnote{For ‘eafor’ (2153), Kl. suggests ‘ealdor.’ Translate then: \emph{Bade the
prince then to bear in the banner, battle-high helmet, etc}. On the other hand,
W. takes ‘eaforhéafodsegn’ as a compound, meaning ‘helmet’: \emph{He bade them
...
Wise-mooded atheling, thereafter to tell thee\footnote{The H.-So. rendering (ærest = \emph{history, origin}; ‘eft’ for ‘est’), though
...
\xchapter{The Hoard and the Dragon.}
...
20
Of long-lasting treasure.\footnote{For ‘long-gestréona,’ B. suggests ‘láengestréona,’ and renders, \emph{Of fleeting
treasures}. S. accepts H.’s ‘long-gestréona,’ but renders, \emph{The treasure long
in accumulating}.} A barrow all-ready
...
\footnote{For ‘hard-fyrdne’ (2246), B. first suggested ‘hard-fyndne,’ rendering:
\emph{A heap of treasures … so great that its equal would be hard to find}. The same
scholar suggests later ‘hord-wynne dæl’ = \emph{A deal of treasure-joy}.}Ponderous deal of the treasure of nobles,

25
Of gold that was beaten, briefly he spake then:\footnote{Some read ‘fec-word’ (2247), and render: \emph{Banning words uttered}.}

\emph{The ring-giver bewails
the loss of
retainers.}
...
Widely beheld him. ’Tis said that he looks for\footnote{An earlier reading of H.’s gave the following meaning to this passage:
\emph{He is said to inhabit a mound under the earth, where he, etc.} The translation
...
Begged of his liegelord. Then the hoard\footnote{The repetition of ‘hord’ in this passage has led some scholars to suggest
new readings to avoid the second ‘hord.’ This, however, is not under the
main stress, and, it seems to me, might easily be accepted.} was discovered,

The treasure was taken, his petition was granted

\emph{The hero plunders
the dragon’s den}
...
Was seen in that desert.\footnote{The reading of H.-So. is well defended in the notes to that volume. B.
emends and renders: \emph{Nor was there any man in that desert who rejoiced in
...
would give substantially the same translation.} Yet he joyed in the battle,

Rejoiced in the conflict: oft he turned to the barrow,

Sought for the gem-cup;\footnote{‘Sinc-fæt’ (2301): this word both here and in v. 2232, t.B. renders
‘treasure.’} this he soon perceived then

\emph{The dragon perceives
that some
one has disturbed
his treasure.}
...
\xchapter{Brave Though Aged.—reminiscences.}

\emph{The dragon spits
fire.}
...
\emph{Beowulf hears of
the havoc wrought
by the dragon.}

Then straight was the horror to Beowulf published,

Early forsooth, that his own native homestead,\footnote{‘Hám’ (2326), the suggestion of B. is accepted by t.B. and other
scholars.}
...
The kinsmen of Grendel, of kindred detested.\footnote{For ‘láðan cynnes’ (2355), t.B. suggests ‘láðan cynne,’ apposition to
‘mægum.’ From syntactical and other considerations, this is a most excellent
emendation.}

\emph{Higelac’s death
recalled.}
...
’Twas the end of his earth-days; injury fatal\footnote{Gr. read ‘on feorme’ (2386), rendering: \emph{He there at the banquet a fatal
...
\xchapter{Beowulf Seeks the Dragon.—beowulf’s Reminiscences.}
...
\emph{Hrethel took me
when I was seven.}

40
Gave me treasure and feasting, our kinship remembered;

Not ever was I \emph{any} less dear to him

\emph{He treated me as
a son.}
...
\emph{[A parallel case
is supposed.]}

So to hoar-headed hero ’tis heavily crushing\footnote{‘Gomelum ceorle’ (2445).—H. takes these words as referring to Hrethel;
...
\emph{(Just) as it is sad for an old man to see his son ride young on the gallows when
...
\xchapter{REMINISCENCES (continued).—BEOWULF’S LAST BATTLE.}
...
\emph{His last salutations.}

Belovèd co-liegemen—his last salutation:

“No brand would I bear, no blade for the dragon,

Wist I a way my word-boast to ’complish\footnote{The clause 2520(2)-2522(1), rendered by ‘Wist I … monster,’ Gr.,
followed by S., translates substantially as follows: \emph{If I knew how else I might
...
Target and war-mail. The ward of the barrow\footnote{B. emends and translates: \emph{I will not flee the space of a foot from the guard
...
\emph{Wait ye here till
the battle is over.}

Earls in armor, which of \emph{us} two may better
...
\emph{Beowulf brandishes
his sword,}

The excellent battle-king first brandished his weapon,

100
The ancient heirloom, of edges unblunted,\footnote{The translation of this passage is based on ‘unsláw’ (2565), accepted by
H.-So., in lieu of the long-standing ‘ungléaw.’ The former is taken as an
adj. limiting ‘sweord’; the latter as an adj. c. ‘gúð-cyning’: \emph{The good war-king,
...
\xchapter{Wiglaf the Trusty.—beowulf Is Deserted by Friends and by Sword.}
...
\footnote{The passage ‘\emph{Brand … burnie},’ is much disputed. In the first place,
...
B. suggests ‘býwdu-scrúd’ = \emph{splendid vestments}. Nor is ‘bám’ accepted by all,
‘béon’ being suggested. Whatever the individual words, the passage must
mean, “\emph{I intend to share with him my equipments of defence}.”}Shield-cover, burnie.” Through the bale-smoke he stalked then,
...
\xchapter{The Fatal Struggle.—beowulf’s Last Moments.}
...
\footnote{B. renders: \emph{He} (\emph{W}.) did not regard his (\emph{the dragon’s}) \emph{head} (since
Beowulf had struck it without effect), \emph{but struck the dragon a little lower down.—}One
crux is to find out \emph{whose head} is meant; another is to bring out the
antithesis between ‘head’ and ‘hand.’}He his head did not guard, but the high-minded liegeman’s
...
Earl-thane in armor, that \emph{in} went the weapon

Gleaming and plated, that ’gan then the fire\footnote{‘Þæt þæt fýr’ (2702), S. emends to ‘þá þæt fýr’ = \emph{when the fire began to
grow less intense afterward}. This emendation relieves the passage of a
plethora of conjunctive \emph{þæt}’s.}
...
They had felled the enemy (life drove out then\footnote{For ‘gefyldan’ (2707), S. proposes ‘gefylde.’ The passage would read:
\emph{He felled the foe (life drove out strength), and they then both had destroyed him,
...
‘e(a)llne.’—The reading ‘\emph{life drove out strength}’ is very unsatisfactory and
very peculiar. I would suggest as follows: Adopt S.’s emendation, remove
H.’s parenthesis, read ‘ferh-ellen wræc,’ and translate: \emph{He felled the foe,
drove out his life-strength} (that is, made him \emph{hors de combat}), \emph{and then they
both, etc}.}
...
\xchapter{Wiglaf Plunders the Dragon’s Den.—beowulf’s Death.}

\emph{Wiglaf fulfils his
lord’s behest.}
...
Gold on the sea-bottom, turn into vanity\footnote{The word ‘oferhígian’ (2767) being vague and little understood, two
quite distinct translations of this passage have arisen. One takes ‘oferhígian’
as meaning ‘to exceed,’ and, inserting ‘hord’ after ‘gehwone,’ renders: \emph{The
...
The brightest of beacons;\footnote{The passage beginning here is very much disputed. ‘The bill of the old
...
\emph{sheathed in brass}.} the bill had erst injured
...
\xchapter{The Dead Foes.—wiglaf’s Bitter Taunts.}

\emph{Wiglaf is sorely
grieved to see his
...
The will of the Wielder; the World-Ruler’s power\footnote{For ‘dædum rædan’ (2859) B. suggests ‘déað árædan,’ and renders: \emph{The
might (or judgment) of God would determine death for every man, as he still
does.}}

Would govern the actions of each one of heroes,

\emph{Wiglaf is ready to
excoriate them.}
...
\emph{Surely our lord
wasted his armor
on poltroons.}

That he wildly wasted his war-gear undoubtedly

When battle o’ertook him.\footnote{Some critics, H. himself in earlier editions, put the clause, ‘When …
him’ (A.-S. ‘þá … beget’) with the following sentence; that is, they make it
dependent upon ‘þorfte’ (2875) instead of upon ‘forwurpe’ (2873).} The troop-king no need had
...
\xchapter{The Messenger of Death.}

\emph{Wiglaf sends the
news of Beowulf’s
death to liegemen
near by.}
...
Head-watch holdeth o’er heroes unliving,\footnote{‘Hige-méðum’ (2910) is glossed by H. as dat. plu. (= for the dead). S.
proposes ‘hige-méðe,’ nom. sing. limiting Wigláf; i.e. \emph{W., mood-weary, holds
...
\xchapter{The Messenger’s Retrospect.}
...
The worthy one went then\footnote{For ‘góda,’ which seems a surprising epithet for a Geat to apply to the
“terrible” Ongentheow, B. suggests ‘gomela.’ The passage would then
stand: ‘\emph{The old one went then,’ etc.}} with well-beloved comrades,
...
To the braves of the Swedemen, the banner\footnote{For ‘segn Higeláce,’ K., Th., and B. propose ‘segn Higeláces,’ meaning:
\emph{Higelac’s banner followed the Swedes (in pursuit).}—S. suggests ‘sæcc Higeláces,’
and renders: \emph{Higelac’s pursuit.}—The H.-So. reading, as translated in
our text, means that the banner of the enemy was captured and brought to
Higelac as a trophy.} to Higelac.
...
\emph{His gifts were beyond
cavil.}

None upon mid-earth needed to twit him\footnote{The rendering given in this translation represents the king as being generous
...
The deed-mighty Scyldings,\footnote{The name ‘Scyldingas’ here (3006) has caused much discussion, and given
...
(3) M. considers 3006 a thoughtless repetition of 2053. (Cf. H.-So.)} did for the troopers

What best did avail them, and further moreover

\emph{It is time for us to
pay the last marks
of respect to our
lord.}
...
65
And \emph{that} one carry on journey to death-pyre
...
Fifty of feet; came forth in the night-time\footnote{B. takes ‘nihtes’ and ‘hwílum’ (3045) as separate adverbial cases, and
renders: \emph{Joy in the air had he of yore by night, etc}. He thinks that the idea of
...
\emph{God alone could
give access to it.}

\footnote{The parenthesis is by some emended so as to read: (1) (\emph{He} (i.e. \emph{God})
\emph{is the hope of men}); (2) (\emph{he is the hope of heroes}). Gr.’s reading has no
parenthesis, but says: … \emph{could touch, unless God himself, true king of victories,
gave to whom he would to open the treasure, the secret place of enchanters,
etc}. The last is rejected on many grounds.}(He is earth-folk’s protector) to open the treasure,

E’en to such among mortals as seemed to Him proper.

\xchapter{XLII.}

\xchapter{Wiglaf’s Sad Story.—the Hoard Carried Off.}

Then ’twas seen that the journey prospered him little

Who wrongly within had the ornaments hidden\footnote{For ‘gehýdde,’ B. suggests ‘gehýðde’: the passage would stand as above
...
5
Was hotly avengèd. ’Tis a wonder where,\footnote{The passage ‘Wundur … búan’ (3063-3066), M. took to be a question
...
question introduced by ‘hwár’ and dependent upon ‘wundur’: \emph{A secret is it
when the hero is to die, etc}.—Why may the two clauses not be parallel, and
the whole passage an Old English cry of ‘\emph{How wonderful is death!’?}—S.’s
...
Punished with plagues, who this place should e’er ravage.\footnote{For ‘strude’ in H.-So., S. suggests ‘stride.’ This would require ‘ravage’
(v. 16) to be changed to ‘tread.’}

He cared not for gold: rather the Wielder’s

Favor preferred he first to get sight of.\footnote{‘He cared … sight of’ (17, 18), S. emends so as to read as follows:
\emph{He (Beowulf) had not before seen the favor of the avaricious possessor.}}

\emph{Wiglaf addresses
his comrades.}
...
Been gained very grimly; too grievous the fate that\footnote{B. renders: \emph{That which drew the king thither} (i.e. \emph{the treasure}) \emph{was
granted us, but in such a way that it overcomes us.}}

The prince of the people pricked to come thither.

30
\emph{I} was therein and all of it looked at,

The building’s equipments, since access was given me,

Not kindly at all entrance permitted

\emph{He tells them of
Beowulf’s last
moments.}
...
\footnote{‘Folc-ágende’ (3114) B. takes as dat. sing. with ‘gódum,’ and refers it to
Beowulf; that is, \emph{Should bring fire-wood to the place where the good folk-ruler
lay}.}Leaders of liegemen, should look for the good one

55
With wood for his pyre: “The flame shall now swallow

(The wan fire shall wax\footnote{C. proposes to take ‘weaxan’ = L. ‘vescor,’ and translate \emph{devour}. This
gives a parallel to ‘fretan’ above. The parenthesis would be discarded and
the passage read: \emph{Now shall the fire consume, the wan-flame devour, the
prince of warriors, etc}.}) the warriors’ leader
...
\xchapter{The Burning of Beowulf.}
