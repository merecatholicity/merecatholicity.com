% St. Thomas Aquinas, Summa Theologica -- The Third Part. The Benziger
...
\urlstyle{same}
\hypersetup{pdftitle={Summa Theologica -- The Third Part},pdfauthor={St. Thomas Aquinas}}
\linespread{1.06}
...
\vspace{1.5em}
{\Large\color{subhead} The Third Part\par}
\vspace{2.5em}
