...
domestic, and those who compose it are called by Charondas \emph{homosipuoi},
and by Epimenides the Cretan \emph{homokapnoi}; but the society of many
...
called these formerly not \emph{psiditia} but \emph{andpia}, as the
...
those of Crete, who are called \emph{kosmoi}; with this difference only,
...
their armies was given to the \emph{kosmoi}. Every one also has a vote in
their public assembly; but this has only the power of confirming what has
already passed the council and the \emph{kosmoi}.
...
The institution of the \emph{kosmoi}, was still worse than that of the
...
among the Cretans the \emph{kosmoi} are not chosen out of the people in
general, but out of some certain families, and the senate out of the \emph{kosmoi}.
...
of a well-constituted government, as the \emph{kosmoi} have no opportunity
...
turn out the \emph{kosmoi}. They are also permitted to resign their office
...
is that which in ancient Greece they called \emph{aesumnetes}; which is
...
the example of GOD Himself, \emph{who is completely happy, not from any
external good, but in Himself, and because such is His nature\emph{. For good
