\xchapter{Letters Gaius Plinius Caecilius Secundus}

\xsection{I — To SEPTITTUS}
...
\xsection{III — To VOCONIUS ROMANUS}
...
of the position in which Rusticus Arulenus\footnote{A pupil and intimate friend
of Paetus Thrasea, the distinguished Stoic philosopher. Arulenus was put
to death by Domitian for writing a panegyric upon Thrasea.} stood, but had exulted in
his death; insomuch that he actually recited and published a libel upon
his memory, in which he styles him ``The Stoics' Ape'': adding, ``stigmated\footnote{The impropriety of this
...
his own tongue. M.} with
the Vitellian scar.''\footnote{An allusion to a wound he
had received in the war between Vitellius and Vespasian.} You recognize Regulus' eloquent strain! \footnote{A brother of Piso Galba's
adopted son. He was put to death by Nero.}\\
\footnote{Sulpicius Camerinus, put to
death by the same emperor, upon some frivolous charge.}\\
\footnote{A select body of men who
...
ought not to be deceived by me. I am waiting for Mauricus'\footnote{Junius Mauricus, the
brother of Rusticus Arulenus. Both brothers were sentenced on the same
day, Arulenue to execution and Mauricui to banishment.} return''
...
courted\footnote{There seems to have been a
...
\xsection{IV — To CORNELIUS TACITUS}
...
\xsection{V — To POMPEIUS SATURNINUS}
...
speech was delivered not before the people, but the Decurii;\footnote{The Decurii were a sort of
senators in the municipal or corporate cities of Italy. M.} not in
...
however, with naming only Euphrates\footnote{``Euphrates was a native
...
Smith's Dict. of Greek and Roman Biog.} the philosopher. I
...
\xsection{VIII — To CALESTRIUS TIRO}
...
being informed that Nonianus\footnote{A pleader and historian
of some distinction, mentioned by Tacitus, Ann. XIV. 19, and by
Quintilian, X, I, 102.} was reciting a composition of his, went
...
\xsection{XI — To SEPTITIUS CLARUS}
...
\xsection{XII — To SUETONIUS TRANQUILLUS}
...
and particular favourites of Cæsar;\footnote{Domitian} any of which
...
And asks no omen but his country's cause.''\footnote{Iliad, XII. 243. Pope.}
...
\xsection{XIII — To ROMANUS FIRMUS}
...
thousand sesterces;\footnote{Equal to about \$4,000 of
our money. After the reign of Augustus the value of the sesterces.} but that we may also have the satisfaction of
seeing you a Roman Knight,\footnote{``The equestrian dignity,
...
in note. M.} I present you with three hundred thousand, in
...
\xsection{XIV — to Cornelius Tacitus}
...
usually has recourse to authorities, and produces Lysias\footnote{An elegant Attic orator,
...
In return, I name Demosthenes, Aeschines, Hyperides,\footnote{A graceful and powerful
orator, and friend of Densosthenes.} and many others, in
opposition to Lysias; while I confront Cato and the Gracchi with Cæsar,
Pollio,\footnote{A Roman orator of the
Augustan age. He was a poet and historian as well, but gained most
distinction as an orator.}
Caelius,\footnote{A man of considerable
...
attended as an assessor.\footnote{The praetor was assisted
by ten assessors, five of whom were senators, and the rest knights. With
these he was obliged to consult before he pronounced sentence. M.} Upon those occasions, I have ever found the
...
Eupolis,\footnote{A contemporary and rival
of Aristophanes.}
...
Another comic poet,\footnote{Thersites. Iliad, II. V.
212.} speaking of the same orator, says:
...
would not be understood to approve that everlasting talker\footnote{Ulysses. Iliad, III. V.
222.}
...
Not but that I extremely admire him,\footnote{Menelaua. Iliad, III. V.
214.} too, of whom the poet
says,
...
\xsection{XVI — To CATILIUS SEVERUS}

\footnote{Great-grandfather of the
Emperor M. Aurelius.}

I AM at present (and have been a considerable time) detained in Rome,
under the most stunning apprehensions. Titus Aristo,\footnote{An eminent lawyer of
Trajan's reign.} whom I have a singular
...
or porticoes\footnote{The philosophers used to
hold their disputations in the gymnasia and porticoes, being places of the
most public resort for walking, \&c. M.} nor does he amuse his own and others' leisure
...
\xsection{XVII — To VOCONIUS ROMANUS}
...
of consul, that he might at least be the highest of subjects, who\footnote{``Verginius Rufus was
...
Smith's Dict. of Greek and Rom. Biog., \&c.)} had
...
and to the bar. The consul Cornelius Tacitus\footnote{The historian,} pronounced his funeral
...
the sacred office\footnote{Namely, of augurs. ``This
...
for that office.'' Middleton's Life of Cicero, I. 547. M.} he constantly proposed me. Even in his last
...
freedmen and ours. My neighbour,\footnote{The ancient Greeks and
...
over upon his left side, leaning on the elbow.} reclining next me,
...
forcibly restored the king of the Bructeri\footnote{A people of Germany.} to his throne; and this
...
their manners. As for himself, he lately held the post of flamen.\footnote{``Any Roman priest devoted
...
as I have lately obtained for him from our most gracious prince\footnote{Trajan.} the
privilege\footnote{By a law passed A. D.
...
hired to cheer somebody or other, at three denarii apiece:\footnote{About 54 cents.}
...
garden, and the gestatio,\footnote{Avenue} running round the garden. The gestatio is
...
transparent\footnote{``Windows made of a
...
Saturnalia,\footnote{A feast held in honour of
...
and fro, of the speaker, the body working\footnote{Cicero and Quintilian
...
deciamassett.'' How many miles he had declaimed. M.} in harmony with every
...
remarkable accomplishments, purposing to execute her will,\footnote{This was an act of great
...
omens to know how soon he should be worth sixty millions of sesterces,\footnote{\$3,350,000.} he
...
\xsection{XXVII — To BAEBIUS MACER}
...
``The Life of Pomponius Secundus,''\footnote{A poet to whom Quintilian
...
high appreciation (Annals, v. 8).} in two volumes.
...
Nero\footnote{Stepson of Augustus and
...
has completed the history which Aufidius Bassus\footnote{A historian under
...
often at twelve.\footnote{The distribution of time
...
which they constantly bathed, and from thence went to supper. M.} He was a most ready sleeper, insomuch that he
...
hundred thousand sesterces,\footnote{\$16,000.} and then there were not so many of them. When
...
\xsection{XXVIII — To ANNIUS SEVERUS}
...
\xsection{XXIX — To CANINIUS RUFUS}

I HAVE just been informed that Silius Italicus\footnote{Born about A. D. 25. He
...
Africanus. See Smith's Dict. of Gr. and Roin. Biog.} has starved himself to
...
Campania, from whence even the accession of the new emperor\footnote{Trajan.}
...
\xsection{XXX — To SPURINNA AND COTTIA}

\footnote{Spurinna's wife.}
...
\xsection{XXXI — To JULIUS GENITOR}
...
philosophers were expelled from Rome,\footnote{Domitian banished the
...
the celebrated Epictetus. M.} I visited him at his
...
\xsection{XXXII — To CATILIUS SEVERUS}
...
confess it was a brave action\footnote{The following is the
...
relates. M.} in her to draw the steel, plunge it into her
...
\xsection{XXXV — To SEVERUS}

I WAS obliged by my consular office to compliment the emperor\footnote{Trajan.} in
...
\xsection{XXXVI — To CALVISIUS RUFUS}
...
these will be good ones; for I keep no fettered slaves\footnote{The Roman, used to employ
...
must know, is three millions of sesterces.\footnote{About \$500,000.} It has formerly gone
over five millions,\footnote{About \$800,000.} but owing, partly to the general hardness of
...
\xsection{XXXVII — To CORNELIUS PRISCUS}
...
whom he directs to go to my house upon the Esquiline,\footnote{One of the famous seven
hills upon which Rome was situated.} but to approach it with
respect.
...
Catos might read my frolic lay.''\footnote{Mart. LX. 19.}
...
\xsection{XXXVIII — To FABATUS (HIS WIFE'S GRANDFATHER)}

You have long desired a visit from your grand-daughter\footnote{Calpurnia, Pliny's wife.}
...
called Tifernum-upon-the-Tiber,\footnote{Now Citta di Castello.} which, with more affection than wisdom, put
...
\xsection{XXXIX — To ATTIUS CLEMENS}
...
father. Regulus gave him his freedom,\footnote{The Romans had an
absolute power over their children, of which no age or station of the
latter deprived them.} in order to entitle him
...
\xsection{XLI — To MATURUS ARRIANUS}

Mv advancement to the dignity of augur\footnote{Their business was to
...
Kennet's Ron,. Antig. M.} is an honour that
...
approbation of so wise and discreet a prince,\footnote{Trajan.} but because it is
...
\xsection{XLII — To STATIUS SABINUS}
...
slave.\footnote{A slave was incapable of
...
\xsection{XLIII — To CORNELIUS MINICIANUS}

\footnote{``Their office was to
...
influence of whose sacred functions he has conquered and triumphed?''\footnote{It was usual with
...
``She took great care to fall with decency.''\footnote{Euripides' Hecuba,}

Celer likewise, a Roman knight, who was accused of an intrigue with her,
while they were scourging him with rods\footnote{The punishment inflicted
upon the violators of Vestal chastity was to be scourged to death. M.} in the Forum, persisted
...
regarding too his daughter\footnote{Calpurnia, Pliny's wife.} as your child, not only shewing her an aunt's
...
\xsection{XLVII — To ROMATIUS FIASIUS}
...
\xsection{XLVIII — To LICINIUS SURA}
...
\xsection{XLIX — To ANNIUS SEVERUS}
...
friendship of Gratilla and Rusticus\footnote{Gratilla was the wife of
...
friend of those who were obnoxious to him. M.} might be extremely
...
ready for his work, and with his desk,\footnote{In the original,
scrinium, box for holding MSS.} as usual, in front of
...
\xsection{LII — To DOMITIUS APOLLINARIS}
...
boundary to the hippodrome\footnote{The hippodromus, in its
...
so called. M.} alters its shape at the farther end, bending
...
Tusculum, Tiber, and Praeneste.\footnote{Now called Frascati,
Tivoli, and Palestrina, all of them situated in the Campagna di Roma, and
at no great distance from Rome. M.} Besides the advantages already mentioned, I
...
four hundred thousand sesterces.\footnote{About \$15,000.} This bequest, in the
...
eleven hundred thousand sesterces\footnote{About \$42,000.} out of my own
...
images\footnote{None had the right of
...
account I sent him into Egypt;\footnote{The Roman physicians used
to send their patients in consumptive cases into Egypt, particularly to
Alexandria. M.} from whence, after a long absence, belately
...
blood. For this reason I intend to send him to your farm at Forum-Julii,\footnote{Frejus, in Provence, the
...
\xsection{LVII — To RUFUS}

I WENT into the Julian\footnote{A court of justice
erected by Julius Cæsar in the forum, and opposite to the basilica
Aemilia.} court to hear those lawyers to whom,
according to the last adjournment, I was to reply. The judges had taken
their seats, the decemviri\footnote{The deceniviri seem to
...
were something in the nature of our juries. M.} were arrived, the eyes of the audience were
...
his right or left eye,\footnote{This silly piece of
...
mention in antiquity. M.} and wearing a white patch\footnote{``We gather from Martial
...
To touch thy head no impious hand shall dare.''\footnote{Hom. II. lib, I. V. 88.}
...
\xsection{LXII — To ALBINUS}

I WAS lately at Alsium,\footnote{Now Alzia, not far from
Corno.} where my mother-in-law has a villa which once
...
wits, you must know, are reckoned rather unsound,\footnote{Nevertheless, Javolentis
Priscus was one of the most eminent lawyers of his time, and is frequently
quoted in the Digesta of Justinian.} though he takes a share
...
that time with the fleet under his command at Misenum.\footnote{In the Bay of Naples.} On
...
just taken a turn in the sun\footnote{The Romans used to lie or
...
circumstances of an over-refined delicacy. M.} and, after bathing himself in cold water, and
...
then at Stabiae,\footnote{Now called Castelamare,
in the Bay of Naples. M.} separated by a bay, which the sea, after
...
\xsection{LXVI — To CORNELIUS TACITUS}
...
night of which we have heard had come upon the world.\footnote{The Stoic and Epicurean
...
gods themselves from the destruction of this general conflagration. M.} Among these there were
...
person of conspicuous or obscure rank. I was sailing lately upon our lake,\footnote{The lake Larius.}
...
\xsection{LXVIII — To SERVIANUS}

I AM extremely glad to hear that you intend your daughter for Fuscus
Salinator, and congratulate you upon it. His family is patrician,\footnote{Those families were
styled patrician whose ancestors had been members of the senate in the
earliest times of the regal or consular government. M.} and
...
\xsection{LXIX — To SEVERUS}

You desire me to consider what turn you should give to your speech in
honour of the emperor,\footnote{Trajan} upon your being appointed consul elect.\footnote{The consuls, though they
...
government, they were chosen. M.} It
...
Your Camillian villa\footnote{So called, because it
formerly belonged to Camillus. M.} in Campania has suffered by the injuries of
...
\xsection{LXXI — To CORNELIANUS}

I RECEIVED lately the most exquisite satisfaction at Centumcellae\footnote{Civita Vecchia.}
(as it is now called), being summoned thither by Cæsar\footnote{Trajan.}
...
she had stained her own good name and his by an intrigue with a centurion.\footnote{An officer in the Roman
...
to the punishment directed by the Julian law.\footnote{This law was made by
Augustus Cæsar; but it nowhere clearly appears what was the peculiar
punishment it inflicted. M.} The emperor thought
...
freedman and procurator.\footnote{An officer employed by
the emperor to receive and regulate the public revenue in the provinces.
M.} The heirs jointly petitioned the emperor,
when he was in Dacia,\footnote{Comprehending
Transylvania, Moldavia, and Walaehia. M.} that he would reserve to himself the trial
...
nobly replied, ``He is not Polycletus,\footnote{Polycletus was a
freedman, and great favourite of Nero. M.} nor am I Nero.''
...
as calumniators.\footnote{Memmius, or Rhemmius
...
proved. M.} Thus you see how usefully and seriously we
...
its great author,\footnote{Trajan.} and will prove of infinite benefit, by
affording a secure retreat to ships on that extensive and dangerous coast.
Farewell.

\xsection{LXXII — To MAXIMUS}
...
abated, and I had been anointed,\footnote{Unction was much
...
\&c. Celsi Med. ed. Aliucloveen, p. 88. M.} my physician offered
...
Cæsar,\footnote{Trajan.}
and to several of the leading men in Rome, and also to us, the advocates
for Varenus. Magnus,\footnote{One of the Bithynians
employed to manage the trial. M.} nevertheless, whom I mentioned in my last
...
\xsection{LXX VII — To FABATUS (HIS WIFE'S GRANDFATHER)}
...
sesterces\footnote{About \$28,000.} for the whole. And as you think it might
have fetched nine hundred thousand,\footnote{About \$26,000.} you are so much the
...
anything in his writings, used to say, ``I appeal\footnote{There is a kind of
...
applies to a different purpose. M.} to the people''; and
...
at what he told me the last time the Pontifical games\footnote{The priests, as well as
...
Cassius,\footnote{A famous lawyer who
...
let or sold. It happened that Athenodorus\footnote{A Stoic philosopher and
native of Tarsus. He was tutor for some time to Octavius, afterwards
Augustus, Cæsar.} the philosopher came
...
be guilty of an excess\footnote{Balzac very prettily
observes: ``Il y a des riviere: qui ne font jamais tact de bien que quand
elles se dibordent; de eneme, l'amitie n'a mealleur quo l'exces.'' M.} in friendship, Farewell.

\xsection{LXXXV — To TACITUS}
...
\xsection{LXXX VI — To SEPTITIUS}

I HAD a good journey here, excepting only that some of my servants were
upset by the excessive heat. Poor Encolpius, my reader,\footnote{Persons of rank and
...
from rectitude is equally criminal,\footnote{It was a doctrine
maintained by the Stoics that all crimes are equal M.} every approach to it
...
therefore, whose purchase amounted to more than ten thousand sesterces,\footnote{About \$400.}
...
value of fifteen thousand sesterces,\footnote{About \$600.} I remitted to him
one-eighth part of that whole sum, and likewise one-tenth of five
thousand.\footnote{About \$93.} Besides this, as several had deposited, in
...
``The brave and mean an equal honour find.''\footnote{Hom. II. lib. IX. V.
319.}

Farewell.

\xsection{LXXX VIII — To ROMANUS}
...
Because the tyranny of former reigns,\footnote{Those of Nero and
Domitian. M.} as it introduced a
...
employing it occurs. Hence it was that Liberty, on her return\footnote{When Nerva and Trajan
...
the other, that I have allowed them to make a kind of will,\footnote{A slave could acquire
...
grandfather desired I would look over his estate near Ameria.\footnote{Now called Amelia, a
town in Ombria. M.}
As I was walking over his grounds, 1 was shown a lake that lies below
them, called Vadirnon,\footnote{Now Laghetto di
Bassano. M.} about which several very extraordinary
...
by the administration of the quaestorship in Bithynia,\footnote{A province in Anatolia,
or Asia Minor. M.}
...
pretence of reason for it. But it is the dress\footnote{The performers at these
...
lost their lives. M.} they like; it is the
...
employment. They are both situated like those at Baiae:\footnote{Now called Castello di
...
touches it. The first, supported as it were by the lofty buskin,\footnote{The buskin was a kind
...
Lugdunum,\footnote{Lyons.} I am so much the more pleased to learn that
...
follies in which we fondly indulge ourselves?''\footnote{He was accused of
...
\xsection{CI — To QUADRATUS}

THE pleasure and attention with which you read the vindication I published
of Helvidius,\footnote{Helvidius.} has greatly raised your curiosity, it
...
lay violent hands upon a member\footnote{Upon the accession of
Nerva to the empire, after the death of Domitian. M.} of that body, one of
...
though I was at that time under great affliction for the loss of my wife,\footnote{Our authors first wife;
...
order of the day.''\footnote{It is very remarkable
...
he came to the point in question. Aul. Gell. IV. C. 10. M.} I replied, ``You must allow me a liberty
...
``'All I've foreseen, and oft in thought revolv'd;\footnote{Aeneid, LIB. VI. V.
105.} and am willing, if
...
moderation which those excellent women\footnote{Arria and Fannia.} had set, who
...
on, ``I entreat you, conscript fathers,''\footnote{The appellation by
which the senate was addressed. M.} said he, ``not to
oblige me to implore the assistance of the tribunes.''\footnote{The tribunes were
...
Those younger champions will thy strength o'ercome.''\footnote{Diomed's speech to
...
obliged,'' said I, ``to renounce, under a virtuous prince,\footnote{Nerva.}
that reward he received from an infamous one!''\footnote{Domitian; by whom he
had been appointed consul elect, though he had not yet entered upon that
office. M.} Some time after I
...
mummers, and wanton prostitutes, who were dancing about round the tables.\footnote{These persons were
...
\xsection{CV — To SABINIANUS}

I GREATLY approve of your having, in compliance with my letter,\footnote{See letter CIII.}
...
And wide beneath them groans the rending ground.''\footnote{Iliad, XXI. 387. Pope.
M.}

Again,

``Reclin'd on clouds his steed and armour lay.''\footnote{Iliad, V. 356, speaking
...
Demosthenes\footnote{The design of Pliny in
...
cannot, perhaps, he preserved in an English translation. M.} himself, that model and standard of true
...
actions,'' \&c.\footnote{See 1st Philippic.} — But what can be more daring and
...
against you,'' \&c.\footnote{See Demosthenes' speech
in defence of Cteisphon.} — The subsequent stricture is of the
...
ever so inconsiderable, has overthrown and destroyed all,'' \&c.\footnote{See end Olynthiac.}—So
...
the orator.''\footnote{See Aesehines' speech
against Ctesiphon.}—And in another place: ``He afterwards
...
superstition, poured some ointment\footnote{It was a religious
...
solemnity of a sacred unction. M.} over him as he lay
...
catastrophe!\footnote{The overflowing
...
Ulysses weeping over his faithful dog Argus, when he expires at his feet:} and how will your genius adorn and heighten
...
sake of strengthening my voice as my digestion;\footnote{By the regimen which
...
debet; post lectionem ambulare,'' \&c. Celsi Medic. 1. I. C. 8. M.} though indeed the
...
\xchapter{Correspondence with the Emperor Trajan}

\xsection{I — to the Emperor Trajan}
...
the helm of the commonwealth which had already shared in the steerage.\footnote{Nerva, who succeeded
...
\xsection{II — To THE EMPEROR TRAJAN}
...
\xsection{III — To THE EMPEROR TRAJAN}
...
advanced, in the manner the law directs, the liberal gift\footnote{\$16,000.}
...
\xsection{IV — To THE EMPEROR TRAJAN}
...
\xsection{VI — To THE EMPEROR TRAJAN}
...
\xsection{VII — To THE EMPEROR TRAJAN}
...
\xsection{IX — To THE EMPEROR TRAJAN}
...
belongs to the district of Memphis.\footnote{One of the four
governments of Lower Egypt. M.} I entreat you
...
\xsection{X — To THE EMPEROR TRAJAN}
...
their patrons.\footnote{The extensive power
...
\xsection{XI — To THE EMPEROR TRAJAN}
...
thousand sesterces,\footnote{Pliny enjoyed the
...
their posts by monthly turns. Buchner. M.} the time for dressing the vineyards is
approaching, and that business must fall upon my new tenants.\footnote{About \$16,000; the
...
private affairs, if you will be pleased to grant me leave of absence\footnote{The senators were not
...
\xsection{XIII — To THE EMPEROR TRAJAN}

\footnote{One of the seven
...
\xsection{XIV — To THE EMPEROR TRAJAN}
...
province\footnote{Bithynia, a province
...
administration of that province. M.} partly in light vessels, and partly in
post-chaises: for as the excessive heats will prevent my travelling
altogether by land, so the Etesian winds,\footnote{A north wind in the
...
blow only in the day-time. Varenius's Geogr. V.I. p. 513. M.} which are now set
in, will not permit me to proceed entirely by sea.

\xsection{XV — Trajan to Pliny}
...
\xsection{XVI — To THE EMPEROR TRAJAN}
...
examining the finances of the Prusenses,\footnote{The inhabitants of
Prusa (Brusa), a principal city of Bithynia.} their expenses,
...
September,\footnote{In the sixth year of
Trajan's reign, A. D. 103, and the 41st of our author's age: he continued
in this province about eighteen months. Vid. Mass, in Vit. Phin. 129. M.} and found in it that obedience and
...
inspect those works\footnote{Among other noble
...
was erected the famous pillar which has been already described.} which I am carrying on at Rome, and in
...
\xsection{XVIII — To THE EMPEROR TRAJAN}
...
\xsection{XIX — To THE EMPEROR TRAJAN}
...
with additional lustre.\footnote{It is probable the
...
\xsection{XX — To THE EMPEROR TRAJAN}

Mv lieutenant, Servilius Pudens, came to Nicomedia,\footnote{The capital of
Bithynia; its modern name is Izmid.} Sir, on the 24th
of November, and by his arrival freed me, at length, from the anxiety of a
very uneasy expectation.

\xsection{XXI — To THE EMPEROR TRAJAN}
...
\xsection{XXII — To THE EMPEROR TRAJAN}
...
\xsection{XXIII — To THE EMPEROR TRAJAN}

I RECEIVED, Sir, a dispatch from your freedman, Lycormas, desiring me, if
any embassy from Bosporus\footnote{The town of
Panticapoeum, also called Bosporus, standing on the European side of the
Cimmerian Bosporus (Straits of Kaffa), in the modern Crimea.} should come here on the way to Rome, that
I would detain it till his arrival. None has yet arrived, at least in the
city\footnote{Nicea (as appears by
...
Sarmatia,\footnote{Sarmatia was divided
...
\&c. M.} I embrace the opportunity which
...
\xsection{XXIV — To THE EMPEROR TRAJAN}
...
you, I granted him an order to make use of the public post.\footnote{The first invention
...
\xsection{XXV — To THE EMPEROR TRAJAN}
...
\xsection{XXVI — To THE EMPEROR TRAJAN}
...
for refuge to your statue;\footnote{Particular temples,
...
an edict. See Lipsii Excurs. ad Taeiti Ann. III, C. 36, M.} that, being brought before a magistrate,
he declared he, was formerly slave to Laberius Maximus, but being taken
prisoner by Susagus\footnote{General under
Deeebalus, king of the Dacians. M.} in Moesia,\footnote{A province in Daeia,
comprehending the southern parts of Servia and part of Bulgaria. M.} he was sent as a
...
which reason I thought it necessary to send\footnote{The second expedition
...
made of him in favour of that design, M.} him to you. This
...
\xsection{XXVII — To THE EMPEROR TRAJAN}

YOUR freedman and procurator,\footnote{Receiver of the
finances. M.} Maximus, behaved,
...
\xsection{XXVIII — To THE EMPEROR TRAJAN}

AFTER having experienced, Sir, in Gabius Bassus, who commands on the
Pontic\footnote{The coast round the
Black Sea.} coast, the greatest integrity, honour,
...
\xsection{XXIX — To THE EMPEROR TRAJAN}

NYMPHIDIUS Lupus,\footnote{The text calls him
...
legion. M.} Sir, and myself, served in the army
...
\xsection{XXX — To THE EMPEROR TRAJAN}

I BEG your determination, Sir, on a point I am exceedingly doubtful about:
it is whether I should place the public slaves\footnote{Slaves who were
purchased by the public. M.} as sentries round
...
\xsection{XXXII — To THE EMPEROR TRAJAN}
...
your order that he should retain only ten beneficiary\footnote{The most probable
...
\xsection{XXXIII — Trajan to Pliny}
...
\xsection{XXXIV — To THE EMPEROR TRAJAN}
...
\xsection{XXXVI — To THE EMPEROR TRAJAN}
...
proper he should retain, especially as he was going into Paphlagonia,\footnote{A province in Asia
...
\xsection{XXX VII — Trajan to Pliny}
...
lost great numbers in the civil wars. Pun. Hist. Nat. XXXIII. 10. M.} among the recruits, has sent them to me.
...
\xsection{XXXIX — Trajan to Pliny}
...
\xsection{XL — To THE EMPEROR TRAJAN}
...
either to the mines, the public games,\footnote{A punishment among
...
\xsection{XLII — To THE EMPEROR TRAJAN}
...
city was not furnished with either engines, \footnote{It has been generally
...
fountains at Tuscum is likewise another evident proof. M.}buckets, or any single
...
\xsection{XLIII — Trajan to Pliny}
...
\xsection{XLIV — To THE EMPEROR TRAJAN}

WE have acquitted, Sir, and renewed our annual vows\footnote{This was an
...
\xsection{XLVI — To THE EMPEROR TRAJAN}

THE citizens of Nicomedia, Sir, have expended three millions three hundred
and twenty-nine sesterces\footnote{About \$132,000.} in building an aqueduct; but, not being
able to finish it, the works are entirely falling to ruin. They made a
second attempt in another place, where they laid out two millions.\footnote{About \$80,000.}
...
\xsection{XLVII — Trajan to Pliny}
...
\xsection{XLVIII — To THE EMPEROR TRAJAN}
...
examined the account myself), above ten millions of sesterces;\footnote{About \$400,000. To
...
to erect the portico, others the galleries over the pit:\footnote{The word carte, in
...
upon a far more enlarged plan, the gymnasium,\footnote{A place in which the
athletic exercises were performed, and where the philosophers also used to
read their lectures. M.} which was burnt
...
walls, although twenty-two feet\footnote{The Roman foot
consisted of 11.71 inches of our standard, M.} in thickness, are
...
brickwork. Also the inhabitants of Claudiopolis\footnote{A colony in the
district of Cataonia, in Cappadocia.} are sinking (I
...
ready to pay whenever I call upon them) for their admission.\footnote{The honorary
...
be annexed shall be finished. — These paltry Greeks\footnote{``Graeculi. Even under
...
\xsection{L — To THE EMPEROR TRAJAN}
...
former is higher by forty cubits,\footnote{A Roman cubit is
equal to a foot 5.406 inches of our measure. Arbuthanot's Tab. M.} I find there is
...
\xsection{LII — To THE EMPEROR TRAJAN}
...
thousand sesterces.\footnote{About \$480.} But knowing the generous maxims of your
...
is likewise taxed with the sum of three thousand sesterces\footnote{About \$120.}
...
\xsection{LIV — To THE EMPEROR TRAJAN}

I BEG, Sir, you would settle a doubt I have concerning your diplomas;\footnote{A diploma is properly
...
\xsection{LVI — To THE EMPEROR TRAJAN}

UPON intimating, Sir, my intention to the city of Apamea,\footnote{A city in Bithynia.
M.}
...
\xsection{LVIII — To THE EMPEROR TRAJAN}
...
ancient temple dedicated to the mother of the gods.\footnote{Cybele, Rhea, or Ops,
as she is otherwise called; from whom, according to the pagan creed, the
rest of the gods are supposed to have descended. M.} This fabric must
...
consecrated according to our rites may be removed,[1040b] consistently
...
foreign city [1041b] is not capable of receiving that kind
of consecration which is sanctified by our laws.

\xsection{LX — To THE EMPEROR TRAJAN}
...
\xsection{LXII — To THE EMPEROR TRAJAN}
...
the public [1042b] (especially at 12 per cent, interest)
...
\xsection{LXIII — Trajan to Pliny}
...
\xsection{LXIV — To THE EMPEROR TRAJAN}
...
purpose), I would have sent in chains to my praetorian prefects: [1043b]
...
\xsection{LXVI — To THE EMPEROR TRAJAN}

WHEN I cited the judges, Sir, to attend me at a sessions [1044b]
which I was going to hold, Flavius Archippus claimed the privilege of
being excused as exercising the profession of a philosopher. [1045b]
...
that six hundred thousand sesterces [1046b] be laid out in
the purchase of an estate for the support of him and his family, in the
neighbourhood of Prusias, [1047b] his native
...
predecessors. But lest the memory of him [1048b] who conferred
...
\xsection{LXVII — To THE EMPEROR TRAJAN}
...
\xsection{LX VIII — Trajan to Pliny}
...
\xsection{LXIX — To THE EMPEROR TRAJAN}
...
\xsection{LXXI — To THE EMPEROR TRAJAN}

A VERY considerable question, Sir, in which the whole province is
interested, has been lately started, concerning the state [1049b]
and maintenance of deserted children.\footnote{``Parents throughout
...
without repayment for the cost of maintenance.'' Church and Brodribb.} I have examined
...
\xsection{LXXII Trajan to Pliny}
...
their maintenance.\footnote{``This decision of
...
\xsection{LXXIII — To THE EMPEROR TRAJAN}
...
\xsection{LXX IV — Trajan to Pliny}
...
\xsection{LXXV — To THE EMPEROR TRAJAN}
...
\xsection{LXXVI — Trajan to Pliny}
...
for if it were, it is still consecrated ground.\footnote{And consequently by
the Roman laws unapplicable to any other purpose. M.}

\xsection{LXXVII — To THE EMPEROR TRAJAN}
...
cases of this nature, I find it only mentions the proconsular provinces.\footnote{The Roman provinces
...
\xsection{LXXVIII — Trajan to Pliny}
...
\xsection{LXXIX — To THE EMPEROR TRAJAN}

JULIUS LARGUS, of Ponus\footnote{A province in Asia,
bordering upon the Black Sea, and by some ancient geographers considered
as one province with Bithynia. M.} (a person whom I never saw nor indeed
...
thousand sesterces\footnote{About \$2,000. M.} for my own use, and to apply the
remainder for the benefit of the cities of Heraclea and Tios,\footnote{Cities of Pontus near
...
\xsection{LXXXI — To THE EMPEROR TRAJAN}
...
\xsection{LXXXII — Trajan to Pliny}
...
should distinguish the city of Juliopolis\footnote{Gordium, the old
capital of Phrygia. It afterwards, in the reign of the Emperor Augustus,
received the name of Juliopolis. (See Smith's Classical Diet.)} in the same way,
...
\xsection{LXXXIII — To THE EMPEROR TRAJAN}

BY a law of Pompey's\footnote{Pompey the Great
...
others, that which is here mentioned. M.} concerning the Bithynians, it is enacted,
...
be legally chosen into the senate by the censors?\footnote{The right of electing
...
conferring that honour. M.} And if so,
...
\xsection{LXXXIV — Trajan to Pliny}
...
\xsection{LXXXV — To THE EMPEROR TRAJAN}
...
desired that it might be assigned\footnote{This, probably, was
some act whereby the city was to ratify and confirm the proceedings of
Dion under the commission assigned to him.} to the city in
...
son are entombed,\footnote{It was a notion which
...
deposited, was esteemed as a mark of disrespect to his person.} and urged me to hear this cause in the
...
\xsection{LXXXVI — Trajan to Pliny}
...
\xsection{LXXXVII — To THE EMPEROR TRAJAN}
...
\xsection{LXXXVIII — Trajan to Pliny}
...
\xsection{LXXXIX — To THE EMPEROR TRAJAN}
...
\xsection{XCI — To THE EMPEROR TRAJAN}

THE inhabitants of Sinope\footnote{A thriving Greek
colony in the territory of Sinopis, on the Euxine.} are ill supplied, Sir, with water, which
...
\xsection{XCIII — To THE EMPEROR TRAJAN}

THE free and confederate city of the Amiseni\footnote{A colony of Athenians
in the province of Pontus. Their town, Amisus, on the coast, was one of
the residences of Mithridates.} enjoys, by your
indulgence, the privilege of its own laws. A memorial being presented to
me there, concerning a charitable institution,\footnote{Casaubon, in his
...
\xsection{XCV — To THE EMPEROR TRAJAN}
...
a favour which I am more than ordinarily anxious to obtain.\footnote{By the law for
...
\xsection{XCVII To THE EMPEROR TRAJAN}

\footnote{This letter is
...
with the same infatuation, but being Roman citizens,\footnote{It was one of the
...
were granted to those who shall repent of their error.\footnote{These women, it is
...
\xsection{XCVIII — Trajan to Pliny}
...
and the crime is proved, they must be punished;\footnote{If we impartially
...
worship, and assembling themselves without authority. M.} with the
...
\xsection{XCIX — To THE EMPEROR TRAJAN}

THE elegant and beautiful city of Amastris,\footnote{On the coast of
Paphlagonia.} Sir, has, among
...
\xsection{CI To THE EMPEROR TRAJAN}
...
\xsection{CIII — To THE EMPEROR TRAJAN}
...
\xsection{CV — To THE EMPEROR TRAJAN}

VALERIUS PAULINUS, Sir, having bequeathed to me the right of patronage\footnote{By the Papian law,
...
\xsection{CVII — To THE EMPEROR TRAJAN}
...
\xsection{CVIII — Trajan to Pliny}
...
\xsection{CIX — To THE EMPEROR TRAJAN}
...
\xsection{CXI — To THE EMPEROR TRAJAN}

THE solicitor to the treasury of the city of Amisis instituted a claim,
Sir, before me against Julius Piso of about forty thousand denarii,\footnote{About \$7,000.}
...
\xsection{CXIII — To THE EMPEROR TRAJAN}
...
cities, of receiving above their legal number, to pay one\footnote{About \$175}
or two thousand denarii\footnote{About \$350.} on their election. Subsequent to this,
...
\xsection{CXV — To THE EMPEROR TRAJAN}
...
\xsection{CXVII — To THE EMPEROR TRAJAN}
...
denarii.\footnote{The denarius=7 cents.
The sum total, then, distributed among one thousand persons at the rate
of, say, two denara a piece would amount to about \$350.} I request you to inform me whether you
...
\xsection{CXVIII — Trajan to Pliny}
...
\xsection{CXIX — To THE EMPEROR TRAJAN}

THE athletic victors, Sir, in the Iselastic\footnote{These games are
...
also annually a certain honourable stipend from the public. M.} games, conceive
...
\xsection{CXXI — To THE EMPEROR TRAJAN}
...
\xsection{CXXII — Trajan to Pliny}
